...
// 				),
    ...
    public function testGets()
    {
        ...
        $this->assertEquals(
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque ullamcorper sapien nec velit porta luctus.;More meat.",
            $vm_ret
        );
        ...
        $this->assertContains(
            'Burr shot his political rival Alexander Hamilton in a famous duel',
        ...
        $this->assertEquals(
            '[500024253] Haring, Keith (Persons, Artists) - American painter, muralist, and cartoonist, 1958-1990',
