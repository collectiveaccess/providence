...
// 				),
	...
	public function testGets() {
		...
		$this->assertStringContainsString('Burr fatally shot his political rival Hamilton in an 1804 duel', $this->opt_object->get('ca_objects.wikipedia.abstract'));
		...
		$this->assertStringContainsString('Burr fatally shot his political rival Hamilton in an 1804 duel', $this->opt_object->get('ca_objects.informationservice.wiki.abstract'));
	}
	# -------------------------------------------------------
