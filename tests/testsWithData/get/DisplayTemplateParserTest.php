...
class DisplayTemplateParserTest extends BaseTestWithData {
	...
	public function testFormatsWithBetween() {
		...
		$this->assertInternalType('array', $vm_ret);
		$this->assertCount(2, $vm_ret);
		$this->assertEquals('10.0 in X 2 lb; 5.0 in X 3 lb', $vm_ret[0]);
		...
		$this->assertInternalType('array', $vm_ret);
		$this->assertCount(2, $vm_ret);
		$this->assertEquals('2 lb X 10.0 in; 3 lb X 5.0 in', $vm_ret[0]);
		$this->assertEquals('1.0 in', trim($vm_ret[1]));
	}
	# -------------------------------------------------------
	...
	public function testFormatsWithRepeatingAttributeUnit() {
		...
		$this->assertEquals('Dimensions are: 10.0 in / 2 lb / foo; 5.0 in / 3 lb / meow', $vm_ret[0]);
	}
	# -------------------------------------------------------
	...
	public function testStartLength() {
		$this->assertEquals('5.0 in x 3 lb', trim(DisplayTemplateParser::evaluate("
