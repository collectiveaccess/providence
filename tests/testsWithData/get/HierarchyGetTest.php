...
class HierarchyGetTest extends BaseTestWithData
{
    ...
    public function setUp()
    {
         ...
         */
        $vn_test_parent = $this->addTestRecord(
            'ca_objects',
            array(
        ...
        $vn_test_child = $this->addTestRecord(
            'ca_objects',
            array(
                'intrinsic_fields' => array(
                    'type_id' => 'image',
        ...
        $vn_another_test_child = $this->addTestRecord(
            'ca_objects',
            array(
                'intrinsic_fields' => array(
                    'type_id' => 'image',
        ...
        $vn_third_test_child = $this->addTestRecord(
            'ca_objects',
            array(
                'intrinsic_fields' => array(
                    'type_id' => 'moving_image',
    ...
    public function testGets()
    {
        ...
        $vm_ret = $this->opt_parent_object->get(
            'ca_objects.children.preferred_labels',
        ...
        $vm_ret = $this->opt_child_object->get(
            'ca_objects.hierarchy.preferred_labels',
        ...
        $vm_ret = $this->opt_child_object->get(
            'ca_objects.siblings.preferred_labels',
            array('returnWithStructure' => true, 'returnAllLocales' => true)
        );
        $this->assertTrue(is_array($vm_ret));
    ...
    public function testChildrenRestrictToTypesDisplayTemplates()
    {
        $vm_ret = DisplayTemplateParser::evaluate(
            "<unit delimiter='; ' restrictToTypes='image' relativeTo='ca_objects.children'>^ca_objects.preferred_labels.name</unit>",
            "ca_objects",
            array($this->opt_parent_object->getPrimaryKey()),
        ...
        $vm_ret = DisplayTemplateParser::evaluate(
            "<unit delimiter='; ' restrictToTypes='moving_image' relativeTo='ca_objects.children'>^ca_objects.preferred_labels.name</unit>",
            "ca_objects",
            array($this->opt_parent_object->getPrimaryKey()),
            array('returnAsArray' => true)
        );
        ...
        $vm_ret = DisplayTemplateParser::evaluate(
            "<unit delimiter='; ' restrictToTypes='image'>^ca_objects.children.preferred_labels.name</unit>",
            "ca_objects",
            array($this->opt_parent_object->getPrimaryKey()),
            array('returnAsArray' => true)
        );
        ...
        $vm_ret = DisplayTemplateParser::evaluate(
            "<unit delimiter='; ' restrictToTypes='moving_image'>^ca_objects.children.preferred_labels.name</unit>",
            "ca_objects",
            array($this->opt_parent_object->getPrimaryKey()),
            array('returnAsArray' => true)
        );
    ...
    {
        $vm_ret = DisplayTemplateParser::evaluate(
            "<unit delimiter='; ' restrictToTypes='moving_image' relativeTo='ca_objects.parent'>^ca_objects.preferred_labels.name</unit>",
            "ca_objects",
            array($this->opt_another_child_object->getPrimaryKey()),
            array('returnAsArray' => true)
        );
        $this->assertInternalType('array', $vm_ret);
        $this->assertCount(1, $vm_ret);
        ...
        $vm_ret = DisplayTemplateParser::evaluate(
            "<unit delimiter='; ' restrictToTypes='image' relativeTo='ca_objects.parent'>^ca_objects.preferred_labels.name</unit>",
            "ca_objects",
            array($this->opt_another_child_object->getPrimaryKey()),
            array('returnAsArray' => true)
        );
    ...
    {
        $vm_ret = DisplayTemplateParser::evaluate(
            "<unit relativeTo='ca_objects.materials' delimiter='<br/>'>^ca_objects.materials.hierarchy.preferred_labels.name_plural%delimiter=_➔_</unit>",
            "ca_objects",
            array($this->opt_parent_object->getPrimaryKey()),
            array('returnAsArray' => true)
        );
    ...
    {
        $vm_ret = DisplayTemplateParser::evaluate(
            "<unit delimiter='; ' restrictToTypes='image' relativeTo='ca_objects.hierarchy'>^ca_objects.preferred_labels.name</unit>",
            "ca_objects",
            array($this->opt_another_child_object->getPrimaryKey()),
            array('returnAsArray' => true)
        );
        ...
        $vm_ret = DisplayTemplateParser::evaluate(
            "<unit delimiter='; ' restrictToTypes='moving_image' relativeTo='ca_objects.hierarchy'>^ca_objects.preferred_labels.name</unit>",
            "ca_objects",
            array($this->opt_another_child_object->getPrimaryKey()),
            array('returnAsArray' => true)
        );
    ...
    {
        $vm_ret = DisplayTemplateParser::evaluate(
            "<unit delimiter='; ' restrictToTypes='image' relativeTo='ca_objects.siblings'>^ca_objects.preferred_labels.name</unit>",
            "ca_objects",
            array($this->opt_another_child_object->getPrimaryKey()),
            array('returnAsArray' => true)
        );
        ...
        $vm_ret = DisplayTemplateParser::evaluate(
            "<unit delimiter='; ' restrictToTypes='moving_image' relativeTo='ca_objects.siblings'>^ca_objects.preferred_labels.name</unit>",
            "ca_objects",
            array($this->opt_another_child_object->getPrimaryKey()),
            array('returnAsArray' => true)
        );
