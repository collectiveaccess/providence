...
class RelatedGetTest extends BaseTestWithData
{
    ...
    public function setUp()
    {
         ...
         */
        $vn_object_id = $this->addTestRecord(
            'ca_objects',
            array(
        ...
        $vn_related_object_id = $this->addTestRecord(
            'ca_objects',
            array(
                'intrinsic_fields' => array(
                    'type_id' => 'dataset',
    ...
    public function testGets()
    {
        ...
        $vm_ret = $this->opt_object->get(
            ...
            array(
                'delimiter' => '; ',
                'excludeRelationshipTypes' => array('creator', 'publisher')
            )
        );
        $this->assertEquals('ACME Inc.', $vm_ret);
        ...
        $va_entity_relationships = $this->opt_object->get(
            'ca_objects_x_entities.relation_id',
