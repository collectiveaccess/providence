...
class FindTest extends BaseTestWithData
{
    ...
    public function setUp()
    {
        ...
        $this->assertGreaterThan(
            0,
            $this->opn_object_id = $this->addTestRecord(
                'ca_objects',
                array(
...
// 				),
        ...
        $this->assertGreaterThan(
            0,
            $this->opn_object_id2 = $this->addTestRecord(
                'ca_objects',
                array(
                    'intrinsic_fields' => array(
                        'type_id' => 'dataset',
...
Said, hey honey, take a walk on the wild side.'
    ...
    public function testFindByPreferredLabelNoPurify()
    {
        $vm_ret = ca_objects::find(
            ['preferred_labels' => ['name' => 'Sound &amp; Motion']],
    ...
    {
        $vm_ret = ca_objects::find(
            ['idno' => ['IN', ['TEST & STUFF', 'INVALID VALUE', 'Another TEST']]],
    ...
    {
        $vm_ret = ca_objects::find(
            ['preferred_labels' => ['name' => ['IN', ['Sound & Motion']]]],
            ['purify' => true, 'returnAs' => 'ids']
        );
        ...
        $vm_ret = ca_objects::find(
            ['preferred_labels' => ['name' => ['IN', ['Sound & Motion', 'INVALID VALUE', 'A Walk on the Wild Side']]]],
            ['purify' => true, 'returnAs' => 'ids']
        );
    ...
    {
        $vm_ret = ca_objects::find(
            ['nonpreferred_labels' => ['name' => ['IN', ['My test image']]]],
            ['purify' => true, 'returnAs' => 'ids']
        );
        ...
        $vm_ret = ca_objects::find(
            [
                'nonpreferred_labels' => [
                    'name' => [
                        'IN',
                        ['My test image', 'INVALID VALUE', 'Lou Reed and the East Village']
                    ]
                ]
            ],
            ['purify' => true, 'returnAs' => 'ids']
    ...
    {
        $vm_ret = ca_objects::find(
            ['external_link' => ['url_source' => [['IN', ['wikipedia']], ['=', 'wikipedia']]]],
            ['purify' => true, 'returnAs' => 'ids']
        );
        ...
        $vm_ret = ca_objects::find(
            ['external_link' => ['url_source' => ['IN', ['wikipedia']]]],
            ['purify' => true, 'returnAs' => 'ids']
        );
        ...
        $vm_ret = ca_objects::find(
            ['external_link' => ['url_source' => ['LIKE', '%source']]],
            ['purify' => true, 'returnAs' => 'ids']
        );
    ...
    {
        $vm_ret = ca_objects::find(
            ['type_id' => 'image', 'preferred_labels' => ['name' => ['LIKE', 'Sound%']]],
            ['purify' => true, 'returnAs' => 'ids']
        );
        ...
        $vm_ret = ca_objects::find(
            ['type_id' => 'dataset', 'preferred_labels' => ['name' => ['LIKE', 'Sound%']]],
            ['purify' => true, 'returnAs' => 'ids']
        );
    ...
    {
        $vm_ret = ca_objects::find(
            ['acquisition_type_id' => 'gift', 'preferred_labels' => ['name' => ['LIKE', 'Sound%']]],
            ['purify' => true, 'returnAs' => 'ids']
        );
    ...
    {
        $vm_ret = ca_objects::find(
            ['acquisition_type_id' => 'gift', 'preferred_labels' => ['name' => ['LIKE', 'A walk%']]],
