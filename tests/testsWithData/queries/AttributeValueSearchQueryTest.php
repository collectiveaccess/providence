...
// 				),
        ...
        $this->setSearchQueries(
            array(
                ...
                'ca_objects.dimensions_length:[25cm to 9in]' => 0,
                // 25cm > 9in
...
// 			'ca_objects.georeference:"[38.5,-124.0 to 36.4,-123.5]"' => 0,
                ...
                // actually has a blank value
                'ca_objects.description:"[BLANK]"' => 1,
                // has no value at all
                ...
                'ca_objects.date.dates_value:1985' => 1,
                // for container advanced searches
                'ca_objects.dates_value:1986' => 0,
                'ca_objects.date.dates_value:1986' => 0,
                // for container advanced searches
