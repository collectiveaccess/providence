...
class RelationshipGeneratorConfigurationPluginTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function assertCorrectErrorMessages(
        $pa_expectedErrorMessageContents,
        $pa_actualErrorMessages,
        $ps_sizeCheckDescription,
        $ps_valueCheckDescriptionTemplate
    ) {
        $this->assertEquals(
            sizeof($pa_expectedErrorMessageContents),
            sizeof($pa_actualErrorMessages),
        ...
        foreach ($pa_expectedErrorMessageContents as $va_expectedContent) {
            foreach ($va_expectedContent as $vs_expectedContentSubstring) {
                $this->assertRegExp(
                    '/' . str_replace('/', '\\/', $vs_expectedContentSubstring) . '/',
