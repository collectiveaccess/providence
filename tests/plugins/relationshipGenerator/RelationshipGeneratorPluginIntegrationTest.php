...
class RelationshipGeneratorPluginIntegrationTest extends AbstractPluginIntegrationTest
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::_processConfiguration(
            __DIR__ . '/conf/integration',
            'conf/relationshipGenerator.conf.template',
            'conf/relationshipGenerator.conf'
        );
        self::_switchInTestPlugin(
    ...
    public function testInsertedRecordNotMatchingAnyRule()
    {
        ...
        $this->assertEquals(
            0,
            self::_getCollectionRelationshipCount($vo_object, 'collection1'),
            'Object does not have a relationship with collection1'
        );
        $this->assertEquals(
            0,
            self::_getCollectionRelationshipCount($vo_object, 'collection2'),
            'Object does not have a relationship with collection2'
        );
        $this->assertEquals(
            0,
            self::_getCollectionRelationshipCount($vo_object, 'collection3'),
            'Object does not have a relationship with collection3'
        );
        $this->assertEquals(
            0,
            self::_getCollectionRelationshipCount($vo_object, 'collection4'),
            'Object does not have a relationship with collection4'
        );
        $this->assertEquals(
            0,
            self::_getCollectionRelationshipCount($vo_object, 'collection5'),
    ...
    {
        $vo_object = self::_createObject(
            'wasNotMatchingAnyRuleNowStillNotMatchingAnyRule',
    ...
    {
        $vo_object = self::_createObject(
            'wasNotMatchingAnyRuleNowMatchingSingleRule',
            array('element1' => 'this value matches nothing')
        );
        $this->assertEquals(
            0,
    ...
    {
        $vo_object = self::_createObject(
            'wasNotMatchingAnyRuleNowMatchingMultipleRules',
            array('element1' => 'this value matches nothing')
        );
        $this->assertEquals(
            0,
    ...
    {
        $vo_object = self::_createObject(
            'wasWasMatchingSingleRuleNowMatchingMultipleRules',
            array('element1' => 'EXACT MATCH')
        );
        $this->assertEquals(
            1,
    ...
    {
        $vo_object = self::_createObject(
            'wasMatchingSingleRuleNowMatchingDifferentSingleRule',
            array('element1' => 'EXACT MATCH')
        );
        $this->assertEquals(
            1,
    ...
    {
        $vo_object = self::_createObject(
            'wasMatchingSingleRuleNowNotMatchingAnyRule',
            array('element1' => 'EXACT MATCH')
        );
        $this->assertEquals(
            1,
    ...
    {
        $vo_object = self::_createObject(
            'wasMatchingMultipleRulesNowMatchingSingleRule',
            array('element1' => 'EXACT MATCH', 'element2' => 'xyzzy')
        );
        $this->assertEquals(
            1,
    ...
    {
        $vo_object = self::_createObject(
            'wasMatchingMultipleRulesNowNotMatchingDifferentSingleRule',
            array(
                'element1' => 'EXACT MATCH',
                'element2' => 'xyzzy',
                'element3' => 'bad data'
            )
        );
    ...
    {
        $vo_object = self::_createObject(
            'wasMatchingMultipleRulesNowNotMatchingAnyRule',
            array('element1' => 'EXACT MATCH', 'element2' => 'xyzzy')
        );
        $this->assertEquals(
            1,
    ...
    {
        $va_collections = $po_object->getRelatedItems(
            'ca_collections',
            array(
