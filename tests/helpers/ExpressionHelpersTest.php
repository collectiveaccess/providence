...
class ExpressionHelpersTest extends PHPUnit_Framework_TestCase {
	...
	public function testAgeCalculation() {
		...
		$this->assertEquals(30, caCalculateAgeInYears('1985/01/28'));
		...
		// same thing in days
		$this->assertEquals(15324, caCalulateAgeInDays('23 June 1912', '7 June 1954'));
		$this->assertEquals(15324, caCalulateAgeInDays('7 June 1954', '23 June 1912'));
