...
class ExpressionHelpersTest extends TestCase {
	...
	public function testAgeCalculation() {
		...
		$this->assertEquals( 91, caCalculateAgeInYears( '1929/10/07', "now" ) );
	...
	public function testAvgCalculation() {
		$this->assertEquals( 13229,
			caCalculateDateRangeAvgInDays( '1912/06/23 - 1954/06/07', '1985/01/28 - 2015/07/24' ) );
