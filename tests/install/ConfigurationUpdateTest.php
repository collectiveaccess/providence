...
class ConfigurationUpdateTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testAddNewLocale()
    {
        ...
        $o_installer = Installer::getFromString(
            file_get_contents(dirname(__FILE__) . '/profile_fragments/locales/add_new.xml')
        );
    ...
    {
        $o_installer = Installer::getFromString(
            file_get_contents(dirname(__FILE__) . '/profile_fragments/locales/update_existing.xml')
        );
        $this->assertTrue($o_installer instanceof Installer);
        $o_installer->processLocales();
    ...
    {
        $o_installer = Installer::getFromString(
            file_get_contents(dirname(__FILE__) . '/profile_fragments/lists/add_new_item_to_existing_list.xml')
        );
        $this->assertTrue($o_installer instanceof Installer);
        $o_installer->processLocales();
        ...
        $this->assertGreaterThan(
            0,
            ($vn_item_id = caGetListItemID('object_types', 'test_object_type', array('dontCache' => true)))
        );
    ...
    {
        $o_installer = Installer::getFromString(
            file_get_contents(dirname(__FILE__) . '/profile_fragments/lists/edit_item_in_existing_list.xml')
        );
        $this->assertTrue($o_installer instanceof Installer);
        $o_installer->processLocales();
        $o_installer->processLists();
        ...
        $this->assertGreaterThan(
            0,
            ($vn_item_id = caGetListItemID('object_types', 'image', array('dontCache' => true)))
        );
        $t_item = new ca_list_items($vn_item_id);
    ...
    {
        $o_installer = Installer::getFromString(
            file_get_contents(dirname(__FILE__) . '/profile_fragments/lists/add_new_list_with_items.xml')
        );
        $this->assertTrue($o_installer instanceof Installer);
        $o_installer->processLocales();
        $o_installer->processLists();
        ...
        $this->assertGreaterThan(
            0,
            ($vn_item_id = caGetListItemID('diff_test_list', 'test_item_one', array('dontCache' => true)))
        );
        ...
        $this->assertGreaterThan(
            0,
            ($vn_item_id = caGetListItemID('diff_test_list', 'test_item_two', array('dontCache' => true)))
        );
    }
    ...
    public function testDeleteListItem()
    {
        ...
        $o_installer = Installer::getFromString(
            file_get_contents(dirname(__FILE__) . '/profile_fragments/lists/delete_list_items.xml')
        );
        $this->assertTrue($o_installer instanceof Installer);
        $o_installer->processLocales();
        $o_installer->processLists();
    ...
    public function testDeleteList()
    {
        ...
        $o_installer = Installer::getFromString(
            file_get_contents(dirname(__FILE__) . '/profile_fragments/lists/delete_list.xml')
        );
        $this->assertTrue($o_installer instanceof Installer);
        $o_installer->processLocales();
        $o_installer->processLists();
    ...
    {
        $o_installer = Installer::getFromString(
            file_get_contents(dirname(__FILE__) . '/profile_fragments/elements/add_new_element.xml')
        );
        $this->assertTrue($o_installer instanceof Installer);
        $o_installer->processLocales();
    ...
    {
        $o_installer = Installer::getFromString(
            file_get_contents(dirname(__FILE__) . '/profile_fragments/elements/remove_labels_from_element.xml')
        );
        $this->assertTrue($o_installer instanceof Installer);
        $o_installer->processLocales();
        $o_installer->processMetadataElements();
    ...
    public function testAddElementExistingContainer()
    {
        $o_installer = Installer::getFromString(
            file_get_contents(
                dirname(__FILE__) . '/profile_fragments/elements/add_new_element_to_existing_container.xml'
            )
        );
        $this->assertTrue($o_installer instanceof Installer);
        $o_installer->processLocales();
    ...
    {
        $o_installer = Installer::getFromString(
            file_get_contents(dirname(__FILE__) . '/profile_fragments/elements/delete_elements.xml')
        );
        $this->assertTrue($o_installer instanceof Installer);
        $o_installer->processLocales();
        $o_installer->processMetadataElements();
    ...
    {
        $o_installer = Installer::getFromString(
            file_get_contents(dirname(__FILE__) . '/profile_fragments/elements/edit_element_in_existing_container.xml')
        );
        $this->assertTrue($o_installer instanceof Installer);
        $o_installer->processLocales();
        $o_installer->processMetadataElements();
        ...
        $va_elements_in_set = array_values(
            $t_instance->getElementsInSet()
        ); // we want to address things by position in the array below, not by element_id
    ...
    {
        $o_installer = Installer::getFromString(
            file_get_contents(dirname(__FILE__) . '/profile_fragments/uis/add_new_ui.xml')
        );
        $this->assertTrue($o_installer instanceof Installer);
        $o_installer->processLocales();
        ...
        $t_ui = ca_editor_uis::find(
            array('editor_code' => 'alternate_entity_ui', 'editor_type' => 20),
    ...
    {
        $o_installer = Installer::getFromString(
            file_get_contents(dirname(__FILE__) . '/profile_fragments/uis/add_new_screen_to_existing_ui.xml')
        );
        $this->assertTrue($o_installer instanceof Installer);
        $o_installer->processLocales();
        $o_installer->processUserInterfaces();
        ...
        $t_ui = ca_editor_uis::find(
            array('editor_code' => 'standard_entity_ui', 'editor_type' => 20),
            array('returnAs' => 'firstModelInstance')
        );
        $this->assertInstanceOf('ca_editor_uis', $t_ui);
    ...
    {
        $o_installer = Installer::getFromString(
            file_get_contents(dirname(__FILE__) . '/profile_fragments/uis/edit_screen_in_existing_ui.xml')
        );
        $this->assertTrue($o_installer instanceof Installer);
        $o_installer->processLocales();
        $o_installer->processUserInterfaces();
        ...
        $va_screen = array_pop(
            $va_screens
        ); // should be the last screen (let's hope the prev test didn't have side effects ;-))
    ...
    public function testDeleteRelType()
    {
        ...
        $o_installer = Installer::getFromString(
            file_get_contents(dirname(__FILE__) . '/profile_fragments/reltypes/delete_reltype.xml')
        );
        $this->assertTrue($o_installer instanceof Installer);
        $o_installer->processLocales();
