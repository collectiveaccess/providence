...
class GeocodeAttributeValueTest extends TestCase {
	...
	public function testWithCoordinates() {
		...
		$this->assertEqualsWithDelta( '52.52000660000002', $va_return['value_decimal1'], 0.001,
			'The correct latitude is returned from a lat/long pair' );
		$this->assertEqualsWithDelta( '13.404954', $va_return['value_decimal2'], 0.001,
			'The correct latitude is returned from a lat/long pair' );
		// they do get rounded a bit in this format
		$this->assertEquals( '52.5200066,13.404954', $va_return['value_longtext2'],
			'The correct latitude,longitude text value is returned from a lat/long pair' );
	}
