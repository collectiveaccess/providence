...
class TGNInformationServiceAttributeValueTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetDisplayLabelFromLookupText()
    {
        ...
        $this->assertEquals(
            'Coney Island',
            $o_service->getDisplayValueFromLookupText(
                '[7015849] Coney Island; Brooklyn, New York (neighborhoods)'
            )
        );
    }
    ...
    public function testConeyIsland()
    {
        ...
        $this->assertContains(
            '[7454829] Coney Island; Armagh, Banbridge and Craigavon, United Kingdom (islands (landforms))',
            $va_labels
        );
    }
