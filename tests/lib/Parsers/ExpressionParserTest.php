...
class ExpressionParserTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testVars()
    {
        ...
        $this->assertEquals(
            true,
            ExpressionParser::evaluate(
                '^ca_entities.type_id%convertCodesToDisplayText=0&convertCodesToIdno=1 =~ /ind/',
    ...
    public function testObscureVars()
    {
        $this->assertTrue(
            ExpressionParser::evaluate(
                '^/gvp:Subject/gvp:parentString =~ /Corporate/',
    ...
    public function testEvaluate()
    {
        ...
        $this->assertEquals(
            false,
            ExpressionParser::evaluate(
                '"Seth" NOT IN ["Julia", "Allison", "Sophie", "Maria", "Angie", "Seth"]'
            )
        );
        $this->assertEquals(
            true,
            ExpressionParser::evaluate(
                '"Joe" NOT IN ["Julia", "Allison", "Sophie", "Maria", "Angie", "Seth"]'
            )
        );
