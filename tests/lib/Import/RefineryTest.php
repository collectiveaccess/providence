...
class RefineryText extends TestCase {
	...
	public function testPlaceholderParsing() {
		if ( true ) {
			...
			$vm_ret = BaseRefinery::parsePlaceholder( "Sector_^1", $this->data, $this->item, null,
				[ 'returnAsString' => false, 'reader' => new ExcelDataReader() ] );
			...
			$vm_ret = BaseRefinery::parsePlaceholder( "Sector_^1", $this->data, $this->item, null,
				[ 'returnAsString' => true, 'reader' => new ExcelDataReader() ] );
			$this->assertIsString( $vm_ret );
			$this->assertEquals( 'Sector_Verdun', $vm_ret );

			// Return array substitition with replacements as array
			$vm_ret = BaseRefinery::parsePlaceholder( "Sector_^2", $this->data, $this->item, null,
				[ 'returnAsString' => false, 'reader' => new ExcelDataReader() ] );
			$this->assertIsArray( $vm_ret );
			...
			$vm_ret = BaseRefinery::parsePlaceholder( "Sector_^2", $this->data, $this->item, null,
				[ 'delimiter' => ';', 'returnAsString' => true, 'reader' => new ExcelDataReader() ] );
			$this->assertIsString( $vm_ret );
			$this->assertEquals( 'Value_Cambrai;Sector_Arras', $vm_ret );

			// Return delimited string with replacements as array
			$vm_ret = BaseRefinery::parsePlaceholder( "Sector_^6", $this->data, $this->item, null,
				[ 'delimiter' => ';', 'returnAsString' => false, 'reader' => new ExcelDataReader() ] );
			$this->assertIsArray( $vm_ret );
			...
			$vm_ret = BaseRefinery::parsePlaceholder( "Sector_^6", $this->data, $this->item, 1,
				[ 'delimiter' => ';', 'returnAsString' => false, 'reader' => new ExcelDataReader() ] );
			$this->assertIsArray( $vm_ret );
			$this->assertCount( 1, $vm_ret );
			...
			$vm_ret = BaseRefinery::parsePlaceholder( "Sector_^6", $this->data, $this->item, 12,
				[ 'delimiter' => ';', 'returnAsString' => false, 'reader' => new ExcelDataReader() ] );
			$this->assertIsArray( $vm_ret );
			...
			$vm_ret = BaseRefinery::parsePlaceholder( "Visited: ^1, ^3, ^4", $this->data, $this->item, null,
				[ 'delimiter' => ';', 'returnAsString' => false, 'reader' => new ExcelDataReader() ] );
			$this->assertIsArray( $vm_ret );
			$this->assertCount( 1, $vm_ret );
			...
			$vm_ret = BaseRefinery::parsePlaceholder( "Visited: ^1, ^2, ^4", $this->data, $this->item, null,
				[ 'delimiter' => ';', 'returnAsString' => false, 'reader' => new ExcelDataReader() ] );
			$this->assertIsArray( $vm_ret );
			$this->assertCount( 2, $vm_ret );
			...
			$vm_ret = BaseRefinery::parsePlaceholder( "Visited: ^1, ^2, ^6", $this->data, $this->item, null,
				[ 'returnAsString' => false, 'reader' => new ExcelDataReader() ] );
		...
		$vm_ret = BaseRefinery::parsePlaceholder( "Got ^7", $this->data, $this->item, 1, [
			'returnDelimitedValueAt' => 1,
			'delimiter'              => [ '|' ],
		...
		$vm_ret = BaseRefinery::parsePlaceholder( "^1", $this->data, $this->item, null,
			[ 'delimiter' => [ ';' ], 'returnAsString' => false, 'reader' => new ExcelDataReader() ] );
		$this->assertIsArray( $vm_ret );
		$this->assertCount( 1, $vm_ret );
		...
		$vm_ret = BaseRefinery::parsePlaceholder( "^2", $this->data, $this->item, null,
			[ 'delimiter' => [ ';' ], 'returnAsString' => false, 'reader' => new ExcelDataReader() ] );
		$this->assertIsArray( $vm_ret );
		$this->assertCount( 2, $vm_ret );
		...
		// single placeholder for repeating values as array
		$vm_ret = BaseRefinery::parsePlaceholder( "^6", $this->data, $this->item, null,
			[ 'delimiter' => [ ';' ], 'returnAsString' => false, 'reader' => new ExcelDataReader() ] );
		$this->assertIsArray( $vm_ret );
		$this->assertCount( 5, $vm_ret );
		...
		$vm_ret = BaseRefinery::parsePlaceholder( "^6", $this->data, $this->item, 2,
			[ 'delimiter' => [ ';' ], 'returnAsString' => false, 'reader' => new ExcelDataReader() ] );
		$this->assertIsArray( $vm_ret );
		$this->assertCount( 1, $vm_ret );
		$this->assertEquals( 'Cambrai', $vm_ret[0] );
		...
		// single placeholder for repeating values with index
		$vm_ret = BaseRefinery::parsePlaceholder( "^7", $this->data, $this->item, 1, [
			'delimiter'              => [ '|' ],
			'returnDelimitedValueAt' => 2,
			'returnAsString'         => false,
			'reader'                 => new ExcelDataReader()
