...
class BundlableLabelableBaseModelWithAttributesTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testInsertLoadAndDeleteCycleWithCaObjectsModel()
    {
        ...
        $this->assertTrue(
            $vb_res !== false,
            'Insert returned non-true value'
        ...
        $this->assertEquals(
            $t_object2->getAttributesForDisplay('description'),
            'Test description',
    ...
    public function testPrepopulateFieldsSimple()
    {
        ...
        $va_prepopulate_options = array(
            'prepopulateConfig' => dirname(
                    __FILE__
                ) . DIRECTORY_SEPARATOR . 'conf' . DIRECTORY_SEPARATOR . 'prepopulate_simple.conf'
        );
        ...
        $this->assertTrue(
            $o_plugin->prepopulateFields($t_object, $va_prepopulate_options),
    ...
    public function testPrepopulateFieldsDontOverwrite()
    {
        ...
        $va_prepopulate_options = array(
            'prepopulateConfig' => dirname(
                    __FILE__
                ) . DIRECTORY_SEPARATOR . 'conf' . DIRECTORY_SEPARATOR . 'prepopulate_dont_overwrite.conf'
        );
    ...
    public function testPrepopulateFieldsIntrinsic()
    {
        ...
        $va_prepopulate_options = array(
            'prepopulateConfig' => dirname(
                    __FILE__
                ) . DIRECTORY_SEPARATOR . 'conf' . DIRECTORY_SEPARATOR . 'prepopulate_intrinsic.conf'
        );
    ...
    public function testPrepopulateFieldsLabels()
    {
        ...
        $va_prepopulate_options = array(
            'prepopulateConfig' => dirname(
                    __FILE__
                ) . DIRECTORY_SEPARATOR . 'conf' . DIRECTORY_SEPARATOR . 'prepopulate_labels.conf'
        );
    ...
    public function testPrepopulateFieldsLabelsOverwrite()
    {
        ...
        $va_prepopulate_options = array(
            'prepopulateConfig' => dirname(
                    __FILE__
                ) . DIRECTORY_SEPARATOR . 'conf' . DIRECTORY_SEPARATOR . 'prepopulate_labels_overwrite.conf'
        );
    ...
    public function testPrepopulateFieldsContainers()
    {
        ...
        $va_prepopulate_options = array(
            'prepopulateConfig' => dirname(
                    __FILE__
                ) . DIRECTORY_SEPARATOR . 'conf' . DIRECTORY_SEPARATOR . 'prepopulate_container.conf'
        );
        ...
        $this->assertEquals(
            'test123',
            $t_object->get('ca_objects.external_link.url_source'),
    ...
    public function testPrepopulateFieldsDontOverwriteContainers()
    {
        ...
        $this->assertEquals(
            ...
            $t_object->get('ca_objects.external_link.url_entry'),
    ...
    public function testPrepopulateFieldsOverwriteContainer()
    {
        ...
        $va_prepopulate_options = array(
            'prepopulateConfig' => dirname(
                    __FILE__
                ) . DIRECTORY_SEPARATOR . 'conf' . DIRECTORY_SEPARATOR . 'prepopulate_container_overwrite.conf'
        );
