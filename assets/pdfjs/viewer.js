...
if (!PDFJS.workerSrc) { PDFJS.workerSrc = 'js/pdfjs/pdf.js'; }
  ...
  setInitialView: function pdfViewSetInitialView(storedHash, scale) {
    ...
    if (PDFView.currentScale === UNKNOWN_SCALE) {
      ...
      this.parseScale(DEFAULT_SCALE, true);
    	...
    	// Voodoo to get toolbar to size properly on Safari and Chrome
			var toolbarDiv = document.getElementById('toolbarTopLevel');
			toolbarDiv.style.display='none';
			toolbarDiv.offsetHeight; // no need to store this anywhere, the reference is enough
			toolbarDiv.style.height = '32px';
...
PDFJS.webViewerLoad = function webViewerLoad(u) {
  PDFView.initialize();
  var params = PDFView.parseQueryString(document.location.search.substring(1));

  var file = u || params.file || DEFAULT_URL;
