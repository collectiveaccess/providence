...
(function(Handsontable){
  ...
  Handsontable.EditorManager = function(instance, priv, selection){
    ...
    var init = function () {
      ...
      $document.bind('keydown.handsontable.' + instance.guid, onKeyDown);
...
//        that.instance.destroyEditor();
      ...
      instance.addHook('afterDestroy', function(){
        $document.unbind('keydown.handsontable.' + instance.guid);
      });
...
WalkontableScrollbar.prototype.init = function () {
  ...
  this.dragdealer = new Dragdealer(this.slider, {
    ...
    callback: function (x, y) {
      ...
      dragDelta = that.type === 'vertical' ? y : x;
      that.onScroll(dragDelta);
      Handsontable.PluginHooks.run(self, 'scrollDone', { "type" : that.type, "dragDelta" : dragDelta });	// MOD for CA 11 April 2013
    }
  });
