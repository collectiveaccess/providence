...
print $vs_control_box = caFormControlBox(
    ($vb_importers_available ? (caFormSubmitButton(
        $this->request,
...
<form action="#" id="caULANSearchForm">
    <div class="formLabel">
        <?php print _t('Find in ULAN') . ': ' . caHTMLTextInput(
                "term",
                array('value' => '', 'id' => 'caULANTerm'),
                array('width' => '250px')
            ); ?>
...
<div class='formLabel'>
    <?php
    if ($vb_importers_available) {
        print _t('Log level') . ': ' . caHTMLSelect(
                'log_level',
                caGetLogLevels(),
                array('id' => 'caLogLevel'),
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        jQuery(document).on('click', '.caULANSearchResultItem', {}, function (e) {
            jQuery(this).parent().find(".caULANSearchResultDetails").slideToggle(250, function (e) {
                ...
                var details = this;
                jQuery(details).html("<div class='caULANDetailsMessage'><?php print caBusyIndicatorIcon(
                        $this->request
    ...
    function caSearchULAN(term, start, c, msg) {
        ...
        jQuery("#caULANResults").html("<div class='caULANResultsMessage'><?php print caBusyIndicatorIcon(
                $this->request
            ) . ' '; ?>" + msg + "</div>");
    ...
    function caGetNextULANResults() {
        if (caULANLastSearchTerm) {
            ...
            caSearchULAN(caULANLastSearchTerm, caULANStartIndex, caULANNumResultsPerLoad, "<?php print addslashes(
                _t('Loading next page...')
            ); ?>");
            jQuery('#caULANResultsPreviousLink').show();
        }
    }
