...
class ImportController extends ActionController {
	...
	public function __construct( &$po_request, &$po_response, $pa_view_paths = null ) {
		...
		MetaTagManager::addLink( 'stylesheet',
			__CA_URL_ROOT__ . "/app/plugins/ULAN/themes/" . __CA_THEME__ . "/css/ULAN.css", 'text/css' );
	}
	# -------------------------------------------------------
	...
	public function Index() {
		...
		$this->view->setVar( 'importer_list',
			$va_importer_list = ca_data_importers::getImporters( null, array( 'formats' => array( 'ULAN' ) ) ) );
	...
	public function RunImport() {
		...
		$vn_status  = $t_importer->importDataFromSource( join( ",", $pa_ulan_ids ), $pn_importer_id,
			array( 'progressBar' => $o_progress, 'format' => 'ULAN', 'logLevel' => $pn_log_level ) );
