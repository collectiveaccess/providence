<?php
/* ----------------------------------------------------------------------
 * app/plugins/alhalqaServices/controllers/AlhalqaCommunityController.php
 * ----------------------------------------------------------------------
 * CollectiveAccess
 ...
 * ----------------------------------------------------------------------
 */
 	require_once(__CA_APP_DIR__.'/plugins/alhalqaServices/services/AlhalqaCommunityService.php');
	require_once(__CA_APP_DIR__.'/service/controllers/FindController.php');

	class AlhalqaCommunityController extends BaseServiceController {
		# -------------------------------------------------------
		...
		public function __call($ps_endpoint, $pa_args){
			$vo_service = new AlhalqaCommunityService($this->getRequest(), $ps_endpoint);
