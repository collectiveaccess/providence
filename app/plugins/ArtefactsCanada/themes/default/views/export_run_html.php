...
<script type="text/javascript">
	jQuery(document).ready(function () {
		...
		jQuery.post('<?php print caNavUrl( $this->request, '*', '*', 'RunExport',
				array() ); ?>', <?php print json_encode( array( 'set_code' => $set_code, 'job_id' => $job_id ) ); ?>,
		...
		updateProgressBarInterval = setInterval(function () {
			jQuery.getJSON('<?php print caNavUrl( $this->request, '*', '*', 'GetExportStatus',
				array( 'job_id' => $job_id ) ); ?>', {}, function (data) {
				if (data && data.total) {
