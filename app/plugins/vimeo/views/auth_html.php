...
if ($this->getVar('had_stored_token')) {
    switch ($va_token['type']) {
        ...
        default:
            ?>
            <div><?php print _t(
                    "If you authorized our app on the Vimeo page, please enter the verification code here."
                ); ?></div>
            <?php
            ...
            <div><?php print _t(
                    'Here is the link to the Vimeo authorization page again: %1',
                    '<a href="' . $this->getVar('authorize_link') . '" target="_blank">Vimeo</a>'
                ); ?></div>
            <?php
