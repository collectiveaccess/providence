...
<form action="#" id="caWorldCatSearchForm">
    <div class="formLabel">
        <?php print _t('Find in WorldCat') . ': ' . caHTMLTextInput(
                "term",
                array('value' => '', 'id' => 'caWorldCatTerm'),
                array('width' => '250px')
            ); ?>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        jQuery(document).on('click', '.caWorldCatSearchResultItem', {}, function (e) {
            jQuery(this).parent().find(".caWorldCatSearchResultDetails").slideToggle(250, function (e) {
                ...
                var details = this;
                jQuery(details).html("<div class='caWorldCatDetailsMessage'><?php print caBusyIndicatorIcon(
                        $this->request
    ...
    function caSearchWorldCat(term, start, c, msg) {
        ...
        jQuery("#caWorldCatResults").html("<div class='caWorldCatResultsMessage'><?php print caBusyIndicatorIcon(
                $this->request
            ) . ' '; ?>" + msg + "</div>");
    ...
    function caGetNextWorldCatResults() {
        if (caWorldCatLastSearchTerm) {
            ...
            caSearchWorldCat(caWorldCatLastSearchTerm, caWorldCatStartIndex, caWorldCatNumResultsPerLoad, "<?php print addslashes(
