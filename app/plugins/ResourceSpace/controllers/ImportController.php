...
class ImportController extends ActionController
{
    ...
    public function Index()
    {
        ...
        $this->view->setVar(
            'importer_list',
            $va_importer_list = ca_data_importers::getImporters(
                null,
    ...
    public function Run()
    {
        ...
        $vs_job_id = md5(
            'U' . $this->request->getUserID() . '_' . $pn_importer_id . '_' . join(
                ';',
                $pa_resourcespace_ids
            ) . '_' . uniqid(rand(), true) . '_' . microtime(true)
        );
        ...
        $this->request->user->setVar(
            'resourcespace_log_level',
    ...
    public function RunImport()
    {
        ...
        $vn_status = ca_data_importers::importDataFromSource(
            $pa_resourcespace_ids,
            $pn_importer_id,
            array(
                'progressBar' => $o_progress,
                'format' => 'resourcespace',
                'logLevel' => $pn_log_level
            )
        );
        ...
        $va_links = caProcessTemplateForIDs(
            $vs_template,
            $va_job_info['data']['table'],
            array_merge(
                $va_job_info['data']['created'],
                $va_job_info['data']['updated']
            ),
