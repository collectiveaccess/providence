...
class Db extends DbBase
{
     ...
     */
    public static function setMonitor($po_monitor)
    {
    ...
    public function beginTransaction()
    {
        ...
        if ($this->opn_transaction_count >= $this->supports("max_nested_transactions")) {
            $this->postError(
                211,
                _t(
                    "Transaction count cannot exceed maximum of %1",
                    $this->supports("max_nested_transactions")
                ),
                "Db->beginTransaction()"
            );
            return false;
