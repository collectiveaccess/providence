...
class Request
{
    ...
    public function getActionErrors($ps_source = null, $ps_subsource = null)
    {
        if (is_null($ps_source)) {
            ...
            return $this->_unrollActionErrors(
                isset($this->opa_action_errors[$ps_source]) ? $this->opa_action_errors[$ps_source] : null
            );
        }
    }
    ...
    public function numActionErrors($ps_source = null, $ps_subsource = null)
    {
        if (is_null($ps_source)) {
            ...
            if ($ps_subsource) {
                return isset($this->opa_action_errors[$ps_source][$ps_subsource]) ? sizeof(
                    $this->opa_action_errors[$ps_source][$ps_subsource]
                ) : 0;
            }
