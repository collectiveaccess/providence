...
class FileMimeTypes {
	...
	static function mimeTypeForFileExtension( $ps_extension ) {
		...
		return isset( $g_file_extensions_to_mimetypes[ $ps_extension ] )
			? $g_file_extensions_to_mimetypes[ $ps_extension ] : 'application/octet-stream';
	}
	# ------------------------------------------------

	/**
	 * Convert mimetype into human-readable name for display. If mimetype is not known the mimetype is returned
	 * unchanged.
	 */
	static function nameForMimeType( $ps_mimetype ) {
		global $g_mimetypes_to_info;

		return isset( $g_mimetypes_to_info[ $ps_mimetype ] ) ? $g_mimetypes_to_info[ $ps_mimetype ]['name']
			: $ps_mimetype;
	}
	# ------------------------------------------------

	/**
	 * Converts file extension into human-readable name for display. Generic 'application/octet-stream' mimetype is
	 * returned if extension is unknown.
	 */
