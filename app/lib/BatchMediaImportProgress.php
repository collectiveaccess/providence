...
class BatchMediaImportProgress extends AppControllerPlugin {
	...
	public function dispatchLoopShutdown() {
		...
		if ( $req->isLoggedIn() ) {
			...
			$va_errors = BatchProcessor::importMediaFromDirectory( $this->request, array_merge( $this->opa_options,
				array(
					'progressCallback' => 'caIncrementBatchMediaImportProgress',
					'reportCallback'   => 'caCreateBatchMediaImportResultsReport'
				) ) );
		}
	}
	# -------------------------------------------------------
