...
interface ITakesAttributes {
	...
	public function getAttributeHTMLFormBundle(
		$po_request, $ps_form_name, $pm_element_code_or_id, $ps_placement_code, $pa_bundle_settings, $pa_options
	);
	...
	public function getApplicableElementCodes(
		$pn_type_id = null, $pb_include_sub_element_codes = false, $pb_dont_cache = true
	);
}
