...
class DbResult extends DbBase
{
     ...
     * @access private
     */
    static public $s_field_info_cache;
    ...
    {
        $va_field = isset(DbResult::$s_field_info_cache[$ps_field]) ? DbResult::$s_field_info_cache[$ps_field] : $this->getFieldInfo(
            $ps_field
        );
    ...
    public function getAllFieldValues($pm_field, $pa_options = null)
    {
        ...
        if (is_array($pm_field)) {
            ...
            foreach ($pm_field as $vs_field) {
                $va_field = isset(DbResult::$s_field_info_cache[$vs_field]) ? DbResult::$s_field_info_cache[$vs_field] : $this->getFieldInfo(
                    $vs_field
                );
                $vm_field[] = $va_field['field'];
            }
        } else {
            $va_field = isset(DbResult::$s_field_info_cache[$pm_field]) ? DbResult::$s_field_info_cache[$pm_field] : $this->getFieldInfo(
                $pm_field
            );
            $vm_field = $va_field['field'];
        }
    ...
    public function getFileInfo($ps_field)
    {
        ...
        return $GLOBALS["_DbResult_fileinfocoder"]->getFileInfo(
            $this->get($va_field["field"], array("unserialize" => true))
        );
    }
