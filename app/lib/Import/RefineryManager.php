...
class RefineryManager
{
     ...
     */
    static public $s_refinery_manager_did_do_refinery_init = false;
    ...
    public static function checkRefineryStatus($ps_refinery_name)
    {
        ...
        if (isset(RefineryManager::$s_refinery_instances[$ps_refinery_name]) && is_object(
    ...
    public function getRefinerySettingsForm($ps_refinery_name, $ps_refinery_id, $pa_settings)
    {
        ...
        $o_appvar = null;
        RefineryManager::initRefineries();
        if (RefineryManager::$s_refinery_instances[$ps_refinery_name] && is_object(
                RefineryManager::$s_refinery_instances[$ps_refinery_name]
            )) {
            ...
            foreach ($va_available_settings as $vs_setting_name => $va_setting_info) {
                ...
                if (isset($va_setting_info['scope']) && ($va_setting_info['scope'] == 'application')) {
                    ...
                    $pa_settings[$vs_setting_name] = $o_appvar->getVar(
                        'refinery_settings_' . $ps_refinery_name . '_' . $vs_setting_name
                    );
                }
                $vs_buf .= RefineryManager::$s_refinery_instances[$ps_refinery_name]->settingHTMLFormElement(
                    $ps_refinery_id,
                    $vs_setting_name,
