...
abstract class BaseDataReader
{
     ...
     * @return bool
     */
    public abstract function seek($pn_row_num);
    # -------------------------------------------------------
    ...
    public function get($ps_field, $pa_options = null)
    {
        ...
        switch ($ps_field) {
            ...
            case '__filepath__':
                ...
                break;
            case '__filename__':
                $vs_val = ($vs_original_filename = caGetOption(
                    'originalFilename',
                    $pa_options,
                    null
    ...
    {
        return in_array(
            strtolower($ps_format),
            $this->opa_formats
        );    // lowercase $ps_format for case-insensitive matching (format list is already all lower-case)
    }
    # -------------------------------------------------------
     ...
     * @return int
     */
    public abstract function getInputType();
    # -------------------------------------------------------
}
