        ...
        if (isset($this->opa_row_ids[$this->opn_current_row]) && ($vn_worldcat_id = $this->opa_row_ids[$this->opn_current_row])) {
            ...
            try {
                if ($this->opb_z3950_available && $this->ops_z3950_user) {
                    $r_conn = yaz_connect(
                        WorldCatDataReader::$s_worldcat_z3950_host,
                        array(
                            'user' => $this->ops_z3950_user,
                            'password' => $this->ops_z3950_password
                        )
                    );
                    ...
                    $o_client = new Client(['base_uri' => WorldCatDataReader::$s_worldcat_detail_url]);
