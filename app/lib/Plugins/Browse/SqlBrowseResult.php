<?php
/** ---------------------------------------------------------------------
 * app/lib/Plugins/Browse/SqlBrowseResult.php :
 * ----------------------------------------------------------------------
 * CollectiveAccess
 ...
 */
 ...
 include_once(__CA_LIB_DIR__.'/Plugins/IWLPlugBrowseResult.php');

class WLPlugSearchEngineSqlBrowseResult extends WLPlug implements IWLPlugBrowseResult {
	# -------------------------------------------------------
	private $opo_config;
