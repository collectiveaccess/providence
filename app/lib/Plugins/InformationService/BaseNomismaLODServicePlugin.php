...
abstract class BaseNomismaLODServicePlugin extends BaseInformationServicePlugin
{
    ...
    public function getDataForSearchIndexing($pa_settings, $ps_url)
    {
        ...
        if (!isset($va_service_conf['additional_indexing_info']) || !is_array(
                $va_service_conf['additional_indexing_info']
            )) {
            return array();
        }
     ...
     * @return array
     */
    public static function getListOfRelatedGraphs(
        $po_graph,
        $ps_base_node,
        $ps_node_uri,
        $pn_limit,
