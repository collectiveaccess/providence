...
class WLPlugInformationServiceCollectiveAccess Extends BaseInformationServicePlugin Implements IWLPlugInformationService
{
    ...
    {
        $o_client = new Client(['base_uri' => $pa_settings['baseURL']]);
        ...
        $o_response = $o_client->request(
            "GET",
            $vs_url = $u['path'] . '/service.php/find/' . $pa_settings['table'] . '?q=' . urlencode(
                    $ps_search
    ...
    public function getExtendedInformation($pa_settings, $ps_url)
    {
        ...
        $o_response = $o_client->request(
            "GET",
            $vs_url = $u['path'] . '/service.php/item/' . $pa_settings['table'] . '/id/' . urlencode(
                    $ps_id
