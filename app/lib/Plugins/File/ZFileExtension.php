...
class WLPlugFileZFileExtension Extends WLPlug Implements IWLPlugFileFormat {
	...
	var $file_extensions
		= array(
			...
			"php"   => array(
				"mimetype"         => "application/x-php4",
				"format_name"      => "PHP",
				"long_format_name" => "PHP source file",
				"dangerous"        => 1
			),
			"php3"  => array(
				"mimetype"         => "application/x-php4",
			...
			"pl"    => array(
				"mimetype"         => "text/plain",
				"format_name"      => "Perl",
				"long_format_name" => "Perl source file",
				"dangerous"        => 1
			),
			"cgi"   => array(
				"mimetype"         => "text/plain",
				"format_name"      => "CGI",
				"long_format_name" => "CGI source file",
				"dangerous"        => 1
			),
			"py"    => array(
				"mimetype"         => "text/plain",
				"format_name"      => "Python",
				"long_format_name" => "Python source file",
				"dangerous"        => 1
			),
			"rb"    => array(
				"mimetype"         => "text/plain",
				"format_name"      => "Ruby",
				"long_format_name" => "Ruby source file",
				"dangerous"        => 1
			),
			"shtml" => array(
				"mimetype"         => "text/plain",
				"format_name"      => "SHTML",
				"long_format_name" => "Server parsed HTML",
				"dangerous"        => 1
			),
			"pyc"   => array(
				"mimetype"         => "text/plain",
				"format_name"      => "Compiled Python",
				"long_format_name" => "Compiled Python",
				"dangerous"        => 1
			),
			"jsp"   => array(
				"mimetype"         => "text/plain",
				"format_name"      => "JSP",
				"long_format_name" => "Java Server Page",
				"dangerous"        => 1
			),
			"asp"   => array(
				"mimetype"         => "text/plain",
				"format_name"      => "ASP",
				"long_format_name" => "ASP",
				"dangerous"        => 1
			),
			"exe"   => array(
				"mimetype"         => "text/plain",
				"format_name"      => "exe",
				"long_format_name" => "Executable",
				"dangerous"        => 1
			),
			"dll"   => array(
				"mimetype"         => "text/plain",
				"format_name"      => "DLL",
				"long_format_name" => "DLL",
				"dangerous"        => 1
			),
			"bat"   => array(
				"mimetype"         => "text/plain",
				"format_name"      => "Batch file",
				"long_format_name" => "DOS batch file",
				"dangerous"        => 1
			),
			"com"   => array(
				"mimetype"         => "text/plain",
				"format_name"      => "COM",
				"long_format_name" => "COM file",
				"dangerous"        => 1
			),
			"sh"    => array(
				"mimetype"         => "text/plain",
				"format_name"      => "Shell",
				"long_format_name" => "Shell script",
				"dangerous"        => 1
			),
			...
			"psd"  => array(
				"mimetype"         => "image/psd",
				"format_name"      => "PSD",
				"long_format_name" => "Photoshop image"
			),
			"swf"  => array(
				"mimetype"         => "application/x-shockwave-flash",
				"format_name"      => "SWF",
				"long_format_name" => "SWF (Shockwave Flash)"
			),
			"pdf"  => array(
				"mimetype"         => "application/pdf",
				"format_name"      => "PDF",
				"long_format_name" => "Adobe Portable Document Format (PDF)"
			),
			"eps"  => array(
				"mimetype"         => "application/eps",
				"format_name"      => "EPS",
				"long_format_name" => "Adobe Encapsulated PostScript (EPS)"
			),
			"ps"   => array(
				"mimetype"         => "application/ps",
				"format_name"      => "PostScript",
				"long_format_name" => "Adobe PostScript"
			),
			"mov"  => array(
				"mimetype"         => "video/quicktime",
				"format_name"      => "Quicktime",
				"long_format_name" => "Quicktime"
			),
			"doc"  => array(
				"mimetype"         => "application/msword",
				"format_name"      => "Microsoft Word",
				"long_format_name" => "Microsoft Word"
			),
			"ppt"  => array(
				"mimetype"         => "application/vnd.ms-powerpoint",
				"format_name"      => "Microsoft PowerPoint",
				"long_format_name" => "Microsoft PowerPoint"
			),
			"xls"  => array(
				"mimetype"         => "application/vnd.ms-excel",
				"format_name"      => "Microsoft Excel",
				"long_format_name" => "Microsoft Excel"
			),
			"wmv"  => array(
				"mimetype"         => "application/windows-media",
				"format_name"      => "WindowsMedia",
				"long_format_name" => "WindowsMedia"
			),
			"tar"  => array(
				"mimetype"         => "application/tar",
				"format_name"      => "TAR",
				"long_format_name" => "Unix Tape Archive (TAR)"
			),
			"tgz"  => array(
				"mimetype"         => "application/windows-media",
				"format_name"      => "Tar Gzip",
				"long_format_name" => "Gzipped Unix Tape Archive (TAR/Gzip)"
			),
			"zip"  => array(
				"mimetype"         => "application/windows-media",
				"format_name"      => "ZIP",
				"long_format_name" => "PKZIP archive"
			),
			"gz"   => array(
				"mimetype"         => "application/windows-media",
				"format_name"      => "Gzip",
				"long_format_name" => "GNU Zip"
			),
			"Z"    => array(
				"mimetype"         => "application/windows-media",
				"format_name"      => "Unix Compress",
				"long_format_name" => "Unix Compress"
			),
		);
	...
	public function test( $filepath, $original_filepath = "" ) {
		...
		if ( ( isset( $this->file_extensions[ strtolower( $ext ) ] ) )
		     && ( $info
				= $this->file_extensions[ strtolower( $ext ) ] )
		) {
