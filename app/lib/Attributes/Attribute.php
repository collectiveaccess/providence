...
class Attribute
{
    ...
    static public $s_attribute_types = array();
    ...
    public function getDisplayValues($pb_index_with_element_ids = false, $pa_options = null)
    {
        ...
        foreach ($this->opa_values as $o_val) {
            $va_display_values[$pb_index_with_element_ids ? $o_val->getElementID() : $o_val->getElementCode(
            )] = $o_val->getDisplayValue($pa_options);
        }
