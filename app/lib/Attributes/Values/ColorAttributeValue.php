...
class ColorAttributeValue extends AttributeValue implements IAttributeValue {
	...
	public function htmlFormElement( $pa_element_info, $pa_options = null ) {
		...
		$va_settings = $this->getSettingValuesFromElementArray( $pa_element_info,
			array( 'fieldWidth', 'fieldHeight', 'showHexValueText', 'showRGBValueText' ) );
		...
		$vs_element = "<input name='{$id}' type='hidden' value='{{" . $pa_element_info['element_id']
		              . "}}' id='{$id}'/>\n";

		if ( isset( $va_settings['showHexValueText'] ) && (bool) $va_settings['showHexValueText'] ) {
			$vs_element .= "<div class='colorpickerText' id='{$id}_hexdisplay'>#{{" . $pa_element_info['element_id']
			               . "}}</div>";
		}
		...
		$vs_element .= "<div id='{$id}_colorchip' class='colorpicker_chip {$vs_class}' style='background-color: #{{"
		               . $pa_element_info['element_id']
		               . "}}; width: {$vs_width}; height: {$vs_height};'><!-- empty --></div>";
