...
$_ca_attribute_settings['TaxonomyAttributeValue'] = array(        // global
    ...
    'doesNotTakeLocale' => array(
        ...
        'description' => _t(
            'Check this option if you don\'t want your Taxonomy values to be locale-specific. (The default is to not be.)'
        )
    ),
...
class TaxonomyAttributeValue extends AttributeValue implements IAttributeValue
{
    ...
    public function htmlFormElement($pa_element_info, $pa_options = null)
    {
        ...
        $vs_element .= " <a href='#' style='display: none;' id='{fieldNamePrefix}" . $pa_element_info['element_id'] . "_link{n}' target='_taxonomy_details'>" . _t(
                "More"
            ) . "</a>";
