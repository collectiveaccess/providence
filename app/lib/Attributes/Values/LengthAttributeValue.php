                    ...
                    if ($vn_decimal > 0) {
                        switch ($vs_convert_to_units) {
                            case Zend_Measure_Length::FEET:
                                ...
                                $vo_inches = new Zend_Measure_Length(
                                    $vn_inches, Zend_Measure_Length::INCH, $g_ui_locale
                                );
                                ...
                                if ($vn_inches > 0) {
                                    $vs_value .= " " . caLengthToFractions(
                                            $vn_inches,
                                            $vn_maximum_denominator,
                                            true,
                                            [
                                                'precision' => $this->config->get(
                            ...
                            case Zend_Measure_Length::MILE:
                                ...
                                $vo_feet = new Zend_Measure_Length(
                                    $vn_whole_feet,
                                ...
                                if (is_null($vn_precision)) {
                                    $vn_precision = $this->config->get(
                                        strtolower($vs_convert_to_units) . '_decimal_precision'
                                    );
                                }
