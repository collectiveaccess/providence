...
$_ca_attribute_settings['GeoNamesAttributeValue'] = array(        // global
    ...
    'doesNotTakeLocale' => array(
        ...
        'description' => _t(
            'Check this option if you don\'t want your GeoNames values to be locale-specific. (The default is to not be.)'
        )
    ),
    ...
    'canBeUsedInSort' => array(
        ...
        'description' => _t(
            'Check this option if this attribute value can be used for sorting of search results. (The default is not to be.)'
        )
    ),
    'disableMap' => array(
        'formatType' => FT_NUMBER,
    ...
    'canBeEmpty' => array(
        ...
        'description' => _t(
            'Check this option if you want to allow empty attribute values. This - of course - only makes sense if you bundle several elements in a container.'
        )
    ),
    ...
    'maxResults' => array(
        ...
        'description' => _t(
            'Determines the maximum number of results returned by GeoNames. Tweak this number if you want to speed up lookups.'
        )
    ),
    'gnElements' => array(
        'formatType' => FT_TEXT,
...
class GeoNamesAttributeValue extends AttributeValue implements IAttributeValue
{
    ...
    public function parseValue($ps_value, $pa_element_info, $pa_options = null)
    {
        ...
        if (!$ps_value) {
            if (!$va_settings["canBeEmpty"]) {
                $this->postError(
                    1970,
                    _t('Entry for <em>%1</em> was blank.', $pa_element_info['displayLabel']),
    ...
    public function htmlFormElement($pa_element_info, $pa_options = null)
    {
        ...
        $vs_element .= " <a href='#' class='caGeoNamesServiceMoreLink' id='{fieldNamePrefix}" . $pa_element_info['element_id'] . "_link{n}' target='_geonames_details'>" . _t(
                "More &rsaquo;"
            ) . "</a>";
