...
class NumericAttributeValue extends AttributeValue implements IAttributeValue {
	...
	public function parseValue( $ps_value, $pa_element_info, $pa_options = null ) {
		...
		if ( $va_settings['minChars'] && ( $vn_strlen < $va_settings['minChars'] ) ) {
			// length is too short
			$vs_err_str = ( $va_settings['minChars'] == 1 ) ? _t( '%1 must be at least 1 character long',
		...
		if ( $va_settings['maxChars'] && ( $vn_strlen > $va_settings['maxChars'] ) ) {
			// length is too long
			$vs_err_str = ( $va_settings['minChars'] == 1 ) ? _t( '%1 must be no more than 1 character long',
				$pa_element_info['displayLabel'] )
		...
		if ( ! ( is_numeric( $ps_value ) ) ) {
			...
			$this->postError( 1970, _t( '%1 is not a numeric value', $pa_element_info['displayLabel'] ),
				'NumericAttributeValue->parseValue()' );
