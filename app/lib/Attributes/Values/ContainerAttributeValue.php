...
$_ca_attribute_settings['ContainerAttributeValue'] = array(        // global
    'doesNotTakeLocale' => array(
        ...
        'description' => _t(
            'Check this option if you don\'t want your compound attributes to be locale-specific. (The default is to be.)'
        )
    ),
    'lineBreakAfterNumberOfElements' => array(
        ...
        'description' => _t(
            'Insert number of metadata elements after which a line break should be inserted here. (Default is 0 - i.e. no line breaks)'
        )
    ),
