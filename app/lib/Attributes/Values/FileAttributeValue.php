...
class FileAttributeValue extends AttributeValue implements IAttributeValue {
	...
	/**
	 * Options:
	 *  return - valid settings are url and path; if set to a valid value then the url or path for the file is returned
	 *  rather than display HTML
	 *
	 */
	public function getDisplayValue( $pa_options = null ) {
		...
		if ( $vs_url = $this->opo_file_info_coder->getFileUrl( $this->opa_file_data ) ) {
			...
			if ( is_object( $pa_options['request'] ) ) {
				$vs_val .= caNavLink( $pa_options['request'],
	...
	public function htmlFormElement( $pa_element_info, $pa_options = null ) {
		...
		$vs_element .= '<div id="{fieldNamePrefix}upload_control_{n}" class="attributeFileDownloadControl">'
		               . _t( "Set file" ) . ': <input type="file" name="{fieldNamePrefix}'
