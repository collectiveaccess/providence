...
class AuthenticationManager
{
    ...
    public static function init($ps_adapter = null)
    {
        if (!is_null($ps_adapter) || (self::$g_authentication_adapter === null)) {
            AuthenticationManager::$g_authentication_conf = $o_auth_config = Configuration::load(
                __CA_APP_DIR__ . "/conf/authentication.conf"
            );
    ...
    public static function authenticate($ps_username, $ps_password = "", $pa_options = null)
    {
        ...
        if ((AuthenticationManager::$g_authentication_conf->get(
                'allow_fallback_to_ca_users_auth'
    ...
    public static function callback($pa_options = null)
    {
        ...
        if (method_exists(
                self::$g_authentication_adapter,
                "callback"
            ) && ($vn_rc = self::$g_authentication_adapter->callback($pa_options))) {
            return $vn_rc;
        }
