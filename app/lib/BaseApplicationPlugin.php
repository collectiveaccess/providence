...
abstract class BaseApplicationPlugin implements IApplicationPlugin {
	 ...
	 * implementation returns a status without errors but with the 'available' flag set to false (ie. plug isn't
	 * functional)
	 *
	 * @return array associative array indicating availability of plugin, and any initialization errors and warnings.
	 *               Also includes text description of plugin for display.
	 */
