...
class Media extends BaseObject
{
     ...
     *
     */
    static public $WLMedia_plugin_cache = [];

    /**
     *
     */
    static public $WLMedia_unregistered_plugin_cache = [];

    /**
     *
     */
    static public $WLMedia_plugin_names = null;
     ...
     *
     */
    static public $s_file_extension_to_plugin_map = null;

    /**
     *
     */
    static public $s_divine_cache = [];
    ...
    public static function getMimetypeForExtension($ps_extension)
    {
        ...
        CompositeCache::save(
            $ps_extension,
            $ret = $va_formats[strtolower($ps_extension)],
