<?php
/** ---------------------------------------------------------------------
 * app/interfaces/ILabelable.php : interface for database entities that support multilingual labeling (aka. multiple
 * titles or names)
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
interface ILabelable {
	...
	public function editLabel(
		$pn_label_id, $pa_label_values, $pn_locale_id, $pn_type_id = null, $pb_is_preferred = false
	);
