...
class TooltipManager {
	 ...
	 * @param string $ps_namespace    Optional namespace specifier; allows you to group tooltip code and output
	 *                                different tool tips at different times in the request cycle
	 *
	...
	static function getLoadHTML( $ps_namespace = 'default' ) {
		...
		if ( isset( TooltipManager::$opa_tooltips[ $ps_namespace ] )
		     && is_array( TooltipManager::$opa_tooltips[ $ps_namespace ] )
		) {
			$vs_class = ( isset( TooltipManager::$opa_namespace_classes[ $ps_namespace ] )
			              && TooltipManager::$opa_namespace_classes[ $ps_namespace ] )
				? TooltipManager::$opa_namespace_classes[ $ps_namespace ] : "tooltipFormat";
			$vs_buf   .= caGetTooltipJS( TooltipManager::$opa_tooltips[ $ps_namespace ], $vs_class );
		}

		if ( isset( TooltipManager::$opa_tooltip_functions[ $ps_namespace ] )
		     && is_array( TooltipManager::$opa_tooltip_functions[ $ps_namespace ] )
		) {
