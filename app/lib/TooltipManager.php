...
class TooltipManager
{
    ...
    static function getLoadHTML($ps_namespace = 'default')
    {
        ...
        if (isset(TooltipManager::$opa_tooltips[$ps_namespace]) && is_array(
                TooltipManager::$opa_tooltips[$ps_namespace]
            )) {
        ...
        if (isset(TooltipManager::$opa_tooltip_functions[$ps_namespace]) && is_array(
                TooltipManager::$opa_tooltip_functions[$ps_namespace]
            )) {
