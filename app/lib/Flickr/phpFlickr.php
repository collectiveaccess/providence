...
class phpFlickr
{
        ...
        if ($type == 'db') {
            ...
            if ($dir = opendir($this->cache_dir)) {
                while ($file = readdir($dir)) {
                    if (substr($file, -6) == '.cache' && ((filemtime(
                                    $this->cache_dir . '/' . $file
                                ) + $cache_expire) < time())) {
    ...
    public function request($command, $args = array(), $nocache = false)
    {
        ...
        $args = array_merge(
            array("method" => $command, "format" => "json", "nojsoncallback" => "1", "api_key" => $this->api_key),
            $args
        );
        if (!empty($this->token)) {
    ...
    public function auth($perms = "read", $remember_uri = true)
    {
        ...
        if (empty($_SESSION['phpFlickr_auth_token']) && empty($this->token)) {
            ...
            if ($this->service == "23") {
                header(
                    "Location: http://www.23hq.com/services/auth/?api_key=" . $this->api_key . "&perms=" . $perms . "&api_sig=" . $api_sig
                );
            } else {
                header(
                    "Location: https://www.flickr.com/services/auth/?api_key=" . $this->api_key . "&perms=" . $perms . "&api_sig=" . $api_sig
                );
            }
            exit;
        } else {
    ...
    public function auth_url($frob, $perms = 'read')
    {
        ...
        return sprintf(
            'https://flickr.com/services/auth/?api_key=%s&perms=%s&frob=%s&api_sig=%s',
            $this->api_key,
            $perms,
            $frob,
            $sig
    ...
    */
    ...
    public function blogs_postPhoto(
        $blog_id = null,
        $photo_id,
        $title,
        $description,
    ...
    public function favorites_getList(
        $user_id = null,
        $jump_to = null,
        $min_fave_date = null,
        $max_fave_date = null,
    ...
    public function favorites_getPublicList(
        $user_id,
        $jump_to = null,
        $min_fave_date = null,
        $max_fave_date = null,
    ...
    public function groups_pools_getPhotos(
        $group_id,
        $tags = null,
        $user_id = null,
        $jump_to = null,
    ...
    public function interestingness_getList(
        $date = null,
        $use_panda = null,
        $extras = null,
        $per_page = null,
    ...
    public function people_getPublicPhotos(
        $user_id,
        $safe_search = null,
        $extras = null,
        $per_page = null,
    ...
    public function photos_getContactsPhotos(
        $count = null,
        $just_friends = null,
        $single_photo = null,
        $include_self = null,
    ...
    public function photos_getContactsPublicPhotos(
        $user_id,
        $count = null,
        $just_friends = null,
        $single_photo = null,
    ...
    public function photos_getInfo(
        $photo_id,
        $secret = null,
        $humandates = null,
        $privacy_filter = null,
    ...
    public function photos_getNotInSet(
    ...
    public function photos_getUntagged(
        $min_upload_date = null,
        $max_upload_date = null,
        $min_taken_date = null,
        $max_taken_date = null,
    ...
    public function photos_setMeta($photo_id, $title, $description)
    {
        ...
        $this->request(
            ...
            array("photo_id" => $photo_id, "title" => $title, "description" => $description),
            true
        );
        return $this->parsed_response ? true : false;
    }
    ...
    public function photos_comments_addComment($photo_id, $comment_text)
    {
        ...
        $this->request(
            ...
            array("photo_id" => $photo_id, "comment_text" => $comment_text),
            true
        );
    ...
    public function photos_comments_editComment($comment_id, $comment_text)
    {
        ...
        $this->request(
            ...
            array("comment_id" => $comment_id, "comment_text" => $comment_text),
            true
        );
        return $this->parsed_response ? true : false;
    }

    public function photos_comments_getList(
        $photo_id,
    ...
    public function photos_comments_getRecentForContacts(
    ...
    public function photos_geo_photosForLocation(
        $lat,
        $lon,
        $accuracy = null,
        $extras = null,
    ...
    public function photos_geo_setLocation(
        $photo_id,
        $lat,
        $lon,
        $accuracy = null,
    ...
    public function photos_licenses_setLicense($photo_id, $license_id)
    {
        ...
        $this->request(
            ...
            array("photo_id" => $photo_id, "license_id" => $license_id),
            true
        );
        return $this->parsed_response ? true : false;
    }
    ...
    public function photos_people_add(
        $photo_id,
        $user_id,
        $person_x = null,
        $person_y = null,
    ...
    public function photos_people_editCoords(
        $photo_id,
        $user_id,
        $person_x,
        $person_y,
    ...
    public function photosets_create($title, $description, $primary_photo_id)
    {
        ...
        $this->request(
            ...
            array("title" => $title, "primary_photo_id" => $primary_photo_id, "description" => $description),
            true
        );
    ...
    public function photosets_editMeta($photoset_id, $title, $description = null)
    {
        ...
        $this->request(
            ...
            array("photoset_id" => $photoset_id, "title" => $title, "description" => $description),
            true
        );
        return $this->parsed_response ? true : false;
    }
    ...
    public function photosets_getPhotos(
        $photoset_id,
        $extras = null,
        $privacy_filter = null,
        $per_page = null,
    ...
    public function photosets_comments_addComment($photoset_id, $comment_text)
    {
        ...
        $this->request(
            ...
            array("photoset_id" => $photoset_id, "comment_text" => $comment_text),
            true
        );
        return $this->parsed_response ? $this->parsed_response['comment'] : false;
    }
    ...
    public function places_placesForContacts(
        $place_type = null,
        $place_type_id = null,
        $woe_id = null,
        $place_id = null,
    ...
    public function places_placesForTags(
        $place_type_id,
        $woe_id = null,
        $place_id = null,
        $threshold = null,
    ...
    public function places_placesForUser(
        $place_type_id = null,
        $place_type = null,
        $woe_id = null,
        $place_id = null,
    ...
    public function places_tagsForPlace(
        $woe_id = null,
        $place_id = null,
        $min_upload_date = null,
        $max_upload_date = null,
