...
class ProgressBar {
	 ...
	 *                          state of the progress bar is written into a persistent cache associated with the
	 *                          job_id. This enables progress bars that can be restored across multiple HTTP requests
	 */
	 ...
	 *
	 * @return string Progress bar output. If mode is CLI and outputToTerminal property is set, output will also be
	 *                printed to terminal.
	 */
	...
	private function getCache() {
		...
		if ( CompositeCache::contains( $this->ops_job_id, 'ProgressBar' ) ) {
			...
			$va_data = array( 'total'    => $this->getTotal(),
			                  'start'    => $this->opn_start,
	 ...
	 *
	 * @param string $ps_job_id  Optional job_id to get progress bar data for. If omitted the currently set job_id is
	 *                           used.
	 * @param string $ps_message The message
	 * @param array  $pa_data    Optional data array to stash
	 *
