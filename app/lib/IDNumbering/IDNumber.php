...
abstract class IDNumber implements IIDNumbering {
	 ...
	 * @param string $ps_parent_value Optional parent identifier value, used to populate PARENT elements in multipart
	 *                                id numbers (and perhaps in other plugins as well) [Default is null]
	 *
	 ...
	 *
	 * @param mixed A type (string) or array of types to set as current type. If an array is passed then each type is
	 *                attempted in turn until a valid type is found. If no valid types are found the type will be set
	 *                to '__default__'
	 *
