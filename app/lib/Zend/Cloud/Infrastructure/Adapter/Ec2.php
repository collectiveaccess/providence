...
class Zend_Cloud_Infrastructure_Adapter_Ec2 extends Zend_Cloud_Infrastructure_Adapter_AbstractAdapter
{
    ...
    public function __construct($options = array())
    {
        ...
        try {
            $this->ec2 = new Zend_Service_Amazon_Ec2_Instance(
    ...
    public function createInstance($name, $options)
    {
        ...
        $this->error = false;
        return new Zend_Cloud_Infrastructure_Instance(
            $this,
    ...
    public function zonesInstance()
    {
        if (!isset($this->ec2Zone)) {
            $this->ec2Zone = new Zend_Service_Amazon_Ec2_AvailabilityZones(
                $this->accessKey,
                $this->accessSecret,
                $this->region
            );
    ...
    public function monitorInstance($id, $metric, $options = null)
    {
        ...
        if (!isset($this->ec2Monitor)) {
            $this->ec2Monitor = new Zend_Service_Amazon_Ec2_CloudWatch(
                $this->accessKey,
                $this->accessSecret,
                $this->region
            );
