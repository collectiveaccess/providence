...
class Zend_Service_Amazon_OfferSet
{
    ...
    public function __construct(DOMElement $dom)
    {
        ...
        if ($offer->length == 1) {
            ...
            $this->TotalCollectible = (int)$xpath->query('./az:OfferSummary/az:TotalCollectible/text()', $dom)->item(
                0
            )->data;
            $this->TotalRefurbished = (int)$xpath->query('./az:OfferSummary/az:TotalRefurbished/text()', $dom)->item(
                0
            )->data;
        }
