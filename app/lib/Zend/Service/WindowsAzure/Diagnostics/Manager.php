...
class Zend_Service_WindowsAzure_Diagnostics_Manager
{
    ...
    protected function _getCurrentRoleInstanceId()
    {
        ...
        if (!isset($_SERVER['RoleDeploymentID']) && !isset($_SERVER['RoleInstanceID']) && !isset($_SERVER['RoleName'])) {
            throw new Exception(
                'Server variables \'RoleDeploymentID\', \'RoleInstanceID\' and \'RoleName\' are unknown. Please verify the application is running in Development Fabric or Windows Azure Fabric.'
            );
        }
    ...
    public function getConfigurationForRoleInstance($roleInstance = null)
    {
        ...
        if ($this->_blobStorageClient->blobExists($this->_controlContainer, $roleInstance)) {
            ...
            $configurationInstance->loadXml(
                $this->_blobStorageClient->getBlobData($this->_controlContainer, $roleInstance)
            );
     ...
     * @throws Zend_Service_WindowsAzure_Diagnostics_Exception
     */
    public function setConfigurationForRoleInstance(
        $roleInstance = null,
        Zend_Service_WindowsAzure_Diagnostics_ConfigurationInstance $configuration
    ) {
        if (is_null($roleInstance)) {
        ...
        $this->_blobStorageClient->putBlobData(
