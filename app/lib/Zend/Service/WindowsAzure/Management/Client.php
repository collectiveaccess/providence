...
class Zend_Service_WindowsAzure_Management_Client
{
    ...
    public function getOperationStatus($requestId = '')
    {
        ...
        if ($response->isSuccessful()) {
            ...
            throw new Zend_Service_WindowsAzure_Management_Exception(
     ...
     * @throws Zend_Service_WindowsAzure_Management_Exception
     */
    public function listSubscriptionOperations(
        $startTime,
        $endTime,
        $objectIdFilter = null,
        ...
        if ($operationResultFilter != '' && !is_null($operationResultFilter)) {
            ...
            if ($operationResultFilter != 'succeeded' && $operationResultFilter != 'failed' && $operationResultFilter != 'inprogress') {
                require_once 'Zend/Service/WindowsAzure/Management/Exception.php';
                throw new Zend_Service_WindowsAzure_Management_Exception(
                    'OperationResultFilter should be succeeded|failed|inprogress.'
                );
            }
        }
        ...
        if ($response->isSuccessful()) {
            ...
            foreach ($xmlOperations as $xmlOperation) {
                ...
                foreach ($xmlParameters as $xmlParameter) {
                    $xmlParameterDetails = $xmlParameter->children(
                        'http://schemas.datacontract.org/2004/07/Microsoft.Samples.WindowsAzure.ServiceManagement'
                    );
                    $operation->addOperationParameter(
                        (string)$xmlParameterDetails->Name,
                        (string)$xmlParameterDetails->Value
                    );
                }
            ...
            if (!is_null($result->ContinuationToken) && $result->ContinuationToken != '') {
                $returnValue = array_merge(
                    $returnValue,
                    $this->listSubscriptionOperations(
                        $startTime,
                        $endTime,
                        $objectIdFilter,
     ...
     */
    public function createBlobClientForService(
        $serviceName,
        Zend_Service_WindowsAzure_RetryPolicy_RetryPolicyAbstract $retryPolicy = null
    ) {
     ...
     */
    public function createTableClientForService(
        $serviceName,
        Zend_Service_WindowsAzure_RetryPolicy_RetryPolicyAbstract $retryPolicy = null
    ) {
        if ($serviceName == '' || is_null($serviceName)) {
     ...
     */
    public function createQueueClientForService(
        $serviceName,
        Zend_Service_WindowsAzure_RetryPolicy_RetryPolicyAbstract $retryPolicy = null
    ) {
        if ($serviceName == '' || is_null($serviceName)) {
     ...
     */
    public function createHostedService(
        $serviceName,
        $label,
        $description = '',
        $location = null,
        ...
        if (strlen($label) > 100) {
            require_once 'Zend/Service/WindowsAzure/Management/Exception.php';
            throw new Zend_Service_WindowsAzure_Management_Exception(
                'Label is too long. The maximum length is 100 characters.'
            );
        }
        if (strlen($description) > 1024) {
            require_once 'Zend/Service/WindowsAzure/Management/Exception.php';
            throw new Zend_Service_WindowsAzure_Management_Exception(
                'Description is too long. The maximum length is 1024 characters.'
            );
        }
        if ((is_null($location) && is_null($affinityGroup)) || (!is_null($location) && !is_null($affinityGroup))) {
            require_once 'Zend/Service/WindowsAzure/Management/Exception.php';
            throw new Zend_Service_WindowsAzure_Management_Exception(
                'Please specify a location -or- an affinity group for the service.'
            );
        }
        ...
        $response = $this->_performRequest(
            ...
            '<CreateHostedService xmlns="http://schemas.microsoft.com/windowsazure"><ServiceName>' . $serviceName . '</ServiceName><Label>' . base64_encode(
                $label
            ) . '</Label><Description>' . $description . '</Description>' . $locationOrAffinityGroup . '</CreateHostedService>'
        );
    ...
    public function updateHostedService($serviceName, $label, $description = '')
    {
        ...
        $response = $this->_performRequest(
            ...
            array('Content-Type' => 'application/xml; charset=utf-8'),
            '<UpdateHostedService xmlns="http://schemas.microsoft.com/windowsazure"><Label>' . base64_encode(
                $label
            ) . '</Label><Description>' . $description . '</Description></UpdateHostedService>'
        );
    ...
    public function createDeployment(
        ...
        $response = $this->_performRequest(
            ...
            Zend_Http_Client::POST,
            array('Content-Type' => 'application/xml; charset=utf-8'),
            '<CreateDeployment xmlns="http://schemas.microsoft.com/windowsazure"><Name>' . $name . '</Name><PackageUrl>' . $packageUrl . '</PackageUrl><Label>' . base64_encode(
                $label
            ) . '</Label><Configuration>' . base64_encode(
                $conformingConfiguration
            ) . '</Configuration><StartDeployment>' . ($startDeployment ? 'true' : 'false') . '</StartDeployment><TreatWarningsAsError>' . ($treatWarningsAsErrors ? 'true' : 'false') . '</TreatWarningsAsError></CreateDeployment>'
        );
    ...
    protected function _updateDeploymentStatus($operationUrl, $status = 'running')
    {
        $response = $this->_performRequest(
            ...
            Zend_Http_Client::POST,
            array('Content-Type' => 'application/xml; charset=utf-8'),
            '<UpdateDeploymentStatus xmlns="http://schemas.microsoft.com/windowsazure"><Status>' . ucfirst(
                $status
                ...
                if (!is_null($xmlRoles)) {
                    for ($i = 0; $i < count($xmlRoles); $i++) {
                        $roles[] = array(
                            ...
                            'osversion' => (!is_null(
                                $xmlRoles[$i]->OsVersion
                            ) ? (string)$xmlRoles[$i]->OsVersion : (string)$xmlRoles[$i]->OperatingSystemVersion)
                        );
                    }
                }
    ...
    protected function _configureDeployment($operationUrl, $configuration)
    {
        ...
        $response = $this->_performRequest(
            ...
            Zend_Http_Client::POST,
            array('Content-Type' => 'application/xml; charset=utf-8'),
            '<ChangeConfiguration xmlns="http://schemas.microsoft.com/windowsazure" xmlns:i="http://www.w3.org/2001/XMLSchema-instance"><Configuration>' . base64_encode(
                $conformingConfiguration
     ...
     * @throws Zend_Service_WindowsAzure_Management_Exception
     */
    public function upgradeDeploymentBySlot(
        $serviceName,
        $deploymentSlot,
        $label,
        $packageUrl,
     ...
     * @throws Zend_Service_WindowsAzure_Management_Exception
     */
    public function upgradeDeploymentByDeploymentId(
        $serviceName,
        $deploymentId,
        $label,
        $packageUrl,
    ...
    protected function _upgradeDeployment($operationUrl, $label, $packageUrl, $configuration, $mode, $roleToUpgrade)
    {
        ...
        $response = $this->_performRequest(
            ...
            Zend_Http_Client::POST,
            array('Content-Type' => 'application/xml; charset=utf-8'),
            '<UpgradeDeployment xmlns="http://schemas.microsoft.com/windowsazure"><Mode>' . ucfirst(
                $mode
            ) . '</Mode><PackageUrl>' . $packageUrl . '</PackageUrl><Configuration>' . base64_encode(
                $conformingConfiguration
            ) . '</Configuration><Label>' . base64_encode($label) . '</Label>' . (!is_null(
                $roleToUpgrade
            ) ? '<RoleToUpgrade>' . $roleToUpgrade . '</RoleToUpgrade>' : '') . '</UpgradeDeployment>'
        );
    ...
    public function getCertificate($serviceName, $algorithm = '', $thumbprint = '')
    {
        if ($serviceName == '' || is_null($serviceName)) {
            require_once 'Zend/Service/WindowsAzure/Management/Exception.php';
            throw new Zend_Service_WindowsAzure_Management_Exception(
                'Service name or certificate URL should be specified.'
            );
        }
        if (strpos($serviceName, 'https') === false && ($algorithm == '' || is_null(
                    $algorithm
                )) && ($thumbprint == '' || is_null($thumbprint))) {
            require_once 'Zend/Service/WindowsAzure/Management/Exception.php';
        ...
        if (strpos($serviceName, 'https') === false) {
            $operationUrl = self::OP_HOSTED_SERVICES . '/' . $serviceName . '/certificates/' . $algorithm . '-' . strtoupper(
                    $thumbprint
                );
        }
    ...
    public function addCertificate($serviceName, $certificateData, $certificatePassword, $certificateFormat = 'pfx')
    {
        ...
        $response = $this->_performRequest(
            ...
            Zend_Http_Client::POST,
            array('Content-Type' => 'application/xml; charset=utf-8'),
            '<CertificateFile xmlns="http://schemas.microsoft.com/windowsazure"><Data>' . base64_encode(
                $certificateData
            ) . '</Data><CertificateFormat>' . $certificateFormat . '</CertificateFormat><Password>' . $certificatePassword . '</Password></CertificateFile>'
        );
    ...
    public function createAffinityGroup($name, $label, $description = '', $location = '')
    {
        ...
        $response = $this->_performRequest(
            ...
            Zend_Http_Client::POST,
            array('Content-Type' => 'application/xml; charset=utf-8'),
            '<CreateAffinityGroup xmlns="http://schemas.microsoft.com/windowsazure"><Name>' . $name . '</Name><Label>' . base64_encode(
                $label
            ) . '</Label><Description>' . $description . '</Description><Location>' . $location . '</Location></CreateAffinityGroup>'
        );
    ...
    public function updateAffinityGroup($name, $label, $description = '')
    {
        ...
        $response = $this->_performRequest(
            ...
            Zend_Http_Client::PUT,
            array('Content-Type' => 'application/xml; charset=utf-8'),
            '<UpdateAffinityGroup xmlns="http://schemas.microsoft.com/windowsazure"><Label>' . base64_encode(
                $label
            ) . '</Label><Description>' . $description . '</Description></UpdateAffinityGroup>'
        );
