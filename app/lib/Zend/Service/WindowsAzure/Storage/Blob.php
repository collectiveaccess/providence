...
class Zend_Service_WindowsAzure_Storage_Blob extends Zend_Service_WindowsAzure_Storage
{
        ...
        if ($response->isSuccessful()) {
            if ($signedIdentifiers == false) {
                ...
                $accessType = $response->getHeader(
                    Zend_Service_WindowsAzure_Storage::PREFIX_STORAGE_HEADER . 'blob-public-access'
                );
     ...
     * @return string
     */
    public function generateSharedAccessUrl(
        $containerName = '',
        $blobName = '',
        $resource = 'b',
        $permissions = 'r',
