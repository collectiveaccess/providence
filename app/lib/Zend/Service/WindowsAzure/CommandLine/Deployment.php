    ...
    extends Zend_Service_Console_Command
{
     ...
     */
    public function createFromStorageCommand(
        $subscriptionId,
        $certificate,
     ...
     */
    public function createFromLocalCommand(
        $subscriptionId,
        $certificate,
        $certificatePassphrase,
        $serviceName,
        ...
        $client = new Zend_Service_WindowsAzure_Management_Client(
     ...
     */
    public function getPropertiesCommand(
        $subscriptionId,
        $certificate,
        $certificatePassphrase,
        $serviceName,
     ...
     */
    public function getPropertyCommand(
        $subscriptionId,
        $certificate,
        $certificatePassphrase,
        $serviceName,
    ...
    public function swapCommand(
        ...
        if (is_null($stagingDeploymentName)) {
            require_once 'Zend/Service/Console/Exception.php';
            throw new Zend_Service_Console_Exception(
                'Swapping deployment slots is only possible when both slots have an active deployment or when production slot is empty.'
            );
        }
     ...
     */
    public function updateConfigurationCommand(
        $subscriptionId,
        $certificate,
        $certificatePassphrase,
        $serviceName,
     ...
     */
    public function editInstanceNumberCommand(
        $subscriptionId,
        $certificate,
        $certificatePassphrase,
        $serviceName,
     ...
     */
    public function rebootInstanceCommand(
        $subscriptionId,
        $certificate,
        $certificatePassphrase,
        $serviceName,
     ...
     * @command-example --RoleInstanceName:"PhpOnAzure.Web_IN_0"
     */
    public function reimageInstanceCommand(
        $subscriptionId,
        $certificate,
        $certificatePassphrase,
        $serviceName,
     ...
     * @command-parameter-for $waitForOperation Zend_Service_Console_Command_ParameterSource_Argv|Zend_Service_Console_Command_ParameterSource_ConfigFile --WaitFor|-w Optional. Wait for the operation to complete?
     */
    public function upgradeFromStorageCommand(
        $subscriptionId,
        $certificate,
        $certificatePassphrase,
        $serviceName,
        ...
        if (!is_null($deploymentSlot) && $deploymentSlot != '') {
            ...
            $client->upgradeDeploymentBySlot(
                $serviceName,
                $deploymentSlot,
                $label,
                $packageUrl,
            ...
            $client->upgradeDeploymentByDeploymentId(
                $serviceName,
                $deploymentName,
                $label,
                $packageUrl,
     ...
     * @command-parameter-for $waitForOperation Zend_Service_Console_Command_ParameterSource_Argv|Zend_Service_Console_Command_ParameterSource_ConfigFile --WaitFor|-w Optional. Wait for the operation to complete?
     */
    public function upgradeFromLocalCommand(
        $subscriptionId,
        $certificate,
        $certificatePassphrase,
        $serviceName,
     ...
     * @command-parameter-for $waitForOperation Zend_Service_Console_Command_ParameterSource_Argv|Zend_Service_Console_Command_ParameterSource_ConfigFile --WaitFor|-w Optional. Wait for the operation to complete?
     */
    public function walkUpgradeDomainsCommand(
        $subscriptionId,
        $certificate,
        $certificatePassphrase,
        $serviceName,
