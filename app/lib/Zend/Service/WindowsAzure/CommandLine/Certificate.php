    ...
    extends Zend_Service_Console_Command
{
     ...
     */
    public function addCertificateCommand(
        $subscriptionId,
        $certificate,
     ...
     */
    public function getCertificateCommand(
        $subscriptionId,
        $certificate,
        $certificatePassphrase,
        $serviceName,
     ...
     * @command-example Get -sid:"<your_subscription_id>" -cert:"mycert.pem" -sn:"phptest" --CertificateThumbprint:"<thumbprint>" --CertificateAlgorithm:"sha1"
     */
    public function getCertificatePropertyCommand(
        $subscriptionId,
        $certificate,
        $certificatePassphrase,
        $serviceName,
     ...
     * @command-example Get -sid:"<your_subscription_id>" -cert:"mycert.pem" -sn:"phptest" --CertificateThumbprint:"<thumbprint>" --CertificateAlgorithm:"sha1"
     */
    public function deleteCertificateCommand(
        $subscriptionId,
        $certificate,
        $certificatePassphrase,
        $serviceName,
