...
class MediaInfoCoder
{
            ...
            if (isset($va_media_info[$ps_version]["PAGES"]) && ($va_media_info[$ps_version]["PAGES"] > 1)) {
                ...
                return join(
                    ...
                    array(
                        ...
                        $va_media_info[$ps_version]["MAGIC"] . "_" . $va_media_info[$ps_version]["FILESTEM"] . "_" . $vn_page . "." . $va_media_info[$ps_version]["EXTENSION"]
                    )
                );
            } else {
                return join(
    ...
    public function getMediaTag($ps_version, $pa_options = null)
    {
        ...
        $vs_url = caGetOption('usePath', $pa_options, false) ? $this->getMediaPath(
            $ps_version,
            $pa_options
