...
class MemoryCache {
	...
	public static function contains( $ps_key, $ps_namespace = 'default' ) {
		...
		return ( isset( self::$opa_caches[ $ps_namespace ] )
		         && array_key_exists( $ps_key, self::$opa_caches[ $ps_namespace ] ) );
	}
	# ------------------------------------------------
	...
	/**
	 * Get number of items for a given namespace. Compared to other cache operations this is very slow so use with
	 * caution!
	 *
	 * @param string $ps_namespace
	 *
