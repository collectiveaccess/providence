 		...
 		public function loadTypeSpecificValueFromRow($pa_value_array) {
 			...
 			switch($g_ui_units_pref) {
 				case 'metric':
 					...
 					$this->ops_text_value = (float)$vo_measurement->convertTo(Zend_Measure_Weight::KILOGRAM, 4);
 					break;
 				case 'english':
 					$vo_measurement = new Zend_Measure_Weight((float)$pa_value_array['value_decimal1'], 'KILOGRAM', $g_ui_locale);
 					$this->ops_text_value = (float)$vo_measurement->convertTo(Zend_Measure_Weight::POUND, 4);
 					break;
				default: // show value in unit entered, but adjusted for the UI locale
					try {
						...
						$this->ops_text_value = (float)$pa_value_array['value_longtext1'];
					}
					break;
 			}	
