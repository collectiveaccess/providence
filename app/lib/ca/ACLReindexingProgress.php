<?php
/** ---------------------------------------------------------------------
 * app/lib/ca/ACLReindexingProgress.php : AppController plugin to add page shell around content
 * ----------------------------------------------------------------------
 * CollectiveAccess
 ...
 */
  ...
  */
	...
	class ACLReindexingProgress extends AppControllerPlugin {
		# -------------------------------------------------------
		...
		public function dispatchLoopShutdown() {	
			...
			if ($req->isLoggedIn() && $req->user->canDoAction('can_do_search_reindex')) {
				...
				foreach(array(57, 20, 51, 13, 56, 67, 72, 89, 133, 137, 82, 153, 155, 33, 36) as $vn_table_num) {
					ca_acl::reindex($vn_table_num);
				}
