<?php
/** ---------------------------------------------------------------------
 * app/lib/ca/Browse/TourStopBrowse.php : ca_places faceted browse
 * ----------------------------------------------------------------------
 * CollectiveAccess
 ...
 */
  ...
  */
 	...
 	require_once(__CA_LIB_DIR__.'/ca/Browse/TourStopBrowseResult.php');
	...
	class TourStopBrowse extends BaseBrowse {
		...
		public function getResults($pa_options=null) {
			return parent::getResults(new TourStopBrowseResult(), $pa_options);
		}
		# ----------------------------------------------------------------------
	}
?>