    ...
    public function loadFile($ps_filepath, $pb_die_on_error = false, $pn_num_lines_to_read = null)
    {
        ...
        while (!feof($r_file)) {
            ...
            if ($vn_in_quote && !in_array($vn_state, [10, 20])) {
                switch ($vn_state) {
                    case 30:
                        $this->ops_error = "Missing trailing quote in list '$vs_key'<br/><strong>Last " . sizeof(
                                $va_token_history
                    ...
                    case 40:
                    case 50:
                        $this->ops_error = "Missing trailing quote in associative array '$vs_key'<br/><strong>Last " . sizeof(
                                $va_token_history
                            ) . " tokens were: </strong>" . $this->_formatTokenHistory(
                                $va_token_history,
                                array('outputAsHTML' => true)
