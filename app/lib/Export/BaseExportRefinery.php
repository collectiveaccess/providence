...
abstract class BaseExportRefinery {
	 ...
	 *
	 * @param array $pa_source_data   Array of data that to be exported. The refinery can make any required additions
	 *                                and modifications to this data; since it's passed by reference those changes will
	 *                                be returned.
	 * @param mixed $pa_exporter_item Specification and settings for the exporter item being processed. Settings are in
	 *                                an array under the "settings" key
