...
abstract class BaseExportFormat {
	...
	/**
	 * Converts array version of item-level export generated by ca_data_exporters string version of the implemented
	 * format. For more info on the format @param array $pa_data export data
	 *
	 * @param array $pa_options option array
	 *                          singleRecord = Gives a signal to the export format implementation that this is a single
	 *                          record export. For certain formats this might trigger different behavior, for instance
	 *                          the XML export format prepends the item-level output with <?xml ... ?> in those cases
	 *                          options = array of exporter options
	 *
	 * @return string export
	 * @see ca_data_exporters::processExporterItem()
	 */
