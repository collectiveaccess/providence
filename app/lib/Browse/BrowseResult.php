...
class WLPlugSearchEngineBrowseEngine extends WLPlug implements IWLPlugSearchEngineResult {
	...
	public function getHits( $pn_limit = null ) {
		return ( $pn_limit > 0 ) ? array_slice( $this->opa_hits, $this->opn_current_row + 1, $pn_limit )
			: $this->opa_hits;
	}
	...
	public function get( $ps_field, $pa_options = null ) {
		...
		if ( ( $ps_field == $this->ops_subject_primary_key )
		     || ( $ps_field == ( $this->ops_subject_table_name . '.' . $this->ops_subject_primary_key ) )
		) {
