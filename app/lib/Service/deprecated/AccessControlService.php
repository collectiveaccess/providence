...
class AccessControlService extends BaseService
{
    ...
    {
        return ($this->_setUserField($user_name, "fname", $new_fname) && $this->_setUserField(
                $user_name,
                "lname",
                $new_lname
            ));
     ...
     *
     * @param string $user_name user name
     * @return int Returns associative array of groups. Key is group id, value is array containing information about the group.
     *
