...
class AccessControlService extends BaseService {
	...
	public function setRealName( $user_name, $new_fname, $new_lname ) {
		return ( $this->_setUserField( $user_name, "fname", $new_fname )
		         && $this->_setUserField( $user_name, "lname", $new_lname ) );
	}
	# -------------------------------------------------------
	 ...
	 *                       userclass
	 *
	 * @return array List of users. Array is keyed on user_id and value is array with all ca_users fields + the
	 *               last_login time as a unix timestamp
	 *
	 */
	...
	/**
	 * Get list of all roles supported by the application. If you want to get the current user's roles, use
	 * getUserRoles()
	 *
	 * @return array Returns associative array of roles. Key is role id, value is array containing information about
	 *               the role.
	 *
	...
	/**
	 * Get list of all available user groups. If you want to get a list of the current user's groups, use
	 * getUserGroups()
	 *
	 * @param string $user_name user name
	 *
	 * @return integer Returns associative array of groups. Key is group id, value is array containing information
	 *                 about the group.
	 *
	 ...
	 * @param string $user_name user name
	 *
	 * @return array Returns associative array of groups. Key is group id, value is array containing information about
	 *               the group.
	 *
	 * The group information array contains the following keys:
	 *        group_id    (numeric id you can use in addRoles(), deleteRoles(), hasRole(), etc.)
	 ...
	 *
	 * @param string $user_name user name
	 * @param string $group     The group to test for the current user for membership in. Group may be specified by
