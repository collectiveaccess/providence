    ...
    public function dispatchLoopShutdown()
    {
        ...
        if ($req->isLoggedIn()) {
            ...
            if (isset($this->opa_options['isBatchDelete']) && $this->opa_options['isBatchDelete']) {
                $va_errors = BatchProcessor::deleteBatchForSet(
                    $this->request,
                    $this->ot_set,
                    $this->ot_subject,
                    array_merge(
                ...
                $va_errors = BatchProcessor::changeTypeBatchForSet(
                    $this->request,
                    $this->opa_options['type_id'],
                    $this->ot_set,
                    $this->ot_subject,
                    array_merge(
                        $this->opa_options,
                ...
                $va_errors = BatchProcessor::saveBatchEditorFormForSet(
                    $this->request,
                    $this->ot_set,
                    $this->ot_subject,
                    array_merge(
