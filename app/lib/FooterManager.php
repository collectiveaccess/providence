...
class FooterManager {
	 ...
	 *
	 * @param string $ps_namespace Optional namespace specifier; allows you to group tooltip code and output different
	 *                             tool tips at different times in the request cycle
	 *
	...
	static function getLoadHTML() {
		...
		if ( isset( FooterManager::$opa_code ) && is_array( FooterManager::$opa_code )
		     && sizeof( FooterManager::$opa_code )
		) {
