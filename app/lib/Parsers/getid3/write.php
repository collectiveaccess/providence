...
class getid3_writetags
{
    ...
    public function WriteTags()
    {
        ...
        foreach ($WritingFilesToInclude as $tagformat) {
            switch ($tagformat) {
                ...
                case 'real':
                    $GETID3_ERRORARRAY = &$this->errors;
                    if (!getid3_lib::IncludeDependency(
                        GETID3_INCLUDEPATH . 'write.' . $tagformat . '.php',
                        __FILE__,
                        false
                    )) {
                        return false;
        ...
        if (!empty($this->ThisFileInfo['tags'])) {
            foreach ($this->ThisFileInfo['tags'] as $tag_format => $tag_data_array) {
                foreach ($tag_data_array as $tag_key => $tag_array) {
                    if (strtoupper($tag_key) !== $tag_key) {
                        $this->ThisFileInfo['tags'][$tag_format][strtoupper(
                            $tag_key
                ...
                default:
                    foreach ($valuearray as $key => $value) {
                        if (is_string($value) || is_numeric($value)) {
                            $ape_tag_data[$tag_key][$key] = getid3_lib::iconv_fallback(
                                $this->tag_encoding,
                                'UTF-8',
                                $value
                            );
    ...
    public function FormatDataForID3v1()
    {
        ...
        $tag_data_id3v1['title'] = getid3_lib::iconv_fallback(
            ...
            implode(
                ' ',
                (isset($this->tag_data['TITLE']) ? $this->tag_data['TITLE'] : array())
            )
        );
        $tag_data_id3v1['artist'] = getid3_lib::iconv_fallback(
            ...
            implode(
                ' ',
                (isset($this->tag_data['ARTIST']) ? $this->tag_data['ARTIST'] : array())
            )
        );
        $tag_data_id3v1['album'] = getid3_lib::iconv_fallback(
            ...
            implode(
                ' ',
                (isset($this->tag_data['ALBUM']) ? $this->tag_data['ALBUM'] : array())
            )
        );
        $tag_data_id3v1['year'] = getid3_lib::iconv_fallback(
            ...
            implode(
                ' ',
                (isset($this->tag_data['YEAR']) ? $this->tag_data['YEAR'] : array())
            )
        );
        $tag_data_id3v1['comment'] = getid3_lib::iconv_fallback(
            ...
            implode(
                ' ',
                (isset($this->tag_data['COMMENT']) ? $this->tag_data['COMMENT'] : array())
            )
        );
        $tag_data_id3v1['track'] = intval(
            getid3_lib::iconv_fallback(
                $this->tag_encoding,
                'ISO-8859-1',
                implode(' ', (isset($this->tag_data['TRACKNUMBER']) ? $this->tag_data['TRACKNUMBER'] : array()))
            )
        );
                        ...
                        if (isset($ID3v2_text_encoding_lookup[$id3v2_majorversion][$this->tag_encoding])) {
                            ...
                            if ($id3v2_majorversion < 4) {
                                ...
                                if (!$ID3v2_tag_data_converted) {
                                    ...
                                    $tag_data_id3v2[$ID3v2_framename][$key]['data'] = "\xFF\xFE" . getid3_lib::iconv_fallback(
                                            $this->tag_encoding,
                                            'UTF-16LE',
                                            $value
                                ...
                                $tag_data_id3v2[$ID3v2_framename][$key]['data'] = getid3_lib::iconv_fallback(
                                    $this->tag_encoding,
                                    'UTF-8',
                                    $value
                                );
                ...
                if (strstr($value, "\n")) {
                    ...
                    foreach ($multilineexploded as $newcomment) {
                        if (strlen(trim($newcomment)) > 0) {
                            $tag_data_vorbiscomment[$tag_key][] = getid3_lib::iconv_fallback(
                                $this->tag_encoding,
                                'UTF-8',
                                $newcomment
                            );
                    ...
                    $tag_data_vorbiscomment[$tag_key][$key] = getid3_lib::iconv_fallback(
                        $this->tag_encoding,
                        'UTF-8',
                        $value
                    );
    ...
    public function FormatDataForReal()
    {
        ...
        $tag_data_real['copyright'] = getid3_lib::iconv_fallback(
            ...
            implode(
                ' ',
                (isset($this->tag_data['COPYRIGHT']) ? $this->tag_data['COPYRIGHT'] : array())
            )
        );
