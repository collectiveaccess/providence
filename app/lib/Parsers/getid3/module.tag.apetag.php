...
class getid3_apetag extends getid3_handler
{
    ...
    public function Analyze()
    {
        ...
        if (!getid3_lib::intValueSupported($info['filesize'])) {
            $info['warning'][] = 'Unable to check for APEtags because file is larger than ' . round(
        ...
        for ($i = 0; $i < $thisfile_ape['footer']['raw']['tag_items']; $i++) {
            ...
            switch (strtolower($item_key)) {
                ...
                case 'cover art (studio)':
                    ...
                    list($thisfile_ape_items_current['filename'], $thisfile_ape_items_current['data']) = explode(
                        "\x00",
                        $thisfile_ape_items_current['data'],
                        2
                    );
                    $thisfile_ape_items_current['data_offset'] = $thisfile_ape_items_current['offset'] + strlen(
                    ...
                    do {
                        ...
                        if ($this->inline_attachments === true) {
                            ...
                            if ($this->inline_attachments < $thisfile_ape_items_current['data_length']) {
                                // too big, skip
                                $info['warning'][] = 'attachment at ' . $thisfile_ape_items_current['offset'] . ' is too large to process inline (' . number_format(
                        ...
                        if (is_string($this->inline_attachments)) {
                            ...
                            $info['ape']['comments']['picture'][] = array(
                                'data' => $thisfile_ape_items_current['data'],
                                'image_mime' => $thisfile_ape_items_current['image_mime']
                            );
                        }
                    } while (false);
                    break;
