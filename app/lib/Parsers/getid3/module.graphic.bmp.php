    ...
    public function Analyze()
    {
        ...
        if ($thisfile_bmp['type_os'] == 'OS/2') {
            ...
            if ($thisfile_bmp['type_version'] >= 2) {
                ...
                $offset += 4;
                $thisfile_bmp_header_raw['bmp_data_size'] = getid3_lib::LittleEndian2Int(
                ...
                $offset += 4;
                $thisfile_bmp_header_raw['colors_important'] = getid3_lib::LittleEndian2Int(
                    substr($BMPheader, $offset, 4)
                );
                $offset += 4;
                $thisfile_bmp_header_raw['resolution_units'] = getid3_lib::LittleEndian2Int(
                    substr($BMPheader, $offset, 2)
                );
                $offset += 2;
                $thisfile_bmp_header_raw['reserved1'] = getid3_lib::LittleEndian2Int(substr($BMPheader, $offset, 2));
                $offset += 2;
                ...
                $offset += 4;
                $thisfile_bmp_header_raw['color_encoding'] = getid3_lib::LittleEndian2Int(
                    substr($BMPheader, $offset, 4)
                );
                $offset += 4;
                ...
                $thisfile_bmp_header['compression'] = $this->BMPcompressionOS2Lookup(
            ...
            $offset += 4;
            $thisfile_bmp_header_raw['resolution_h'] = getid3_lib::LittleEndian2Int(
                substr($BMPheader, $offset, 4),
                true
            );
            $offset += 4;
            $thisfile_bmp_header_raw['resolution_v'] = getid3_lib::LittleEndian2Int(
                substr($BMPheader, $offset, 4),
                true
            );
            $offset += 4;
            ...
            $thisfile_bmp_header['compression'] = $this->BMPcompressionWindowsLookup(
                $thisfile_bmp_header_raw['compression']
            );
            $info['video']['resolution_x'] = $thisfile_bmp_header_raw['width'];
            $info['video']['resolution_y'] = $thisfile_bmp_header_raw['height'];
            ...
            if (($thisfile_bmp['type_version'] >= 4) || ($thisfile_bmp_header_raw['compression'] == 3)) {
                ...
                $thisfile_bmp_header['ciexyz_red'] = getid3_lib::FixedPoint2_30(
                    strrev($thisfile_bmp_header_raw['ciexyz_red'])
                );
                $thisfile_bmp_header['ciexyz_green'] = getid3_lib::FixedPoint2_30(
                    strrev($thisfile_bmp_header_raw['ciexyz_green'])
                );
                $thisfile_bmp_header['ciexyz_blue'] = getid3_lib::FixedPoint2_30(
                    strrev($thisfile_bmp_header_raw['ciexyz_blue'])
                );
            }
            ...
            if ($thisfile_bmp['type_version'] >= 5) {
                ...
                $offset += 4;
                $thisfile_bmp_header_raw['profile_data_offset'] = getid3_lib::LittleEndian2Int(
                    substr($BMPheader, $offset, 4)
                );
                $offset += 4;
                $thisfile_bmp_header_raw['profile_data_size'] = getid3_lib::LittleEndian2Int(
                    substr($BMPheader, $offset, 4)
                );
                $offset += 4;
                            ...
                            for ($row = ($thisfile_bmp_header_raw['height'] - 1); $row >= 0; $row--) {
                                for ($col = 0; $col < $thisfile_bmp_header_raw['width']; $col++) {
                                    $thisfile_bmp['data'][$row][$col] = (ord(
                                            ...
                                            ) << 24) | (ord($BMPpixelData{$pixeldataoffset + 2}) << 16) | (ord(
                    ...
                    switch ($thisfile_bmp_header_raw['bits_per_pixel']) {
                        case 8:
                            ...
                            while ($pixeldataoffset < strlen($BMPpixelData)) {
                                ...
                                $secondbyte = getid3_lib::LittleEndian2Int(
