...
//return false;
                            ...
                            $info['warning'][] = 'exif_read_data() cannot parse non-EXIF data in APP1 (expected "Exif", found "' . substr(
                                    $imageinfo['APP1'],
                                    0,
                                    4
                                ) . '")';
        ...
        if (isset($info['jpg']['exif']['GPS'])) {
            ...
            if (isset($info['jpg']['exif']['GPS']['GPSDateStamp'])) {
                ...
                $info['jpg']['exif']['GPS']['computed']['timestamp'] = mktime(
                    $computed_time[0],
                    $computed_time[1],
                    $computed_time[2],
                    $computed_time[3],
            ...
            if (isset($info['jpg']['exif']['GPS']['GPSAltitudeRef'])) {
                $info['jpg']['exif']['GPS']['GPSAltitudeRef'] = ord(
            ...
            if (isset($info['jpg']['exif']['GPS']['GPSAltitude'])) {
                ...
                $info['jpg']['exif']['GPS']['computed']['altitude'] = $direction_multiplier * getid3_lib::DecimalizeFraction(
