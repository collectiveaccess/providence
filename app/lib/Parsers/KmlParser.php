		...
		foreach ( $va_placemarks as $va_placemark ) {
			...
			if ( isset( $va_placemark->Point ) ) {
				...
				if ( isset( $va_placemark->LineString ) && isset( $va_placemark->LineString->coordinates ) ) {
					...
					if ( isset( $va_placemark->Polygon ) && isset( $va_placemark->Polygon->outerBoundaryIs )
					     && isset( $va_placemark->Polygon->outerBoundaryIs->LinearRing )
					     && isset( $va_placemark->Polygon->outerBoundaryIs->LinearRing->coordinates )
					) {
