...
class ImageRepresentationAnnotationCoder extends BaseRepresentationAnnotationCoder implements
    IRepresentationAnnotationPropertyCoder
{
    # ------------------------------------------------------------------
    /**
     *
    ...
    public function setProperty($ps_property, $pm_value)
    {
        ...
        switch ($va_info['fieldType']) {
            case 'FT_NUMBER':
                ...
                $this->postError(
                    1500,
                    _t("Invalid numeric value '%1' for %2", $pm_value, $va_info['label']),
