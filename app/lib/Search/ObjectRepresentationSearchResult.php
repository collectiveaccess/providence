...
class ObjectRepresentationSearchResult extends BaseSearchResult {
	 ...
	 * @param RepresentableBaseModel $pt_subject A model instance loaded with the subject (the record the media is
	 *                                           shown in the context of. Eg. if a representation is shown for an
	 *                                           object this is an instance for that object record)
	...
	public function representationIsOfClass( $ps_class ) {
		...
		return ( preg_match( "!{$vs_mimetypes_regex}!", $this->get( 'ca_object_representations.mimetype' ) ) ) ? true
			: false;
	}
	# ------------------------------------------------------------------
