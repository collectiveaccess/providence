...
class BaseSearchResult extends SearchResult
{
    ...
    public function __construct($po_engine_result = null, $pa_tables = null)
    {
        ...
        $this->ops_label_table_name = method_exists(
            $this->opo_subject_instance,
            "getLabelTableName"
        ) ? $this->opo_subject_instance->getLabelTableName() : null;
        $this->ops_label_display_field = method_exists(
            $this->opo_subject_instance,
            "getLabelDisplayField"
    ...
    {
        return $this->get(
            $this->ops_table_name . '.preferred_labels.' . $this->ops_label_display_field,
