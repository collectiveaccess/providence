	...
	protected function __construct() {
		...
		if ( is_array( $this->opa_possible_errors ) ) {
			...
			foreach ( $this->opa_possible_errors as $vn_setting_num ) {
				...
				$this->opa_settings[ $this->opn_current_setting ]['status']
				                                                  = $this->checkSetting( $vn_setting_num );
				$this->opa_settings[ $this->opn_current_setting ]['description']
				                                                  = $this->getSettingDescription( $vn_setting_num );
				$this->opa_settings[ $this->opn_current_setting ]['name']
				                                                  = $this->getSettingName( $vn_setting_num );
				$this->opa_settings[ $this->opn_current_setting ]['hint']
				                                                  = $this->getSettingHint( $vn_setting_num );
