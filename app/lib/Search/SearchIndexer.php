                            ...
                            if ($va_hier_values = $this->_genHierarchicalPath(
                                ...
                                if (caGetOption('INDEX_ANCESTORS_AS_PATH_WITH_DELIMITER', $va_data, false) !== false) {
                                    ...
                                    $this->_genIndexInheritance(
                                        ...
                                        array_merge(
                                            $va_data,
                                            array('DONT_TOKENIZE' => 1, 'TOKENIZE' => 1)
                                        )
                                    );
                                }
                            }
                                        ...
                                        if ($vb_is_attr) {
                                            ...
                                            if (((isset($va_rel_field_info['INDEX_AS_IDNO']) && $va_rel_field_info['INDEX_AS_IDNO']) || in_array(
                                                ...
                                                $this->opo_engine->indexField(
                                                    ...
                                                    $vn_id = $qr_res->get($vs_related_pk),
                                                    $va_values,
                                                    array_merge(
                                                        $va_rel_field_info,
                                                        array(
                                            ...
                                            } elseif (((isset($va_rel_field_info['INDEX_AS_MIMETYPE']) && $va_rel_field_info['INDEX_AS_MIMETYPE']) || in_array(
                                                    'INDEX_AS_MIMETYPE',
                                                    $va_rel_field_info
                                                ))) {
                                                // specialized mimetype processing
                                                ...
                                                $this->opo_engine->indexField(
                                                    ...
                                                    $vn_rid = $qr_res->get($vs_related_pk),
                                                    [$vs_fld_data],
                                                    array_merge(
                                                        $va_rel_field_info,
                                                        array(
                                ...
                                if ($t_label = $t_rel->getLabelTableInstance()) {
                                    ...
                                    if (is_array($va_label_info['related']['fields']) && sizeof(
                                        ...
                                        if (is_array($va_restrict_self_indexing_to_types) && $t_rel->load(
                                                $vn_row_id
                                            ) && !in_array($t_rel->getTypeID(), $va_restrict_self_indexing_to_types)) {
                                            $vb_skip = true;
                                        }
                            ...
                            switch ($va_row_to_reindex['indexing_info']['datatype']) {
                                        ...
                                        if (sizeof($va_attributes)) {
                                            foreach ($va_attributes as $vo_attribute) {
                                                foreach ($vo_attribute->getValues() as $vo_value) {
                                                    ...
                                                    if ($t_rel = Datamodel::getInstanceByTableNum(
                                                        $va_row_to_reindex['table_num'],
                                                        true
                                                    )) {
                                                        $this->opo_engine->indexField(
                                ...
                                case __CA_ATTRIBUTE_VALUE_LIST__:            // list
                                    ...
                                    foreach ($va_tmp as $vn_attribute_id => $vn_item_id) {
                                        ...
                                        if (!isset($va_new_values[$vn_item_id]) || !is_array(
                                                $va_new_values[$vn_item_id]
                                            )) {
                                            continue;
                                        }
                                        $vs_v = join(
