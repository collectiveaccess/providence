...
class phpVimeo
{
     ...
     * @param string $url The base URL to use.
     * @param bool $cache Whether or not to cache the response.
     * @param bool $use_auth_header Use the OAuth Authorization header to pass the OAuth params.
    ...
    private function _request(
        ...
        $oauth_params['oauth_signature'] = $this->_generateSignature(
            array_merge($oauth_params, $api_params),
            $request_method,
            $url
        );
     ...
     * @param bool $session_store Store the token in a session variable
     * @return bool true
     */
     ...
     * @param bool $use_multiple_chunks Whether or not to split the file up into smaller chunks
