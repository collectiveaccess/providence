...
class CLIBaseUtils {
	 ...
	 */
	private static $ansiForegroundColors
		= array(
			'black'       => '0;30',
			'dark_gray'   => '1;30',
			'red'         => '0;31',
	 ...
	 */
	private static $ansiBackgroundColors
		= array(
			'black'      => '40',
			'red'        => '41',
			'magenta'    => '45',
	 ...
	 * @param string $ps_color  The color to output $ps_string in. Colors are defined in
	 *                          CLIBaseUtils::ansiForegroundColors
	 *
	 * @return string The string with ANSI color codes. If $ps_color is invalid the original string will be returned
	 *                without ANSI codes.
	 */
	 ...
	 *
	 * @param string $ps_string The string to output
	 * @param string $ps_color  The background color to output $ps_string with. Colors are defined in
	 *                          CLIBaseUtils::ansiBackgroundColors
	 *
	 * @return string The string with ANSI color codes. If $ps_color is invalid the original string will be returned
	 *                without ANSI codes.
	 */
