...
class InformationServiceManager
{
     ...
     */
    static public $s_information_service_manager_did_do_init = false;

    /**
     *
     */
    static public $s_information_service_instances = array();
    ...
    public static function getInformationServiceNames()
    {
        ...
        if (is_resource($r_dir = opendir($vs_base_service_dir))) {
            while (($vs_service = readdir($r_dir)) !== false) {
                ...
                if (file_exists($vs_base_service_dir . '/' . $vs_service) && preg_match(
    ...
    public static function checkInformationServiceStatus($ps_service_name)
    {
        ...
        if (isset(InformationServiceManager::$s_information_service_instances[$ps_service_name]) && is_object(
                InformationServiceManager::$s_information_service_instances[$ps_service_name]
            )) {
