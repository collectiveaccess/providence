...
class savedSearchesWidget extends BaseWidget implements IWidget {
	...
	public function renderWidget( $ps_widget_id, &$pa_settings ) {
		...
		foreach ( $va_tables as $vs_table ) {
			$va_searches[ $vs_table ]["basic_search"]    = $this->request->user->getSavedSearches( $vs_table,
				"basic_search" );
			$va_searches[ $vs_table ]["advanced_search"] = $this->request->user->getSavedSearches( $vs_table,
				"advanced_search" );
		}
