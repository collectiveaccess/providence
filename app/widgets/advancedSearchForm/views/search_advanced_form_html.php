...
?>
<?= caFormTag($this->request, 'Index/page/1', "AdvancedSearchForm_{$widget_id}", "find/{$controller_name}", 'post', 'multipart/form-data', '_top', array('noCSRFToken' => true, 'disableUnsavedChangesWarning' => true)); ?>
<?php 
