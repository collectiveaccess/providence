...
BaseModel::$s_ca_models_definitions['ca_object_representations_x_vocabulary_terms'] = array(
 	...
 	'FIELDS' 			=> array(
		...
		'is_primary' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => _t('Is primary?'), 'DESCRIPTION' => _t('Indicates that the representation should be used to depict the list item in situations where only a single representation can be displayed (eg. search results).')
		),
		'rank' => array(
