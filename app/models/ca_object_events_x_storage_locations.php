<?php
/** ---------------------------------------------------------------------
 * app/models/ca_object_events_x_storage_locations.php : table access class for table ca_object_events_x_storage_locations
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_object_events_x_storage_locations'] = array(
 	'NAME_SINGULAR' 	=> _t('object event ⇔ storage location relationship'),
 	'NAME_PLURAL' 		=> _t('object event ⇔ storage location relationships'),
 	'FIELDS' 			=> array(
 		'relation_id' => array(
...
class ca_object_events_x_storage_locations extends BaseRelationshipModel {
	# ---------------------------------
	...
	protected $TABLE = 'ca_object_events_x_storage_locations';
	...
	# --- Relationship info
	# ------------------------------------------------------
	protected $RELATIONSHIP_LEFT_TABLENAME = 'ca_object_events';
