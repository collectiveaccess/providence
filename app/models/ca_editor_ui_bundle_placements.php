...
$_ca_editor_ui_bundle_placement_settings = array(        // global
                                                         ...
                                                         'expand_collapse_value'    => array(
	                                                         ...
	                                                         'options'     => array(
		                                                         _t( "Don't force (default)" ) => 'dont_force',
...
BaseModel::$s_ca_models_definitions['ca_editor_ui_bundle_placements'] = array(
	...
	'FIELDS'        => array(
		...
		'screen_id'      => array(
			...
			'DEFAULT'        => '',
			'LABEL'          => 'Screen id',
			'DESCRIPTION'    => 'Identifier for Screen'
		),
		'bundle_name'    => array(
			'FIELD_TYPE'     => FT_TEXT,
			'DISPLAY_TYPE'   => DT_FIELD,
		...
		'placement_code' => array(
			...
			'IS_NULL'        => false,
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Placement code' ),
			'DESCRIPTION'    => _t( 'Unique code for placement of this bundle on this screen.' ),
