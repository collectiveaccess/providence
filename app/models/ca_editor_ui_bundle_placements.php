...
$_ca_editor_ui_bundle_placement_settings = array(        // global
    ...
    'description' => array(
        ...
        'description' => _t(
            'Descriptive text to use for help for bundle. Will override descriptive text set for underlying metadata element, if set.'
        )
    ),
    'width' => array(
        'formatType' => FT_TEXT,
...
class ca_editor_ui_bundle_placements extends BaseModel
{
    ...
    # ------------------------------------------------------
    public function __construct($pn_id = null, $pa_additional_settings = null, $pa_setting_values = null)
    {
