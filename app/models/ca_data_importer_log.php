...
BaseModel::$s_ca_models_definitions['ca_data_importer_log'] = array(
	...
	'FIELDS'        => array(
		'log_id'       => array(
			...
			'DEFAULT'        => '',
			'LABEL'          => 'Log id',
			'DESCRIPTION'    => 'Identifier for import'
		),
		'user_id'      => array(
			'FIELD_TYPE'     => FT_NUMBER,
		...
		'importer_id'  => array(
			...
			'IS_NULL'        => true,
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Data importer used' ),
			'DESCRIPTION'    => _t( 'Indicates which import mapping was used.' )
		),
		'log_datetime' => array(
			...
			'IS_NULL'        => false,
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Import start date/time' ),
		...
		'notes'        => array(
			...
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Notes' ),
			'DESCRIPTION'    => _t( 'Notes regarding data import.' ),
		...
		'table_num'    => array(
			...
			'IS_NULL'        => false,
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Import target' ),
			'DESCRIPTION'    => _t( 'The table into which data was imported.' )
		),
		'datafile'     => array(
			'FIELD_TYPE'     => FT_FILE,
			'DISPLAY_TYPE'   => DT_FIELD,
			...
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Data file' ),
			'DESCRIPTION'    => _t( 'The original data imported.' )
		)
	)
);
...
class ca_data_importer_log extends BaseModel {
	...
	/**
	 * @property $opn_start_time Microtime recorded on call to ca_data_importer_log::beginItem(); used to calculate
	 *           elapsed time on call to ca_data_importer_log::endItem()
	 */
