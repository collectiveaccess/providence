...
BaseModel::$s_ca_models_definitions['ca_attribute_value_multifiles'] = array(
	...
	'FIELDS'        => array(
		'multifile_id'   => array(
			...
			'DEFAULT'        => '',
			'LABEL'          => 'Multifile id',
			'DESCRIPTION'    => 'Identifier for Multifile'
		),
		'value_id'       => array(
			'FIELD_TYPE'     => FT_NUMBER,
			...
			'DEFAULT'        => '',
			'LABEL'          => 'Value id',
			'DESCRIPTION'    => 'The attribute value to which this multifile is attached.'
		),
		'resource_path'  => array(
			'FIELD_TYPE'     => FT_TEXT,
			...
			'IS_NULL'        => false,
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Resource path' ),
			'DESCRIPTION'    => _t( 'Organizational path into which this file is placed.' )
		),
		'media'          => array(
			'FIELD_TYPE'     => FT_MEDIA,
			'DISPLAY_TYPE'   => DT_FIELD,
		...
		'rank'           => array(
			...
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Sort order' ),
			'DESCRIPTION'    => _t( 'Indicates how multifiles should be ordered in a list. Higher ranks are lower in the list. That is, rank is used to sort in ascending order.' )
		)
	)
);
