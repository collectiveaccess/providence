...
$_ca_metadata_type_restriction_settings = array(        // global
    ...
    'maxAttributesPerRow' => array(
        ...
        'description' => _t(
            'If set to more than 1 the element will be repeated to capture additional data values during cataloging.  The extent of the repeatability will match the number entered here.'
        )
    ),
...
BaseModel::$s_ca_models_definitions['ca_metadata_type_restrictions'] = array(
    ...
    'FIELDS' => array(
        ...
        'table_num' => array(
            ...
            'IS_NULL' => false,
            'DEFAULT' => '',
            'LABEL' => _t('Bind attribute to'),
            'DESCRIPTION' => _t('Type of item to bind element to.'),
        ...
        'settings' => array(
            ...
            'DEFAULT' => '',
            'LABEL' => 'Settings',
            'DESCRIPTION' => 'Settings for type restriction'
        ),
        'rank' => array(
            'FIELD_TYPE' => FT_NUMBER,
            'DISPLAY_TYPE' => DT_FIELD,
...
class ca_metadata_type_restrictions extends BaseModel
{
    ...
    public function __construct($pn_id = null, $pb_filter_tables = false)
    {
        ...
        if (!ca_metadata_type_restrictions::$s_loaded_relationship_tables) {
            ...
            if ($pb_filter_tables) {
                BaseModel::$s_ca_models_definitions['ca_metadata_type_restrictions']['FIELDS']['table_num']['BOUNDS_CHOICE_LIST'] = caFilterTableList(
                    BaseModel::$s_ca_models_definitions['ca_metadata_type_restrictions']['FIELDS']['table_num']['BOUNDS_CHOICE_LIST'],
                    array('sort' => true)
                );
            }
