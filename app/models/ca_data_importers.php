...
class ca_data_importers extends BundlableLabelableBaseModelWithAttributes {
	...
	public function importDataFromSource($ps_source, $ps_mapping, $pa_options=null) {
		...
		$o_event = ca_data_import_events::newEvent(isset($pa_options['user_id']) ? $pa_options['user_id'] : null, $pa_options['format'], mb_substr($ps_source, 0, 255) isset($pa_options['description']) ? $pa_options['description'] : '');
