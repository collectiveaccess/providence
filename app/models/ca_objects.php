...
BaseModel::$s_ca_models_definitions['ca_objects'] = array(
    ...
    'FIELDS' => array(
        'object_id' => array(
            ...
            'DESCRIPTION' => _t('Unique numeric identifier used by CollectiveAccess internally to identify this object')
        ),
        'parent_id' => array(
            'FIELD_TYPE' => FT_NUMBER,
        ...
        'hier_object_id' => array(
            ...
            'DESCRIPTION' => 'Identifier of object that is root of the object hierarchy.'
        ),
        'lot_id' => array(
            'FIELD_TYPE' => FT_NUMBER,
            'DISPLAY_TYPE' => DT_HIDDEN,
            ...
            'DEFAULT' => '',
            'LABEL' => _t('Lot'),
            'DESCRIPTION' => _t('Lot this object belongs to; is null if object is not part of a lot.')
        ),
        'locale_id' => array(
            'FIELD_TYPE' => FT_NUMBER,
        ...
        'source_id' => array(
            ...
            'LABEL' => _t('Source'),
            'DESCRIPTION' => _t(
                'Administrative source of object. This value is often used to indicate the administrative sub-division or legacy database from which the object originates, but can also be re-tasked for use as a simple classification tool if needed.'
            )
        ),
        'type_id' => array(
            'FIELD_TYPE' => FT_NUMBER,
        ...
        'idno' => array(
            ...
            'DEFAULT' => '',
            'ALLOW_BUNDLE_ACCESS_CHECK' => true,
            'LABEL' => _t('Object identifier'),
            'DESCRIPTION' => _t(
                'A unique alphanumeric identifier for this object. This is usually equivalent to the "accession number" in museum settings.'
            ),
        ...
        'idno_sort' => array(
            ...
            'IS_NULL' => false,
            'DEFAULT' => '',
            'LABEL' => 'Sortable object identifier',
            'DESCRIPTION' => 'Value used for sorting objects on identifier value.',
            'BOUNDS_LENGTH' => array(0, 255)
        ),
        'is_deaccessioned' => array(
            ...
            'ALLOW_BUNDLE_ACCESS_CHECK' => true,
            'DONT_ALLOW_IN_UI' => true,
            'RESULTS_EDITOR_BUNDLE' => 'ca_objects_deaccession',
            // bundle to use when editing this in the search/browse "results" editing interface
            'LABEL' => _t('Is deaccessioned'),
            'DESCRIPTION' => _t('Check if object is deaccessioned')
        ),
        'deaccession_date' => array(
            ...
            'ALLOW_BUNDLE_ACCESS_CHECK' => true,
            'DONT_ALLOW_IN_UI' => true,
            'START' => 'deaccession_sdatetime',
            'END' => 'deaccession_edatetime',
            'LABEL' => _t('Date of deaccession'),
            'DESCRIPTION' => _t('Enter the date the object was deaccessioned.')
        ),
        'deaccession_disposal_date' => array(
            ...
            'ALLOW_BUNDLE_ACCESS_CHECK' => true,
            'DONT_ALLOW_IN_UI' => true,
            'START' => 'deaccession_disposal_sdatetime',
            'END' => 'deaccession_disposal_edatetime',
            'LABEL' => _t('Date of disposal'),
            'DESCRIPTION' => _t('Enter the date the deaccessioned object was disposed of.')
        ),
        'deaccession_notes' => array(
            ...
            'ALLOW_BUNDLE_ACCESS_CHECK' => true,
            'DONT_ALLOW_IN_UI' => true,
            'LABEL' => _t('Deaccession notes'),
            'DESCRIPTION' => _t('Justification for deaccession.'),
        ...
        'deaccession_type_id' => array(
            ...
            'LABEL' => _t('Deaccession type'),
            'DESCRIPTION' => _t('Indicates type of deaccession.')
        ),
        'current_loc_class' => array(
            ...
            'BOUNDS_CHOICE_LIST' => array(
                _t('occurrences') => 67,
                _t('storage locations') => 119,
                // we store the ca_objects_x_storage_locations relation_id for locations
                _t('loans') => 133,
                _t('movements') => 137,
                _t('object lots') => 51
            ),
            'LABEL' => _t('Current location class'),
            'DESCRIPTION' => _t(
                'Indicates classification of last location for objects (eg. storage location, occurrence, loan, movement)'
            )
        ),
        'current_loc_subclass' => array(
            ...
            'IS_NULL' => true,
            'DONT_ALLOW_IN_UI' => true,
            'LABEL' => _t('Current location sub-class'),
            'DESCRIPTION' => _t(
                'Indicates sub-classification of last location for objects (eg. storage location relationship type, occurrence type, loan type, movement)'
            )
        ),
        'current_loc_id' => array(
            ...
            'DESCRIPTION' => _t('Reference to record recording details of current object location.')
        ),
        'item_status_id' => array(
            ...
            'DESCRIPTION' => _t(
                'Indicates accession/collection status of object. (eg. accessioned, pending accession, loan, non-accessioned item, etc.)'
            )
        ),
        'acquisition_type_id' => array(
            ...
            'LABEL' => _t('Acquisition method'),
            'DESCRIPTION' => _t('Indicates method employed to acquire the object.')
        ),
        'source_info' => array(
            'FIELD_TYPE' => FT_VARS,
            'DISPLAY_TYPE' => DT_OMIT,
            ...
            'DESCRIPTION' => 'Serialized array used to store source information for object information retrieved via web services [NOT IMPLEMENTED YET].'
        ),
        'hier_left' => array(
            'FIELD_TYPE' => FT_NUMBER,
            'DISPLAY_TYPE' => DT_OMIT,
        ...
        'extent' => array(
            ...
            'LABEL' => _t('Extent'),
            'DESCRIPTION' => _t(
                'The extent of the object. This is typically the number of discrete items that compose the object represented by this record. It is stored as a whole number (eg. 1, 2, 3...).'
            )
        ),
        'extent_units' => array(
            'FIELD_TYPE' => FT_TEXT,
        ...
        'acl_inherit_from_ca_collections' => array(
            ...
            'LABEL' => _t('Inherit access settings from collections?'),
            'DESCRIPTION' => _t(
                'Determines whether access settings set for related collections are applied to this object.'
            )
        ),
        'acl_inherit_from_parent' => array(
            ...
            'LABEL' => _t('Inherit item-level access control settings from parent?'),
            'DESCRIPTION' => _t(
                'Determines whether item-level access control settings set for parent object is applied to this object.'
            )
        ),
        'access_inherit_from_parent' => array(
            ...
            'DESCRIPTION' => _t(
                'Determines whether front-end access settings set for parent object is applied to this object.'
            )
        ),
        'view_count' => array(
            'FIELD_TYPE' => FT_NUMBER,
        ...
        'circulation_status_id' => array(
            ...
            'LABEL' => _t('Circulation status'),
            'DESCRIPTION' => _t('Indicates circulation status of the object.')
        ),
    )
);
...
class ca_objects extends BaseObjectLocationModel implements IBundleProvider
{
    ...
    public function __construct($pn_id = null)
    {
        if (
            ...
            ||
            !is_null(
                BaseModel::$s_ca_models_definitions['ca_objects']['FIELDS']['acl_inherit_from_ca_collections']['DEFAULT']
            )
        ) {
            $o_config = Configuration::load();

            if (!is_null(
                BaseModel::$s_ca_models_definitions['ca_objects']['FIELDS']['acl_inherit_from_parent']['DEFAULT']
            )) {
                BaseModel::$s_ca_models_definitions['ca_objects']['FIELDS']['acl_inherit_from_parent']['DEFAULT'] = (int)$o_config->get(
                    'ca_objects_acl_inherit_from_parent_default'
                );
            }
            if (!is_null(
                BaseModel::$s_ca_models_definitions['ca_objects']['FIELDS']['acl_inherit_from_ca_collections']['DEFAULT']
            )) {
                BaseModel::$s_ca_models_definitions['ca_objects']['FIELDS']['acl_inherit_from_ca_collections']['DEFAULT'] = (int)$o_config->get(
                    'ca_objects_acl_inherit_from_ca_collections_default'
                );
            }
        }
    ...
    protected function initLabelDefinitions($pa_options = null)
    {
        ...
        $this->BUNDLES['ca_objects_components_list'] = array(
            'type' => 'special',
            'repeating' => false,
            'label' => _t('Components')
        );
        $this->BUNDLES['ca_objects_location'] = array(
            'type' => 'special',
            'repeating' => false,
            'label' => _t('Current location')
        );
        $this->BUNDLES['ca_objects_location_date'] = array(
            'type' => 'special',
            'repeating' => false,
            'label' => _t('Current location date')
        );

        $this->BUNDLES['ca_objects_history'] = array(
            'type' => 'special',
            'repeating' => false,
            'label' => _t('Object use history')
        );
        $this->BUNDLES['ca_objects_deaccession'] = array(
            'type' => 'special',
            'repeating' => false,
            'label' => _t('Deaccession status')
        );
        $this->BUNDLES['ca_object_checkouts'] = array(
            'type' => 'special',
            'repeating' => false,
            'label' => _t('Object checkouts')
        );

        $this->BUNDLES['ca_object_representations_access_status'] = array(
            'type' => 'special',
            'repeating' => true,
            'label' => _t('Media representation access and status')
        );
        ...
        $this->BUNDLES['ca_object_circulation_status'] = array(
            'type' => 'special',
            'repeating' => false,
            'label' => _t('Circulation Status')
        );
    ...
    public function insert($pa_options = null)
    {
        if ($vn_parent_id = $this->get('parent_id')) {
            if (!$this->getAppConfig()->get(
                ['ca_objects_dont_inherit_lot_from_parent', 'ca_objects_dont_inherit_lot_id_from_parent']
            )) {
        ...
        if (is_array($va_representations)) {
            foreach ($va_representations as $va_rep) {
                ...
                $qr_res = $this->getDb()->query(
                    "SELECT count(*) c FROM ca_objects_x_object_representations WHERE object_id <> ? AND representation_id = ?",
                    (int)$this->getPrimaryKey(),
                    (int)$va_rep["representation_id"]
                );
     ...
     */
    public function getObjectDeaccessionHTMLFormBundle(
        $po_request,
        $ps_form_name,
        $ps_placement_code,
     ...
     * @return string Rendered HTML bundle
     */
    public function getObjectCheckoutsHTMLFormBundle(
        $po_request,
        $ps_form_name,
        $ps_placement_code,
        $pa_bundle_settings = null,
        ...
        $o_view->setVar(
            'client_list',
            $va_client_list = array_unique(caExtractValuesFromArrayList($va_history, 'user_name'))
        );
     ...
     * @return string Rendered HTML bundle
     */
    public function getObjectLocationHTMLFormBundle(
        $po_request,
        $ps_form_name,
        $ps_placement_code,
        $pa_bundle_settings = null,
        ...
        $o_view->setVar(
            'mode',
            $vs_mode = caGetOption('locationTrackingMode', $pa_bundle_settings, 'ca_storage_locations')
        );
        ...
        switch ($vs_mode) {
            case 'ca_storage_locations':
                ...
                $o_view->setVar(
                    'location_history',
                    $this->getLocationHistory(array('template' => $vs_history_template))
                );

                $o_view->setVar(
                    'location_relationship_type',
                    $this->getAppConfig()->get('object_storage_location_tracking_relationship_type')
                );
                $o_view->setVar('location_change_url', null);
                break;
            case 'ca_movements':
            default:
                $t_last_movement = $this->getLastMovement(
                    array(
                        'dateElement' => $vs_movement_date_element = $this->getAppConfig()->get(
                ...
                $o_view->setVar(
                    'current_location',
                    $t_last_movement ? $t_last_movement->getWithTemplate($vs_display_template) : null
                );
                ...
                $o_view->setVar(
                    ...
                    $this->getMovementHistory(
                        array(
                            'dateElement' => $vs_movement_date_element,
                            'template' => $vs_history_template
                        )
                    )
                );
                ...
                $o_view->setVar(
                    'location_relationship_type',
                    $this->getAppConfig()->get('movement_object_tracking_relationship_type')
                );
                $o_view->setVar(
                    'location_change_url',
                    caNavUrl(
...
//
            ...
            foreach ($lot_ids as $vn_lot_id) {
                ...
                if (!$t_lot->get('ca_object_lots.deleted')) {
                    ...
                    foreach ($va_dates as $va_date) {
                        ...
                        if (!is_array($va_history[$va_date['sortable']])) {
     ...
     */
    public function getObjectHistoryHTMLFormBundle(
        $po_request,
        $ps_form_name,
        $ps_placement_code,
        $pa_bundle_settings = null,
        ...
        $va_occ_types_to_show = caGetOption(
        ...
        $o_view->setVar(
            ...
            $t_occ_rel->getRelationshipTypes(null, null, array_merge($pa_options, $pa_bundle_settings))
        );
        $o_view->setVar(
        ...
        $o_view->setVar(
            ...
            $t_location_rel->getRelationshipTypes(null, null, array_merge($pa_options, $pa_bundle_settings))
        );
        $o_view->setVar(
        ...
        switch ($vs_mode) {
            ...
            default:
                ...
                $o_view->setVar(
                    'location_relationship_type',
                    $this->getAppConfig()->get('movement_storage_location_tracking_relationship_type')
                );
                $o_view->setVar(
                    'location_change_url',
                    caNavUrl(
    ...
    {
        if (($vb_use_app_defaults = caGetOption('useAppConfDefaults', $pa_bundle_settings, false)) && is_array(
                $va_current_location_criteria = $this->getAppConfig()->getAssoc('current_location_criteria')
            ) && sizeof($va_current_location_criteria)) {
                ...
                switch ($vs_table) {
                    case 'ca_storage_locations':
                        if (is_array($va_info)) {
                            ...
                            $va_bundle_settings["{$vs_table}_showRelationshipTypes"] = caMakeRelationshipTypeIDList(
                    ...
                    default:
                        if (is_array($va_info)) {
                            ...
                            $va_bundle_settings["{$vs_table}_showTypes"] = caMakeTypeIDList(
                                $vs_table,
                                $va_bundle_settings["{$vs_table}_showTypes"]
                            );
                        }
                        break;
                }
    ...
    public function getLastMovement($pa_options = null)
    {
        ...
        if (!($ps_date_element = caGetOption('dateElement', $pa_options, null))) {
            return null;
        }
        if (!($t_element = ca_metadata_elements::getInstance($ps_date_element))) {
            return null;
        }
    ...
    public function getMovementHistory($pa_options = null)
    {
        ...
        if (sizeof($va_relation_ids)) {
            ...
            while ($qr_paths->nextRow()) {
                ...
                $va_paths[$qr_paths->get('movement_id')] = is_array($va_data['path']) ? join(
                    " ➜ ",
                    $va_data['path']
                ) : $qr_paths->get('ca_storage_locations.hierarchy.preferred_labels.name', array('delimiter' => ' ➜ '));
                $va_location_ids[$qr_paths->get('movement_id')] = $va_data['ids'];
            }
        }
        $va_displays = caProcessTemplateForIDs(
            $ps_display_template,
            'ca_movements_x_objects',
            $va_relation_ids,
            array(
                'returnAsArray' => true,
                'forceValues' => array('ca_storage_locations.hierarchy.preferred_labels.name' => $va_paths)
            )
        );
     ...
     * @return string Rendered HTML bundle
     */
    public function getComponentListHTMLFormBundle(
        $po_request,
        $ps_form_name,
        $ps_placement_code,
        $pa_bundle_settings = null,
    ...
    public function getComponentCount($pa_options = null)
    {
        ...
        if (is_array($va_component_types) && (sizeof($va_component_types) && !in_array('*', $va_component_types))) {
            $va_ids = ca_objects::find(
                array('parent_id' => $pn_object_id, 'type_id' => $va_component_types, array('returnAs' => 'ids'))
            );
        } else {
    ...
    public function getComponents($pa_options = null)
    {
        ...
        if (is_array($va_component_types) && (sizeof($va_component_types) && !in_array('*', $va_component_types))) {
            $vm_res = ca_objects::find(
                array('parent_id' => $pn_object_id, 'type_id' => $va_component_types),
                array(
                    'sort' => 'ca_objects.idno',
                    'returnAs' => ($vs_return_as == 'info') ? 'searchResult' : $vs_return_as
                )
            );
        } else {
            $vm_res = ca_objects::find(
                array('parent_id' => $pn_object_id),
                array(
                    'sort' => 'ca_objects.idno',
                    'returnAs' => ($vs_return_as == 'info') ? 'searchResult' : $vs_return_as
                )
    ...
    public function addRelationship(
        ...
        if ($vn_rc = parent::addRelationship(
            $pm_rel_table_name_or_num,
            $pn_rel_id,
            $pm_type_id,
            $ps_effective_date,
    ...
    public function editRelationship(
        ...
        if ($vn_rc = parent::editRelationship(
            $pm_rel_table_name_or_num,
            $pn_relation_id,
            $pn_rel_id,
            $pm_type_id,
     ...
     * @return bool
     */
    private function relationshipChangeMayAffectCurrentLocation(
        $pm_rel_table_name_or_num,
        $pn_rel_id,
        $pm_type_id = null,
        $pa_options = null
    ...
    public function deriveCurrentLocationForBrowse($pa_options = null)
    {
        ...
        if (is_array(
                $va_history = $this->getObjectHistory(
                    $va_bundle_settings,
                    array('displayLabelOnly' => true, 'limit' => 1, 'currentOnly' => true, 'noCache' => true)
                )
            ) && (sizeof($va_history) > 0)) {
            $va_current_location = array_shift(array_shift($va_history));

            if ($va_current_location['type'] == 'ca_storage_locations') {
                return $this->setCurrentLocationForBrowse(
                    'ca_objects_x_storage_locations',
                    $va_current_location['rel_type_id'],
                    $va_current_location['id'],
                    array('dontCheckID' => true)
                );
            } else {
                return $this->setCurrentLocationForBrowse(
                    $va_current_location['type'],
                    $va_current_location['type_id'],
                    $va_current_location['id'],
                    array('dontCheckID' => true)
                );
            }
     ...
     *
     */
    private function setCurrentLocationForBrowse(
        $pm_current_loc_class,
        $pm_current_loc_subclass,
        $pn_current_loc_id,
        $pa_options = null
    ) {
     ...
     * @return array
     */
    public static function getConfigurationForCurrentLocationType(
        $pm_current_loc_class,
        $pm_current_loc_subclass = null,
        $pa_options = null
    ) {
        ...
        if (!($t_instance = Datamodel::getInstance($pm_current_loc_class, true))) {
        ...
        if (isset($va_map[$vs_table_name])) {
            if ((!$pm_current_loc_subclass) && isset($va_map[$vs_table_name]['*'])) {
                return ca_objects::$s_current_location_type_configuration_cache[caMakeCacheKeyFromOptions(
                    $pa_options,
                    "{$vs_table_name}/{$pm_type_id}"
                )] = ca_objects::$s_current_location_type_configuration_cache[$vs_cache_key] = $va_map[$vs_table_name]['*'];
            }    // return default config if no type is specified

            if ($pm_current_loc_subclass) {
                switch ($vs_table_name) {
                    case 'ca_objects_x_storage_locations':
                        $va_types = ca_relationship_types::relationshipTypeIDsToTypeCodes(
                            array($pm_current_loc_subclass)
                        );
                ...
                if ($vs_type && isset($va_map[$vs_table_name][$vs_type])) {
                    if (is_array(
                            $va_facet_display_config
                        ) && isset($va_facet_display_config[$vs_table_name][$vs_type])) {
                        $va_map[$vs_table_name][$vs_type] = array_merge(
                            $va_map[$vs_table_name][$vs_type],
                            $va_facet_display_config[$vs_table_name][$vs_type]
                        );
                    }
                    return ca_objects::$s_current_location_type_configuration_cache[caMakeCacheKeyFromOptions(
                        $pa_options,
                        "{$vs_table_name}/{$pm_current_loc_subclass}"
                    )] = ca_objects::$s_current_location_type_configuration_cache[$vs_cache_key] = $va_map[$vs_table_name][$vs_type];
                } elseif (isset($va_map[$vs_table_name]['*'])) {
                    if (is_array($va_facet_display_config) && isset($va_facet_display_config[$vs_table_name]['*'])) {
                        $va_map[$vs_table_name][$vs_type] = array_merge(
                            $va_map[$vs_table_name]['*'],
                            $va_facet_display_config[$vs_table_name]['*']
                        );
                    }
                    return ca_objects::$s_current_location_type_configuration_cache[caMakeCacheKeyFromOptions(
                        $pa_options,
        ...
        return ca_objects::$s_current_location_type_configuration_cache[caMakeCacheKeyFromOptions(
            $pa_options,
            "{$vs_table_name}/{$pm_current_loc_subclass}"
        )] = ca_objects::$s_current_location_type_configuration_cache[$vs_cache_key] = null;
    }
    # ------------------------------------------------------
    # Object checkout
    # ------------------------------------------------------
    ...
    public function getCheckoutStatus($pa_options = null)
    {
        ...
        if ($va_restrict_to_circ_statuses = $o_lib_conf->get('restrict_to_circulation_statuses')) {
            if (sizeof($va_restrict_to_circ_statuses)) {
                if (!in_array(
                    $this->get('circulation_status_id', ['convertCodesToIdno' => true]),
                    $va_restrict_to_circ_statuses
                )) {
        ...
        if ($va_is_out) {
            ...
            $va_info['status_display'] = $vb_is_reserved ? ((($vn_num_reservations == 1) ? _t(
                'Out; %1 reservation',
                $vn_num_reservations
            ) : _t('Out; %1 reservations', $vn_num_reservations))) : _t('Out');
            ...
            $va_info['user_name'] = $t_checkout->get('ca_users.fname') . ' ' . $t_checkout->get(
                    'ca_users.lname'
                ) . (($vs_email = $t_checkout->get('ca_users.email')) ? " ({$vs_email})" : '');
        } elseif ($vb_is_reserved) {
            $va_info['status'] = __CA_OBJECTS_CHECKOUT_STATUS_RESERVED__;
            $va_info['status_display'] = ($vn_num_reservations == 1) ? _t('Reserved') : _t(
                '%1 reservations',
                $vn_num_reservations
            );
     ...
     * @return string
     */
    public function getObjectCirculationStatusHTMLFormBundle(
        $po_request,
        $ps_form_name,
        $ps_placement_code,
        $pa_bundle_settings = null,
    ...
    public function renderBundleForDisplay($ps_bundle_name, $pn_row_id, $pa_values, $pa_options = null)
    {
        switch ($ps_bundle_name) {
            ...
            case 'ca_objects_location_date':
                ...
                if ((method_exists($this, "getObjectHistory")) && (is_array(
                        $va_bundle_settings = $this->_processObjectHistoryBundleSettings(['useAppConfDefaults' => true])
                    )) && (sizeof($va_bundle_settings) > 0)) {
                    ...
                    return $this->getLastLocationForDisplay(
