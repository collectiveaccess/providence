...
class ca_objects extends RepresentableBaseModel implements IBundleProvider
{
     ...
     */
    static public $s_current_location_type_configuration_cache = array();
    ...
    public function editRelationship(
        ...
        return parent::editRelationship(
            $pm_rel_table_name_or_num,
            $pn_relation_id,
            $pn_rel_id,
            $pm_type_id,
    ...
    public function renderBundleForDisplay($ps_bundle_name, $pn_row_id, $pa_values, $pa_options = null)
    {
        switch ($ps_bundle_name) {
            case 'home_location_value':
                ...
                if ($q && $q->nextHit()) {
                    if (($home_location_id = $q->get(
                            'ca_objects.home_location_id'
                        )) && ($t_loc = ca_storage_locations::find(
                ...
                break;
            default:
                return self::renderHistoryTrackingBundleForDisplay(
                    $ps_bundle_name,
                    $pn_row_id,
                    $pa_values,
                    $pa_options
