...
BaseModel::$s_ca_models_definitions['ca_site_page_media'] = array(
    ...
    'FIELDS' => array(
        ...
        'title' => array(
            ...
            'DEFAULT' => '',
            'LABEL' => _t('Title'),
            'DESCRIPTION' => _t('Short descriptive title for media'),
        ...
        'idno' => array(
            ...
            'IS_NULL' => false,
            'DEFAULT' => '',
            'LABEL' => _t('Media identifier'),
            'DESCRIPTION' => _t('A unique alphanumeric identifier for this media.'),
            'BOUNDS_LENGTH' => array(0, 255)
        ),
        'idno_sort' => array(
            'FIELD_TYPE' => FT_TEXT,
            ...
            'IS_NULL' => false,
            'DEFAULT' => '',
            'LABEL' => 'Sortable media identifier',
            'DESCRIPTION' => 'Value used for sorting media on identifier value.',
            'BOUNDS_LENGTH' => array(0, 255)
        ),
        'caption' => array(
            'FIELD_TYPE' => FT_TEXT,
            ...
            'DEFAULT' => '',
            'LABEL' => _t('Caption'),
            'DESCRIPTION' => _t('Long description for media')
        ),
        'page_id' => array(
            'FIELD_TYPE' => FT_NUMBER,
            ...
            'DEFAULT' => '',
            'LABEL' => _t('Page'),
            'DESCRIPTION' => _t('Page to which media belongs.')
        ),
        'media' => array(
            'FIELD_TYPE' => FT_MEDIA,
            'DISPLAY_TYPE' => DT_FIELD,
        ...
        'access' => array(
            ...
            'LABEL' => _t('Access'),
            'DESCRIPTION' => _t('Indicates if the media is accessible to the public or not.')
        ),
        'deleted' => array(
            'FIELD_TYPE' => FT_BIT,
            'DISPLAY_TYPE' => DT_OMIT,
            ...
            'DEFAULT' => 0,
            'LABEL' => _t('Is deleted?'),
            'DESCRIPTION' => _t('Indicates if media is deleted or not.')
        )
    )
);
