<?php
/** ---------------------------------------------------------------------
 * app/models/ca_history_tracking_current_value_labels.php : table access class for table ca_history_tracking_current_value_labels
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_history_tracking_current_value_labels'] = array(
 	...
 	'FIELDS' 			=> array(
		...
		'tracking_id' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => 'Object id', 'DESCRIPTION' => 'Identifier for history tracking current value'
		),
		'locale_id' => array(
		...
		'value' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => _t('Name'), 'DESCRIPTION' => _t('Current value'),
...
class ca_history_tracking_current_value_labels extends BaseLabel {
	# ---------------------------------
	...
	protected $TABLE = 'ca_history_tracking_current_value_labels';
	...
	protected $LIST_FIELDS = array('value');
	...
	protected $ORDER_BY = array('value_sort');
	...
	protected $LABEL_DISPLAY_FIELD = 'value';
	
	# --- Name of field used for sorting purposes
	protected $LABEL_SORT_FIELD = 'value_sort';
	
	# --- Name of table this table contains label for
	protected $LABEL_SUBJECT_TABLE = 'ca_history_tracking_current_values';
