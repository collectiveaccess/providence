...
BaseModel::$s_ca_models_definitions['ca_user_notes'] = array(
    ...
    'FIELDS' => array(
        ...
        'table_num' => array(
            ...
            'IS_NULL' => false,
            'DEFAULT' => '',
            'LABEL' => 'Table note applies to',
            'DESCRIPTION' => 'The table number of the table this watch is applied to.',
        ...
        'row_id' => array(
            ...
            'DEFAULT' => '',
            'LABEL' => 'Row ID',
            'DESCRIPTION' => 'Primary key value of the row in the table specified by table_num that this note applies to.'
        ),
        'bundle_name' => array(
            'FIELD_TYPE' => FT_TEXT,
            'DISPLAY_TYPE' => DT_FIELD,
            ...
            'DESCRIPTION' => _t('Name of CollectiveAccess bundle to attach note to.'),
            'BOUNDS_VALUE' => array(1, 255)
        ),
        'user_id' => array(
            'FIELD_TYPE' => FT_NUMBER,
            ...
            'DEFAULT' => '',
            'LABEL' => _t('User'),
            'DESCRIPTION' => _t('The user who created the note.')
        ),
        'note' => array(
            'FIELD_TYPE' => FT_TEXT,
            'DISPLAY_TYPE' => DT_FIELD,
        ...
        'created_on' => array(
            ...
            'IS_NULL' => false,
            'DEFAULT' => '',
            'LABEL' => _t('Note creation date'),
            'DESCRIPTION' => _t('The date and time the note was created.')
        ),
    )
);
