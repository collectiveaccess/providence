...
BaseModel::$s_ca_models_definitions['ca_data_exporter_items'] = array(
	...
	'FIELDS'        => array(
		'item_id'      => array(
			...
			'DESCRIPTION'    => _t( 'Unique numeric identifier used by CollectiveAccess internally to identify this exporter item' )
		),
		'parent_id'    => array(
			'FIELD_TYPE'     => FT_NUMBER,
		...
		'element'      => array(
			...
			'DESCRIPTION'    => _t( 'Name of the target element. For XML exports this would be the XML element or attribute name.' ),
		...
		'source'       => array(
			...
			'DESCRIPTION'    => _t( 'Determines where the exported data is taken from. This will typically be a bundle name.' ),
			'BOUNDS_LENGTH'  => array( 0, 1024 )
		),
		'settings'     => array(
			'FIELD_TYPE'     => FT_VARS,
