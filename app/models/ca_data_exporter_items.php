...
BaseModel::$s_ca_models_definitions['ca_data_exporter_items'] = array(
    ...
    'FIELDS' => array(
        'item_id' => array(
            ...
            'DESCRIPTION' => _t(
                'Unique numeric identifier used by CollectiveAccess internally to identify this exporter item'
            )
        ),
        'parent_id' => array(
            'FIELD_TYPE' => FT_NUMBER,
            ...
            'DEFAULT' => '',
            'LABEL' => 'Parent id',
            'DESCRIPTION' => 'Identifier of parent object; is null if object is root of hierarchy.'
        ),
        'exporter_id' => array(
            'FIELD_TYPE' => FT_NUMBER,
            'DISPLAY_TYPE' => DT_OMIT,
            ...
            'DEFAULT' => '',
            'LABEL' => 'exporter id',
            'DESCRIPTION' => 'Identifier for exporter'
        ),
        'element' => array(
            'FIELD_TYPE' => FT_TEXT,
            ...
            'IS_NULL' => false,
            'DEFAULT' => '',
            'LABEL' => _t('External element'),
            'DESCRIPTION' => _t(
                'Name of the target element. For XML exports this would be the XML element or attribute name.'
            ),
        ...
        'context' => array(
            ...
            'DESCRIPTION' => _t(
                'This setting can be used to switch the context of the export for this exporter item and all its children to a different table, for instance to related entities. The element is automatically repeated for all selected related records. Leave empty to inherit context from parent item.'
            ),
            'BOUNDS_LENGTH' => array(0, 1024)
        ),
        'source' => array(
            ...
            'DESCRIPTION' => _t(
                'Determines where the exported data is taken from. This will typically be a bundle name.'
            ),
            'BOUNDS_LENGTH' => array(0, 1024)
        ),
        'settings' => array(
            ...
            'DEFAULT' => '',
            'LABEL' => _t('Settings'),
            'DESCRIPTION' => _t('exporter item settings')
        ),
        'hier_item_id' => array(
            'FIELD_TYPE' => FT_NUMBER,
            'DISPLAY_TYPE' => DT_OMIT,
            ...
            'IS_NULL' => false,
            'DEFAULT' => '',
            'LABEL' => 'Exporter item hierarchy',
            'DESCRIPTION' => 'Identifier of exporter item that is root of the item hierarchy.'
        ),
        'hier_left' => array(
            'FIELD_TYPE' => FT_NUMBER,
            'DISPLAY_TYPE' => DT_OMIT,
...
class ca_data_exporter_items extends BaseModel
{
    ...
    protected function initSettings($pa_settings = null)
    {
        ...
        $va_settings['template'] = array(
            ...
            'description' => _t(
                'Format exported value with provided template. Template may include caret (^) prefixed placeholders that refer to data source values. This setting can also be used to set static values for exporter items without data source.'
            )
        );
        ...
        $va_settings['repeat_element_for_multiple_values'] = array(
            ...
            'description' => _t(
                'If the current selector/template returns multiple values, this setting determines if the element is repeated for each value.'
            )
        );
        ...
        $va_settings['convertCodesToDisplayText'] = array(
            ...
            'description' => _t(
                'If set, id values refering to foreign keys are returned as preferred label text in the current locale.'
            )
        );
        ...
        $va_settings['returnIdno'] = array(
            ...
            'description' => _t(
                'If set, idnos are returned for List attribute values instead of primary key values. Do not combine this with convertCodesToDisplayText!'
            )
        );
        ...
        $va_settings['filterByRegExp'] = array(
            ...
            'description' => _t(
                'Any value that does NOT match this PCRE regular expression is filtered and not exported. Insert expression without delimiters.'
            )
        );
        ...
        $va_settings['original_values'] = array(
            ...
            'description' => _t(
                'Return-separated list of values from the CollectiveAccess source to be replaced. PCRE-style regular expressions are allowed (without delimiters).'
            )
        );
        ...
        $va_settings['replacement_values'] = array(
            ...
            'description' => _t(
                'Return-separated list of replacement values that correspond to the mapped values from the original data source.'
            )
        );
        ...
        $va_settings['locale'] = array(
            ...
            'label' => _t('Locale'),
            'description' => _t(
                'Locale code to use to get the field values. If not set, the system/user default is used.'
            )
        );
        ...
        $va_settings['omitIfEmpty'] = array(
            ...
            'description' => _t(
                'Omit this item and all its children unless this CollectiveAccess bundle specifier returns a result.'
            )
        );
        ...
        $va_settings['omitIfNotEmpty'] = array(
            ...
            'description' => _t(
                'Omit this item and all its children if this CollectiveAccess bundle specifier returns a non-empty result.'
            )
        );
        ...
        $va_settings['restrictToTypes'] = array(
            ...
            'description' => _t(
                'Restricts the context of the mapping to only records of the designated type. Only valid when context is set.'
            )
        );
        $va_settings['filterTypes'] = array(
            ...
            'description' => _t(
                'Filter returned list item hierarachy returning only items with the specified types. Only valid for export of list item attributes.'
            )
        );
        ...
        $va_settings['restrictToRelationshipTypes'] = array(
            ...
            'description' => _t(
                'Restricts the context of the mapping to only records related with the designated relationship type. Only valid when context is set.'
            )
        );
        ...
        $va_settings['restrictToBundleValues'] = array(
            ...
            'description' => _t(
                'Restricts the context of the mapping to only records related with the designated bundle values. Only valid when context is set.'
            )
        );
        ...
        $va_settings['checkAccess'] = array(
            ...
            'description' => _t(
                'Restricts the context of the mapping to only records with one of the designated access values. Only valid when context is set.'
            )
        );
        ...
        $va_settings['sort'] = array(
            ...
            'label' => _t('Sort'),
            'description' => _t(
                'Sorts the values returned for a context switch on these fields. Only valid when context is set.'
            )
        );
        ...
        $va_settings['start_as_iso8601'] = array(
            ...
            'description' => _t(
                'If set, only the end of a date range is exported for the current mapping. Format is ISO8601. Only applies to exports of DateRange attributes.'
            )
        );
        ...
        $va_settings['end_as_iso8601'] = array(
            ...
            'description' => _t(
                'If set, only the beginning of a date range is exported for the current mapping. Format is ISO8601. Only applies to exports of DateRange attributes.'
            )
        );
        ...
        $va_settings['dontReturnValueIfOnSameDayAsStart'] = array(
            ...
            'description' => _t(
                'If set, the exporter will not insert a value for this mapping if the end day of the DateRange in question is on the same day as the start. Only applias to exports of DateRange attributes and only in conjunction with end_as_iso8601.'
            ),
        );
        ...
        $va_settings['coordinatesOnly'] = array(
            ...
            'description' => _t(
                'Formatting option for Geocode attributes. Forces return of coordinates only, omitting text labels.'
            )
        );
