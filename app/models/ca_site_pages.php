...
BaseModel::$s_ca_models_definitions['ca_site_pages'] = array(
 	...
 	'FIELDS' 			=> array(
		...
		'path' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => _t('Page metadata: URL path'), 'DESCRIPTION' => _t('The unique root-relative URL path used by the public to access this page. For example, if set to <em>/pages/staff</em> this page would be accessible to the public using a URL similar to this: <em>%1</em>.', 'http://your.domain.com/pages/staff'),
