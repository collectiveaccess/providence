...
BaseModel::$s_ca_models_definitions['ca_tour_stops'] = array(
	...
	'FIELDS'        => array(
		...
		'tour_id'      => array(
			...
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Tour' ),
			'DESCRIPTION'    => _t( 'Tour stop is part of' )
		),
		'type_id'      => array(
			'FIELD_TYPE'      => FT_NUMBER,
			...
			'DEFAULT'         => '',
			'LABEL'           => _t( 'Type' ),
			'DESCRIPTION'     => _t( 'Indicates the type of the stop.' )
		),
		'idno'         => array(
			'FIELD_TYPE'     => FT_TEXT,
			...
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Id number' ),
			'DESCRIPTION'    => _t( 'Unique identifier for this tour stop' ),
		...
		'idno_sort'    => array(
			...
			'IS_NULL'        => false,
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Id number sort' ),
			'DESCRIPTION'    => _t( 'Sortable value for id number' ),
			'BOUNDS_LENGTH'  => array( 0, 255 )
		),
		'color'        => array(
			'FIELD_TYPE'     => FT_TEXT,
			...
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Color' ),
			'DESCRIPTION'    => _t( 'Color to display stop in' )
		),
		'icon'         => array(
			'FIELD_TYPE'               => FT_MEDIA,
			'DISPLAY_TYPE'             => DT_FIELD,
			...
			'LABEL'                    => _t( 'Icon' ),
			'DESCRIPTION'              => _t( 'Optional icon to use with stop' )
		),
		'rank'         => array(
			'FIELD_TYPE'     => FT_NUMBER,
			'DISPLAY_TYPE'   => DT_FIELD,
		...
		'hier_stop_id' => array(
			...
			'IS_NULL'        => false,
			'DEFAULT'        => '',
			'LABEL'          => 'Stop hierarchy',
			'DESCRIPTION'    => 'Identifier of stop that is root of the stop hierarchy.'
		),
		'access'       => array(
			'FIELD_TYPE'         => FT_NUMBER,
			'DISPLAY_TYPE'       => DT_SELECT,
