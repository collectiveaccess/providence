...
BaseModel::$s_ca_models_definitions['ca_notification_subjects'] = array(
    ...
    'FIELDS' => array(
        ...
        'notification_id' => array(
            ...
            'DESCRIPTION' => _t('Notification this subject definition belongs to.')
        ),
        'table_num' => array(
            'FIELD_TYPE' => FT_NUMBER,
        ...
        'read_on' => array(
            ...
            'DEFAULT' => null,
            'LABEL' => _t('Date read'),
            'DESCRIPTION' => _t('The date and time the notification was read.')
        ),
        ...
        'delivery_email_sent_on' => array(
            ...
            'DISPLAY_HEIGHT' => 1,
            'IS_NULL' => true,
            'LABEL' => _t('Date and time notification was sent by email'),
            'DESCRIPTION' => _t('Date and time notification was sent by email')
        ),
