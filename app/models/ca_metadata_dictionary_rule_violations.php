...
BaseModel::$s_ca_models_definitions['ca_metadata_dictionary_rule_violations'] = array(
    ...
    'FIELDS' => array(
        'violation_id' => array(
            ...
            'DEFAULT' => '',
            'LABEL' => 'Violation id',
            'DESCRIPTION' => 'Identifier for violation'
        ),
        'rule_id' => array(
            'FIELD_TYPE' => FT_NUMBER,
            ...
            'DEFAULT' => '',
            'LABEL' => 'Rule id',
            'DESCRIPTION' => 'Identifier for rule'
        ),
        'table_num' => array(
            'FIELD_TYPE' => FT_NUMBER,
            ...
            'DEFAULT' => '',
            'LABEL' => 'Table',
            'DESCRIPTION' => 'Table to which this violation applies.',
        ...
        'row_id' => array(
            ...
            'DEFAULT' => '',
            'LABEL' => 'Row id',
            'DESCRIPTION' => 'Identifier of row to which this violation applies.'
        ),
        'created_on' => array(
        ...
        'last_checked_on' => array(
            ...
            'IS_NULL' => false,
            'DEFAULT' => '',
            'LABEL' => _t('Last checked on'),
            'DESCRIPTION' => _t('Last checked on')
        ),
    )
);
