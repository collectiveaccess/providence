...
BaseModel::$s_ca_models_definitions['ca_representation_transcriptions'] = array(
    ...
    'FIELDS' => array(
        'transcription_id' => array(
            ...
            'DESCRIPTION' => _t(
                'Unique numeric identifier used by CollectiveAccess internally to identify this IP address block'
            )
        ),
        ...
        'is_primary' => array(
            ...
            'LABEL' => _t('Is primary?'),
            'DESCRIPTION' => _t(
                'Indicates that the transcription is the preferred transcription for this representation.'
            )
        ),
        'created_on' => array(
        ...
        'completed_on' => array(
            ...
            'DESCRIPTION' => _t(
                'The date and time the transcription was completed on. An empty value indicates an incomplete transcription.'
            )
        ),
        'validated_on' => array(
            'FIELD_TYPE' => FT_DATETIME,
            ...
            'DESCRIPTION' => _t(
                'The date and time the transcription was validated on. An empty value indicates an unvalidated transcription.'
            )
        ),
        'ip_addr' => array(
            'FIELD_TYPE' => FT_TEXT,
