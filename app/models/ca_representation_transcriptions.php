...
BaseModel::$s_ca_models_definitions['ca_representation_transcriptions'] = array(
	...
	'FIELDS'        => array(
		...
		'transcription'     => array(
			...
			'DESCRIPTION'    => _t( 'Text of transcription.' ),
		...
		'is_primary'        => array(
			...
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Is primary?' ),
			'DESCRIPTION'    => _t( 'Indicates that the transcription is the preferred transcription for this representation.' )
		),
		'created_on'        => array(
			...
			'IS_NULL'        => false,
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Transcription creation date' ),
			'DESCRIPTION'    => _t( 'The date and time the transcription was started.' )
		),
		'completed_on'      => array(
			...
			'IS_NULL'        => true,
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Transcription completion date' ),
			'DESCRIPTION'    => _t( 'The date and time the transcription was completed on. An empty value indicates an incomplete transcription.' )
		),
		'validated_on'      => array(
			'FIELD_TYPE'     => FT_DATETIME,
			'DISPLAY_TYPE'   => DT_FIELD,
			...
			'IS_NULL'        => true,
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Transcription validation date' ),
			'DESCRIPTION'    => _t( 'The date and time the transcription was validated on. An empty value indicates an unvalidated transcription.' )
		),
		'ip_addr'           => array(
			'FIELD_TYPE'     => FT_TEXT,
			'DISPLAY_TYPE'   => DT_FIELD,
		...
		'user_id'           => array(
			...
			'DESCRIPTION'      => _t( 'User submitting this transcription.' )
		),
	)
);
...
class ca_representation_transcriptions extends BaseModel {
	 ...
	 *
	 * @return int Unix timestamp for date/time completed, null if no transcription is loaded, or false if the
