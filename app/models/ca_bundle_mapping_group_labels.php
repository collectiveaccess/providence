<?php
/** ---------------------------------------------------------------------
 * app/models/ca_bundle_mapping_group_labels.php
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
BaseModel::$s_ca_models_definitions['ca_bundle_mapping_group_labels'] = array(
 	'NAME_SINGULAR' 	=> _t('mapping unit name'),
 	'NAME_PLURAL' 		=> _t('mapping unit names'),
 	'FIELDS' => array(
		'label_id' => array(
		...
		'name' => array(
				...
				'IS_NULL' => false,
				'DEFAULT' => '',
				'LABEL' => _t('Name'), 'DESCRIPTION' => _t('Name of mapping unit'),
		...
		'description' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => _t('Description'), 'DESCRIPTION' => _t('Description of mapping unit name'),
		...
		'locale_id' => array(
				...
				'LABEL' => _t('Locale'), 'DESCRIPTION' => _t('Locale of mapping unit name'),
		),
		'source_info' => array(
...
class ca_bundle_mapping_group_labels extends BaseLabel {
	# ---------------------------------
	...
	protected $TABLE = 'ca_bundle_mapping_group_labels';
	...
	protected $LABEL_SUBJECT_TABLE = 'ca_bundle_mapping_groups';
