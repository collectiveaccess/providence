<?php
/** ---------------------------------------------------------------------
 * app/models/ca_storage_locations_x_storage_locations.php : table access class for table
...
BaseModel::$s_ca_models_definitions['ca_storage_locations_x_storage_locations'] = array(
	...
	'FIELDS'        => array(
		...
		'location_left_id'  => array(
			...
			'IS_NULL'        => false,
			'DEFAULT'        => '',
			'LABEL'          => 'Location left id',
			'DESCRIPTION'    => 'Location left id'
		),
		'location_right_id' => array(
			...
			'IS_NULL'        => false,
			'DEFAULT'        => '',
			'LABEL'          => 'Location right id',
			'DESCRIPTION'    => 'Location right id'
		),
		'type_id'           => array(
			'FIELD_TYPE'     => FT_NUMBER,
			'DISPLAY_TYPE'   => DT_FIELD,
