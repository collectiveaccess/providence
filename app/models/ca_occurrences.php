...
BaseModel::$s_ca_models_definitions['ca_occurrences'] = array(
    ...
    'FIELDS' => array(
        'occurrence_id' => array(
            ...
            'DESCRIPTION' => _t(
                'Unique numeric identifier used by CollectiveAccess internally to identify this occurrence'
            )
        ),
        'parent_id' => array(
            'FIELD_TYPE' => FT_NUMBER,
        ...
        'type_id' => array(
            ...
            'LABEL' => _t('Type'),
            'DESCRIPTION' => _t(
                'The type of the occurrence. In CollectiveAccess every occurrence has a single "instrinsic" type that determines the set of descriptive and administrative metadata that can be applied to it.'
            )
        ),
        'idno' => array(
            'FIELD_TYPE' => FT_TEXT,
        ...
        'source_id' => array(
            ...
            'LABEL' => _t('Source'),
            'DESCRIPTION' => _t(
                'Administrative source. This value is often used to indicate the administrative sub-division or legacy database from which the information originates, but can also be re-tasked for use as a simple classification tool if needed.'
            )
        ),
        'source_info' => array(
            'FIELD_TYPE' => FT_VARS,
