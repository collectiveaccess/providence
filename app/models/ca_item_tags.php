...
BaseModel::$s_ca_models_definitions['ca_item_tags'] = array(
	...
	'FIELDS'        => array(
		'tag_id'    => array(
			...
			'DESCRIPTION'    => _t( 'Unique numeric identifier used by CollectiveAccess internally to identify this tag' )
		),
		'locale_id' => array(
			'FIELD_TYPE'     => FT_NUMBER,
			...
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Locale' ),
			'DESCRIPTION'    => _t( 'The locale of the tag.' )
		),
		'tag'       => array(
			'FIELD_TYPE'     => FT_TEXT,
			...
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Tag' ),
			'DESCRIPTION'    => _t( 'Text of the tag.' ),
...
class ca_item_tags extends BaseModel {
	 ...
	 *        value
	 *
	 * @param bool $pb_moderation_status To return only unmoderated tags set to FALSE; to return only moderated tags
	 *                                   set to TRUE; to return all tags set to null or omit
