<?php
/** ---------------------------------------------------------------------
 * app/models/ca_object_representations_x_storage_locations.php : table access class for table
...
BaseModel::$s_ca_models_definitions['ca_object_representations_x_storage_locations'] = array(
	...
	'FIELDS'        => array(
		...
		'location_id'       => array(
			...
			'DEFAULT'        => '',
			'LABEL'          => 'Location id',
			'DESCRIPTION'    => 'Identifier for storage location'
		),
		'type_id'           => array(
			'FIELD_TYPE'     => FT_NUMBER,
			'DISPLAY_TYPE'   => DT_FIELD,
		...
		'is_primary'        => array(
			...
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Is primary?' ),
			'DESCRIPTION'    => _t( 'Indicates that the representation should be used to depict the storage location is situations where only a single representation can be displayed (eg. search results).' )
		),
		'rank'              => array(
			'FIELD_TYPE'     => FT_NUMBER,
