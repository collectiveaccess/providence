...
BaseModel::$s_ca_models_definitions['ca_search_form_placements'] = array(
    ...
    'FIELDS' => array(
        ...
        'rank' => array(
            ...
            'LABEL' => _t('Sort order'),
            'DESCRIPTION' => _t(
                'The relative priority of the search form element when displayed in a list with other elements in a form. Lower numbers indicate higher priority.'
            )
        )
    )
);
...
class ca_search_form_placements extends BaseModel
{
    ...
    public function setSettingDefinitionsForPlacement($pa_additional_settings)
    {
        ...
        $this->SETTINGS = new ModelSettings(
            ...
            'settings',
            array_merge(
                $_ca_editor_search_form_placement_settings,
