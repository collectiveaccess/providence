...
BaseModel::$s_ca_models_definitions['ca_object_representation_captions'] = array(
	...
	'FIELDS'        => array(
		'caption_id'        => array(
			...
			'IS_NULL'        => false,
			'DEFAULT'        => '',
			'LABEL'          => 'Caption file id',
			'DESCRIPTION'    => 'Identifier for caption file'
		),
		'representation_id' => array(
			...
			'DESCRIPTION'    => 'The representation to which this caption file is attached.'
		),
		'locale_id'         => array(
			'FIELD_TYPE'     => FT_NUMBER,
			...
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Locale' ),
			'DESCRIPTION'    => _t( 'The locale of the captions.' )
		),
		'caption_file'      => array(
			'FIELD_TYPE'     => FT_FILE,
			...
			'LABEL'          => _t( 'Caption file to upload' ),
			'DESCRIPTION'    => _t( 'Use this control to select a caption file from your computer to upload.' )
		),
		'caption_content'   => array(
			...
			'IS_NULL'        => false,
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Caption content' ),
			'DESCRIPTION'    => _t( 'Caption content' )
		)
	)
);
