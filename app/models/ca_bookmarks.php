...
BaseModel::$s_ca_models_definitions['ca_bookmarks'] = array(
	...
	'FIELDS'        => array(
		'bookmark_id' => array(
			...
			'DESCRIPTION'    => _t( 'Unique numeric identifier used by CollectiveAccess internally to identify this bookmark' )
		),
		'folder_id'   => array(
			'FIELD_TYPE'      => FT_NUMBER,
			...
			'DEFAULT'         => '',
			'LABEL'           => _t( 'Folder' ),
			'DESCRIPTION'     => _t( 'Indicates the folder to which the bookmark belongs.' )
		),
		'table_num'   => array(
			'FIELD_TYPE'         => FT_NUMBER,
			'DISPLAY_TYPE'       => DT_SELECT,
			...
			'IS_NULL'            => false,
			'DEFAULT'            => '',
			'LABEL'              => _t( 'Bookmark type' ),
			'DESCRIPTION'        => _t( 'Indicates type of item bookmark represents.' ),
		...
		'row_id'      => array(
			...
			'DEFAULT'        => '',
			'LABEL'          => 'Row id',
			'DESCRIPTION'    => 'Identifier for row included in the bookmark list'
		),
		'rank'        => array(
			'FIELD_TYPE'     => FT_NUMBER,
		...
		'notes'       => array(
			...
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Notes' ),
			'DESCRIPTION'    => _t( 'Notes pertaining to the bookmark and/or bookmarked item.' ),
		...
		'created_on'  => array(
			...
			'IS_NULL'          => false,
			'DEFAULT'          => '',
			'LABEL'            => _t( 'Bookmark created on' ),
			'DESCRIPTION'      => _t( 'Date/time the bookmark was created.' ),
		),
	)
);
