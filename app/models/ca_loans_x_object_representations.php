...
BaseModel::$s_ca_models_definitions['ca_loans_x_object_representations'] = array(
    ...
    'FIELDS' => array(
        ...
        'loan_id' => array(
            ...
            'DEFAULT' => '',
            'LABEL' => 'Loan id',
            'DESCRIPTION' => 'Identifier for Loan'
        ),
        'type_id' => array(
            'FIELD_TYPE' => FT_NUMBER,
            'DISPLAY_TYPE' => DT_FIELD,
        ...
        'representation_id' => array(
            ...
            'DEFAULT' => '',
            'LABEL' => 'Collection id',
            'DESCRIPTION' => 'Identifier for collection'
        ),
        'source_info' => array(
            'FIELD_TYPE' => FT_TEXT,
            'DISPLAY_TYPE' => DT_FIELD,
        ...
        'effective_date' => array(
            ...
            'DESCRIPTION' => _t(
                'Period of time for which this relationship was in effect. This is an option qualification for the relationship. If left blank, this relationship is implied to have existed for as long as the related items have existed.'
            )
        ),
        'is_primary' => array(
            'FIELD_TYPE' => FT_BIT,
            ...
            'LABEL' => _t('Is primary?'),
            'DESCRIPTION' => _t(
                'Indicates that the representation should be used to depict the entity is situations where only a single representation can be displayed (eg. search results).'
            )
        ),
        'rank' => array(
            'FIELD_TYPE' => FT_NUMBER,
            ...
            'LABEL' => _t('Sort order'),
            'DESCRIPTION' => _t(
                'The relative priority of the relationship when displayed in a list with other relationships. Lower numbers indicate higher priority.'
            )
        )
    )
);
