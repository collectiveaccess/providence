...
BaseModel::$s_ca_models_definitions['ca_loans'] = array(
	...
	'FIELDS'        => array(
		'loan_id'              => array(
			...
			'DESCRIPTION'    => _t( 'Unique numeric identifier used by CollectiveAccess internally to identify this loan' )
		),
		'parent_id'            => array(
			'FIELD_TYPE'     => FT_NUMBER,
			...
			'DEFAULT'        => '',
			'LABEL'          => 'Parent id',
			'DESCRIPTION'    => 'Identifier of parent loan'
		),
		'type_id'              => array(
			'FIELD_TYPE'     => FT_NUMBER,
			...
			'LABEL'          => _t( 'Loan type' ),
			'DESCRIPTION'    => _t( 'The type of the loan. eg. incoming loan, outgoing loan, etc.' )
		),
		'idno'                 => array(
			'FIELD_TYPE'                => FT_TEXT,
			...
			'LABEL'                     => _t( 'Loan identifier' ),
			'DESCRIPTION'               => _t( 'A unique alphanumeric identifier for this loan.' ),
		...
		'source_id'            => array(
			...
			'LABEL'                     => _t( 'Source' ),
			'DESCRIPTION'               => _t( 'Administrative source of loan. This value is often used to indicate the administrative sub-division or legacy database from which the object originates, but can also be re-tasked for use as a simple classification tool if needed.' )
		),
		'source_info'          => array(
			'FIELD_TYPE'     => FT_VARS,
			'DISPLAY_TYPE'   => DT_OMIT,
			...
			'IS_NULL'        => false,
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Data source information' ),
			'DESCRIPTION'    => _t( 'Serialized array used to store source information for loan information retrieved via web services [NOT IMPLEMENTED YET].' )
		),
		'hier_loan_id'         => array(
			'FIELD_TYPE'     => FT_NUMBER,
			'DISPLAY_TYPE'   => DT_OMIT,
			...
			'IS_NULL'        => false,
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Loan hierarchy' ),
			'DESCRIPTION'    => _t( 'Identifier of loan that is root of the loan hierarchy.' )
		),
		'hier_left'            => array(
			'FIELD_TYPE'     => FT_NUMBER,
			'DISPLAY_TYPE'   => DT_OMIT,
		...
		'access'               => array(
			...
			'LABEL'                     => _t( 'Access' ),
			'DESCRIPTION'               => _t( 'Indicates if loan information is accessible to the public or not. ' )
		),
		'status'               => array(
			'FIELD_TYPE'                => FT_NUMBER,
			'DISPLAY_TYPE'              => DT_SELECT,
			...
			'LABEL'                     => _t( 'Status' ),
			'DESCRIPTION'               => _t( 'Indicates the current state of the loan record.' )
		),
		'deleted'              => array(
			'FIELD_TYPE'     => FT_BIT,
			'DISPLAY_TYPE'   => DT_OMIT,
			...
			'DEFAULT'        => 0,
			'LABEL'          => _t( 'Is deleted?' ),
			'DESCRIPTION'    => _t( 'Indicates if the loan is deleted or not.' ),
...
class ca_loans extends RepresentableBaseModel implements IBundleProvider {
	...
	protected function initLabelDefinitions( $pa_options = null ) {
		...
		$this->BUNDLES['ca_entities']                            = array( 'type'      => 'related_table',
		                                                                  'repeating' => true,
		...
		$this->BUNDLES['ca_list_items'] = array( 'type'      => 'related_table',
		                                         'repeating' => true,
