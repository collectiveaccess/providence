...
BaseModel::$s_ca_models_definitions['ca_bundle_display_placements'] = array(
	...
	'FIELDS'        => array(
		'placement_id' => array(
			...
			'DEFAULT'        => '',
			'LABEL'          => 'Placement id',
			'DESCRIPTION'    => 'Identifier for placement'
		),
		'display_id'   => array(
			'FIELD_TYPE'     => FT_NUMBER,
			...
			'DEFAULT'        => '',
			'LABEL'          => 'Display id',
			'DESCRIPTION'    => 'Identifier for display'
		),
		'bundle_name'  => array(
			'FIELD_TYPE'     => FT_TEXT,
			'DISPLAY_TYPE'   => DT_FIELD,
			...
			'IS_NULL'        => false,
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Bundle name' ),
			'DESCRIPTION'    => _t( 'Name of bundle to display' ),
		...
		'rank'         => array(
			...
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Sort order' ),
			'DESCRIPTION'    => _t( 'The relative priority of the display when displayed in a list with other displays. Lower numbers indicate higher priority.' )
		)
	)
);
...
class ca_bundle_display_placements extends BaseModel {
	...
	/**
	 * Sets setting definitions for to use for the current display placement. Note that these definitions persist no
	 * matter what row is loaded
	 * (or even if no row is loaded). You can set the definitions once and reuse the instance for many placements. All
	 * will have the set definitions.
	 *
	...
	public function setSettingDefinitionsForPlacement( $pa_additional_settings ) {
		...
		$this->SETTINGS = new ModelSettings( $this, 'settings',
			array_merge( $_ca_editor_display_placement_settings, $pa_additional_settings ) );
