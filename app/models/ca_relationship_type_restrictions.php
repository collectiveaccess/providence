<?php
/** ---------------------------------------------------------------------
 * app/models/ca_relationship_type_restrictions.php : table access class for table ca_relationship_type_restrictions
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
class ca_relationship_type_restrictions extends BaseModel {
	use ModelSettings;
	...
	protected $TABLE = 'ca_relationship_type_restrictions';
