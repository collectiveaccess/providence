...
BaseModel::$s_ca_models_definitions['ca_list_item_labels'] = array(
    ...
    'FIELDS' => array(
        ...
        'locale_id' => array(
            ...
            'LABEL' => _t('Locale'),
            'DESCRIPTION' => _t('Locale of label'),
        ),
        'type_id' => array(
            'FIELD_TYPE' => FT_NUMBER,
            'DISPLAY_TYPE' => DT_SELECT,
            ...
            'LABEL' => _t('Type'),
            'DESCRIPTION' => _t('Indicates type of label and how it should be employed.')
        ),
        'name_singular' => array(
            'FIELD_TYPE' => FT_TEXT,
            ...
            'IS_NULL' => false,
            'DEFAULT' => '',
            'LABEL' => _t('Item name (singular)'),
            'DESCRIPTION' => _t('The name of this list item in the singular form (eg. "disk", "lobster").'),
        ...
        'name_plural' => array(
            ...
            'IS_NULL' => false,
            'DEFAULT' => '',
            'LABEL' => _t('Item name (plural)'),
            'DESCRIPTION' => _t('The name of this list item in the plural form (eg. "disks", "lobsters").'),
            'BOUNDS_LENGTH' => array(1, 255)
        ),
        'name_sort' => array(
            'FIELD_TYPE' => FT_TEXT,
            ...
            'DEFAULT' => '',
            'LABEL' => 'Sort order',
            'DESCRIPTION' => 'Sortable version of name value',
        ...
        'description' => array(
            ...
            'DESCRIPTION' => _t('A description of the list item, including suggested use notes or definitions.'),
        ...
        'is_preferred' => array(
            ...
            'IS_NULL' => false,
            'DEFAULT' => '',
            'LABEL' => _t('Is preferred?'),
            'DESCRIPTION' => _t('Set this if this label is the preferred label for the current locale.'),
