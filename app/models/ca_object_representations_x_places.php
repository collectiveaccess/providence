...
BaseModel::$s_ca_models_definitions['ca_object_representations_x_places'] = array(
    ...
    'FIELDS' => array(
        ...
        'place_id' => array(
            ...
            'DEFAULT' => '',
            'LABEL' => 'Place id',
            'DESCRIPTION' => 'Identifier for Place'
        ),
        'type_id' => array(
            'FIELD_TYPE' => FT_NUMBER,
            'DISPLAY_TYPE' => DT_FIELD,
        ...
        'is_primary' => array(
            ...
            'LABEL' => _t('Is primary?'),
            'DESCRIPTION' => _t(
                'Indicates that the representation should be used to depict the place is situations where only a single representation can be displayed (eg. search results).'
            )
        ),
        'rank' => array(
            'FIELD_TYPE' => FT_NUMBER,
