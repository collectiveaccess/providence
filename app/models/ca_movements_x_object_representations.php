...
BaseModel::$s_ca_models_definitions['ca_movements_x_object_representations'] = array(
 	...
 	'FIELDS' 			=> array(
		...
		'is_primary' => array(
				...
				'IS_NULL' => false, 
				'DEFAULT' => '',
				'LABEL' => _t('Is primary?'), 'DESCRIPTION' => _t('Indicates that the representation should be used to depict the movement in situations where only a single representation can be displayed (eg. search results).')
		),
		'rank' => array(
