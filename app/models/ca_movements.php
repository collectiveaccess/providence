...
BaseModel::$s_ca_models_definitions['ca_movements'] = array(
    ...
    'FIELDS' => array(
        'movement_id' => array(
            ...
            'DESCRIPTION' => _t(
                'Unique numeric identifier used by CollectiveAccess internally to identify this movement'
            )
        ),
        'type_id' => array(
            'FIELD_TYPE' => FT_NUMBER,
        ...
        'source_id' => array(
            ...
            'LABEL' => _t('Source'),
            'DESCRIPTION' => _t(
                'Administrative source of movement. This value is often used to indicate the administrative sub-division or legacy database from which the object originates, but can also be re-tasked for use as a simple classification tool if needed.'
            )
        ),
        'source_info' => array(
            'FIELD_TYPE' => FT_VARS,
            ...
            'DESCRIPTION' => _t(
                'Serialized array used to store source information for movement information retrieved via web services [NOT IMPLEMENTED YET].'
            )
        ),
        'access' => array(
            'FIELD_TYPE' => FT_NUMBER,
