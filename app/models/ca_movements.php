...
BaseModel::$s_ca_models_definitions['ca_movements'] = array(
	...
	'FIELDS'        => array(
		'movement_id'          => array(
			...
			'DESCRIPTION'    => _t( 'Unique numeric identifier used by CollectiveAccess internally to identify this movement' )
		),
		'type_id'              => array(
			'FIELD_TYPE'     => FT_NUMBER,
			...
			'DESCRIPTION'    => _t( 'The type of the movement. eg. administrative, exhibition, etc.' )
		),
		'idno'                 => array(
			'FIELD_TYPE'                => FT_TEXT,
			...
			'LABEL'                     => _t( 'Movement identifier' ),
			'DESCRIPTION'               => _t( 'A unique alphanumeric identifier for this movement.' ),
		...
		'source_id'            => array(
			...
			'LABEL'                     => _t( 'Source' ),
			'DESCRIPTION'               => _t( 'Administrative source of movement. This value is often used to indicate the administrative sub-division or legacy database from which the object originates, but can also be re-tasked for use as a simple classification tool if needed.' )
		),
		'source_info'          => array(
			'FIELD_TYPE'     => FT_VARS,
			'DISPLAY_TYPE'   => DT_OMIT,
			...
			'DESCRIPTION'    => _t( 'Serialized array used to store source information for movement information retrieved via web services [NOT IMPLEMENTED YET].' )
		),
		'access'               => array(
			'FIELD_TYPE'                => FT_NUMBER,
			'DISPLAY_TYPE'              => DT_SELECT,
			...
			'LABEL'                     => _t( 'Access' ),
			'DESCRIPTION'               => _t( 'Indicates if movement information is accessible to the public or not. ' )
		),
		'status'               => array(
			'FIELD_TYPE'                => FT_NUMBER,
			'DISPLAY_TYPE'              => DT_SELECT,
			...
			'LABEL'                     => _t( 'Status' ),
			'DESCRIPTION'               => _t( 'Indicates the current state of the movement record.' )
		),
		'deleted'              => array(
			'FIELD_TYPE'     => FT_BIT,
			'DISPLAY_TYPE'   => DT_OMIT,
			...
			'DEFAULT'        => 0,
			'LABEL'          => _t( 'Is deleted?' ),
			'DESCRIPTION'    => _t( 'Indicates if the movement is deleted or not.' ),
