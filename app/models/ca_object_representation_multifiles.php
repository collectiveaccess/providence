...
BaseModel::$s_ca_models_definitions['ca_object_representation_multifiles'] = array(
	...
	'FIELDS'        => array(
		...
		'representation_id' => array(
			...
			'DESCRIPTION'    => 'The representation to which this multifile is attached.'
		),
		'resource_path'     => array(
			'FIELD_TYPE'     => FT_TEXT,
...
class ca_object_representation_multifiles extends BaseModel {
	 ...
	 * @param string      $ps_bundle_name Optional bundle name to test readability on. If omitted readability is
	...
	function isReadable( $po_request, $ps_bundle_name = null ) {
		...
		if ( $ps_bundle_name ) {
			if ( $po_request->user->getBundleAccessLevel( 'ca_object_representations', $ps_bundle_name )
