...
BaseModel::$s_ca_models_definitions['ca_entities'] = array(
	...
	'FIELDS'        => array(
		'entity_id'            => array(
			...
			'DESCRIPTION'    => _t( 'Unique numeric identifier used by CollectiveAccess internally to identify this entity' )
		),
		'parent_id'            => array(
			'FIELD_TYPE'     => FT_NUMBER,
			...
			'DEFAULT'        => '',
			'LABEL'          => 'Parent id',
			'DESCRIPTION'    => 'Identifier of parent entity'
		),
		'locale_id'            => array(
			'FIELD_TYPE'     => FT_NUMBER,
			...
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Locale' ),
			'DESCRIPTION'    => _t( 'The locale from which the entity originates.' )
		),
		'source_id'            => array(
			'FIELD_TYPE'                => FT_NUMBER,
			'DISPLAY_TYPE'              => DT_SELECT,
			...
			'LABEL'                     => _t( 'Source' ),
			'DESCRIPTION'               => _t( 'Administrative source of the entity. This value is often used to indicate the administrative sub-division or legacy database from which the entity information originates, but can also be re-tasked for use as a simple classification tool if needed.' )
		),
		'type_id'              => array(
			'FIELD_TYPE'     => FT_NUMBER,
			'DISPLAY_TYPE'   => DT_SELECT,
			...
			'DESCRIPTION'    => _t( 'The type of the entity. eg. individual, organization, family, etc.' )
		),
		'idno'                 => array(
			'FIELD_TYPE'                => FT_TEXT,
			...
			'DEFAULT'                   => '',
			'ALLOW_BUNDLE_ACCESS_CHECK' => true,
			'LABEL'                     => _t( 'Entity identifier' ),
			'DESCRIPTION'               => _t( 'A unique alphanumeric identifier for this entity.' ),
		...
		'source_info'          => array(
			...
			'DESCRIPTION'    => _t( 'Serialized array used to store source information for entity information retrieved via web services [NOT IMPLEMENTED YET].' )
		),
		'lifespan'             => array(
			...
			'DEFAULT'                   => '',
			'ALLOW_BUNDLE_ACCESS_CHECK' => true,
			'START'                     => 'life_sdatetime',
			'END'                       => 'life_edatetime',
			'LABEL'                     => _t( 'Lifetime' ),
			'DESCRIPTION'               => _t( 'Lifetime of entity (date range)' )
		),
		'hier_entity_id'       => array(
			...
			'IS_NULL'        => false,
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Entity hierarchy' ),
			'DESCRIPTION'    => _t( 'Identifier of entity that is root of the entity hierarchy.' )
		),
		'hier_left'            => array(
			'FIELD_TYPE'     => FT_NUMBER,
			'DISPLAY_TYPE'   => DT_OMIT,
		...
		'access'               => array(
			...
			'LABEL'                     => _t( 'Access' ),
			'DESCRIPTION'               => _t( 'Indicates if entity information is accessible to the public or not. ' )
		),
		'status'               => array(
			'FIELD_TYPE'                => FT_NUMBER,
			'DISPLAY_TYPE'              => DT_SELECT,
			...
			'LABEL'                     => _t( 'Status' ),
			'DESCRIPTION'               => _t( 'Indicates the current state of the entity record.' )
		),
		'deleted'              => array(
			'FIELD_TYPE'     => FT_BIT,
			'DISPLAY_TYPE'   => DT_OMIT,
			...
			'DEFAULT'        => 0,
			'LABEL'          => _t( 'Is deleted?' ),
			'DESCRIPTION'    => _t( 'Indicates if the entity is deleted or not.' ),
...
class ca_entities extends RepresentableBaseModel implements IBundleProvider {
	...
	/**
	 * Implementations can override this to add more criteria for hashing, e.g. hierarchy path components or what have
	 * you
	 *
	 * @return array
	 */
