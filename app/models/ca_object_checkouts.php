...
BaseModel::$s_ca_models_definitions['ca_object_checkouts'] = array(
    ...
    'FIELDS' => array(
        'checkout_id' => array(
            ...
            'DESCRIPTION' => _t(
                'Unique numeric identifier used by CollectiveAccess internally to identify this object checkout entry'
            )
        ),
        'group_uuid' => array(
            'FIELD_TYPE' => FT_TEXT,
...
class ca_object_checkouts extends BundlableLabelableBaseModelWithAttributes
{
    ...
    public function checkout($pn_object_id, $pn_user_id, $ps_note = null, $ps_due_date = null, $pa_options = null)
    {
        ...
        if (is_null(
            $va_checkout_config = ca_object_checkouts::getObjectCheckoutConfigForType(
        ...
        if (!($va_checkout_config['allow_override_of_due_dates'] && $ps_due_date && caDateToUnixTimestamp(
                $ps_due_date
            ))) {
    ...
    public function objectHasReservations($pn_object_id, $pa_options = null)
    {
        ...
        while ($qr_history->nextHit()) {
            $va_reservations[] = array(
                ...
                'user_name' => $qr_history->get('ca_users.fname') . ' ' . $qr_history->get(
                        'ca_users.lname'
     ...
     * @return array
     */
    public static function getOutstandingCheckoutsForUser(
        $pn_user_id,
        $ps_display_template = null,
        $ps_datetime = null,
        $pa_options = null
    ) {
        if (!($o_db = caGetOption('db', $pa_options, null))) {
        ...
        return ca_object_checkouts::_collectCheckoutData(
            caMakeSearchResult('ca_object_checkouts', $qr_res->getAllFieldValues('checkout_id')),
            $ps_display_template
        );
    }
    # ------------------------------------------------------
     ...
     * @return array
     */
    public static function getOverdueCheckoutsForUser(
        $pn_user_id,
        $ps_display_template = null,
        $ps_datetime = null,
        $pa_options = null
     ...
     * @return array
     */
    public static function getCheckinsForUser(
        $pn_user_id,
        $ps_display_template = null,
        $ps_datetime = null,
        $pa_options = null
     ...
     * @return array
     */
    public static function getOutstandingReservationsForUser(
        $pn_user_id,
        $ps_display_template = null,
        $pa_options = null
    ) {
    ...
    public static function getItemsDueWithin($ps_interval, $pa_options = null)
    {
        ...
        if ($vs_template = caGetOption('template', $pa_options, null)) {
            $va_checkout_ids = $qr_res->getAllFieldValues('checkout_id');
            $va_template_values = caProcessTemplateForIDs(
                $vs_template,
                'ca_object_checkouts',
                $va_checkout_ids,
