...
BaseModel::$s_ca_models_definitions['ca_data_importer_groups'] = array(
	...
	'FIELDS'        => array(
		'group_id'    => array(
			...
			'DESCRIPTION'    => _t( 'Unique numeric identifier used by CollectiveAccess internally to identify this importer group' )
		),
		'importer_id' => array(
			'FIELD_TYPE'     => FT_NUMBER,
			...
			'DEFAULT'        => '',
			'LABEL'          => 'Importer id',
			'DESCRIPTION'    => 'Identifier for importer'
		),
		'group_code'  => array(
			'FIELD_TYPE'     => FT_TEXT,
			...
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Group code' ),
			'DESCRIPTION'    => _t( 'Unique alphanumeric identifier for this importer group.' ),
			'UNIQUE_WITHIN'  => array()
		...
		'destination' => array(
			...
			'DESCRIPTION'    => _t( 'Name of CollectiveAccess bundle to map to.' ),
		...
		'settings'    => array(
			...
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Settings' ),
			'DESCRIPTION'    => _t( 'Importer group settings' )
		)
	)
);
