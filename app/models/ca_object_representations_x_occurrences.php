<?php
/** ---------------------------------------------------------------------
 * app/models/ca_object_representations_x_occurrences.php : table access class for table
...
BaseModel::$s_ca_models_definitions['ca_object_representations_x_occurrences'] = array(
	...
	'FIELDS'        => array(
		...
		'is_primary'        => array(
			...
			'DEFAULT'        => '',
			'LABEL'          => _t( 'Is primary?' ),
			'DESCRIPTION'    => _t( 'Indicates that the representation should be used to depict the occurrence is situations where only a single representation can be displayed (eg. search results).' )
		),
		'rank'              => array(
			'FIELD_TYPE'     => FT_NUMBER,
