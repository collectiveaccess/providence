 ...
 */
 	...
 	class SearchToursController extends BaseSearchController {
 		 ...
 		 * need to do here is instantiate a new subject-appropriate subclass of BaseSearch 
 		 * (eg. ObjectSearch for objects, TourSearch for entities) and pass it to BaseSearchController->Form() 
 		 */ 
 		public function Form($pa_options=null) {
 			JavascriptLoadManager::register('imageScroller');
 			JavascriptLoadManager::register('tabUI');
 			return parent::Form(new TourSearch(), $pa_options);
 		}
 		# -------------------------------------------------------
 		/**
 		...
 		public function Tools($pa_parameters) {
 			...
 			return parent::Tools($pa_parameters, new TourSearch());
 		}
 		# -------------------------------------------------------
 	}
 ?>