...
class BrowseEntitiesController extends BaseBrowseController {
	...
	public function __construct(&$po_request, &$po_response, $pa_view_paths=null) {
		...
		$this->opa_views = caApplyFindViewUserRestrictions($po_request->getUser(), 'ca_entities', ['returnAll' => $this->request->config->get('enable_full_thumbnail_result_views_for_ca_entities_browse'), 'type_id' => $this->opn_type_restriction_id]);
	}	
	# -------------------------------------------------------
	/**
