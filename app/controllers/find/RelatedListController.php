...
class RelatedListController extends BaseSearchController {
	...
	public function Index($pa_options=null) {
		...
		if(!$t_related) { throw new Exception(_t('Invalid table name')); }
		...
		while($o_interstitial_res->nextHit()) {
			$va_ids[$o_interstitial_res->get('relation_id')] = $o_interstitial_res->get($t_related->primaryKey(true));
			$va_relation_id_map[$o_interstitial_res->get($t_related->primaryKey(true))] = array(
