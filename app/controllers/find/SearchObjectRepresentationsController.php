...
class SearchObjectRepresentationsController extends BaseSearchController {
	...
	public function __construct( &$po_request, &$po_response, $pa_view_paths = null ) {
		...
		$this->opo_browse = new ObjectRepresentationBrowse( $this->opo_result_context->getParameter( 'browse_id' ),
			'providence' );
	}
	# -------------------------------------------------------
	...
	public function _getSubTypeActionNav( $pa_item ) {
		return [
			[
				...
				"default"     => [ 'module'     => 'find',
				                   'controller' => 'SearchObjectRepresentations',
				                   'action'     => 'Index'
				],
				'parameters'  => array(
			...
			[
				...
				"default"         => [
					'module'     => 'find',
					'controller' => 'SearchObjectRepresentationsAdvanced',
					'action'     => 'Index'
				],
				'useActionInPath' => 1,
				'parameters'      => array(
			...
			[
				...
				"default"     => [ 'module'     => 'find',
				                   'controller' => 'BrowseObjectRepresentations',
				                   'action'     => 'Index'
				],
				'parameters'  => array(
					'type_id' => $pa_item['item_id']
