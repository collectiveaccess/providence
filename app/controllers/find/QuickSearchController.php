...
class QuickSearchController extends BaseFindController
{
    ...
    public function Index($pa_options = null)
    {
        ...
        $vs_default_actions["ca_objects"] = ($this->request->user->canDoAction(
            "can_edit_ca_objects"
        ) ? "Edit" : "Summary");
        $vs_default_actions["ca_object_lots"] = ($this->request->user->canDoAction(
            "can_edit_ca_object_lots"
        ) ? "Edit" : "Summary");
        $vs_default_actions["ca_entities"] = ($this->request->user->canDoAction(
            "can_edit_ca_entities"
        ) ? "Edit" : "Summary");
        $vs_default_actions["ca_places"] = ($this->request->user->canDoAction(
            "can_edit_ca_places"
        ) ? "Edit" : "Summary");
        $vs_default_actions["ca_occurrences"] = ($this->request->user->canDoAction(
            "can_edit_ca_occurrences"
        ) ? "Edit" : "Summary");
        $vs_default_actions["ca_collections"] = ($this->request->user->canDoAction(
            "can_edit_ca_collections"
        ) ? "Edit" : "Summary");
        $vs_default_actions["ca_storage_locations"] = ($this->request->user->canDoAction(
            "can_edit_ca_storage_locations"
        ) ? "Edit" : "Summary");
        $vs_default_actions["ca_loans"] = ($this->request->user->canDoAction("can_edit_ca_loans") ? "Edit" : "Summary");
        $vs_default_actions["ca_movements"] = ($this->request->user->canDoAction(
            "can_edit_ca_movements"
        ) ? "Edit" : "Summary");
        $vs_default_actions["ca_object_representations"] = ($this->request->user->canDoAction(
        ...
        $vs_default_actions["ca_tour_stops"] = ($this->request->user->canDoAction(
            "can_edit_ca_tours"
        ) ? "Edit" : "Summary");
        ...
        foreach ($va_searches as $vs_target => $va_sorts) {
            ...
            if (($o_config->get($vs_table . '_disable')) || (($vs_table == 'ca_tour_stops') && $o_config->get(
                        'ca_tours_disable'
                    ))) {
            ...
            $vo_result->setOption(
                'prefetch',
                $this->opn_num_results_per_item_type
            );    // get everything we need in one pass
            $vo_result->setOption(
                'dontPrefetchAttributes',
                true
    ...
    private function _doSearch($ps_target, $ps_search, $ps_sort, $ps_type = null)
    {
        ...
        if (!$this->request->user->canDoAction(
            'can_search_' . (($ps_target == 'ca_tour_stops') ? 'ca_tours' : $ps_target)
        )) {
            return '';
        }
        switch ($ps_target) {
            ...
            case 'ca_object_lots':
                ...
                return $o_object_lots_search->search(
                    $ps_search,
                    array(
                        'sort' => $ps_sort,
                        'search_source' => 'Quick',
            ...
            case 'ca_occurrences':
                ...
                return $o_occurrence_search->search(
                    $ps_search,
                    array(
                        'sort' => $ps_sort,
                        'search_source' => 'Quick',
            ...
            case 'ca_collections':
                ...
                return $o_collection_search->search(
                    $ps_search,
                    array(
                        'sort' => $ps_sort,
                        'search_source' => 'Quick',
            ...
            case 'ca_storage_locations':
                ...
                return $o_storage_location_search->search(
                    ($ps_search == '*') ? '(ca_storage_locations.is_enabled:1)' : '(' . $ps_search . ') AND (ca_storage_locations.is_enabled:1)',
                    array(
                        'sort' => $ps_sort,
                        'search_source' => 'Quick',
                        'limit' => $this->opn_num_results_per_item_type,
            ...
            case 'ca_movements':
                ...
                return $o_movement_search->search(
                    $ps_search,
                    array(
                        'sort' => $ps_sort,
                        'search_source' => 'Quick',
            ...
            case 'ca_tour_stops':
                ...
                return $o_tour_stop_search->search(
                    $ps_search,
                    array(
                        'sort' => $ps_sort,
                        'search_source' => 'Quick',
