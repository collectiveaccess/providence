...
class SearchCollectionsAdvancedController extends BaseAdvancedSearchController {
	...
	public function __construct( &$po_request, &$po_response, $pa_view_paths = null ) {
		...
		$this->opo_browse = new CollectionBrowse( $this->opo_result_context->getParameter( 'browse_id' ),
			'providence' );
	}
	# -------------------------------------------------------
	 ...
	 * (eg. ObjectSearch for objects, CollectionSearch for collections) and pass it to
	 * BaseAdvancedSearchController->Index()
	 */
