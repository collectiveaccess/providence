...
class SearchStorageLocationsAdvancedController extends BaseAdvancedSearchController {
	...
	public function __construct( &$po_request, &$po_response, $pa_view_paths = null ) {
		...
		$this->opo_browse = new StorageLocationBrowse( $this->opo_result_context->getParameter( 'browse_id' ),
			'providence' );
	}
	# -------------------------------------------------------
	 ...
	 * (eg. ObjectSearch for objects, StorageLocationSearch for storage locations) and pass it to
