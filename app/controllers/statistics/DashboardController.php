 ...
 */
 	...
 	class DashboardController extends ActionController {
 		...
 		public function Index() {
 			...
 			$this->view->setVar('data', StatisticsAggregator::getAggregatedData());
 			$this->view->setVar('groups', StatisticsAggregator::getGroups());
 			$this->view->setVar('sources', StatisticsAggregator::getSources());
