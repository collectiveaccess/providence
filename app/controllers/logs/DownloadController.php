	...
	public function Index() {
		...
		if ( is_array( $va_download_list ) && sizeof( $va_download_list ) ) {
			...
			foreach ( $va_row_id_by_table_num as $vn_table_num => $va_row_ids ) {
				...
				$va_record_labels_by_table_num[ $vn_table_num ]
				                                           = $t_table->getPreferredDisplayLabelsForIDs( $va_row_ids );
			}
			...
			switch ( $ps_group_by ) {
				...
				case "record":
					...
					foreach ( $va_download_list as $va_download ) {
						$va_download_list_by_record[ $va_download["table_num"] . "-" . $va_download["row_id"] ]["info"]
							= $va_download;
						$va_download_list_by_record[ $va_download["table_num"] . "-"
						                             . $va_download["row_id"] ]["num_downloads"]
							= $va_download_list_by_record[ $va_download["table_num"] . "-"
							                               . $va_download["row_id"] ]["num_downloads"] + 1;
						if ( $va_download["user_id"] ) {
							$va_download_list_by_record[ $va_download["table_num"] . "-"
							                             . $va_download["row_id"] ]["num_logged_in_users"][ $va_download["user_id"] ]
								= $va_download["user_id"];
						} else {
							$va_download_list_by_record[ $va_download["table_num"] . "-"
							                             . $va_download["row_id"] ]["num_anon_users"]
								= $va_download_list_by_record[ $va_download["table_num"] . "-"
								                               . $va_download["row_id"] ]["num_anon_users"] + 1;
						}
					}
