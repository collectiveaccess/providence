...
class MediaImportController extends ActionController
{
    ...
    public function __construct(&$po_request, &$po_response, $pa_view_paths = null)
    {
        ...
        if (!$po_request->user->canDoAction('can_batch_import_media')) {
            $po_response->setRedirect(
                $po_request->config->get('error_display_url') . '/n/3410?r=' . urlencode($po_request->getFullUrlPath())
            );
            return;
        }
    ...
    public function Index($pa_values = null, $pa_options = null)
    {
        ...
        $this->view->setVar(
            'batch_mediaimport_last_settings',
        ...
        $this->view->setVar(
            ...
            caHTMLSelect(
                ...
                array(
                    ...
                    'onchange' => 'window.location.replace("' . caNavUrl(
                            $this->getRequest(),
                            $this->getRequest()->getModulePath(),
        ...
        $this->view->setVar(
            ...
            caHTMLSelect(
                ...
                array(),
                array('value' => $va_last_settings['importMode'])
            )
        );
        ...
        $this->view->setVar(
            ...
            caHTMLSelect(
                ...
                array(),
                array('value' => $va_last_settings['matchMode'])
            )
        );
        ...
        $this->view->setVar(
            ...
            caHTMLSelect(
                ...
                array(),
                array('value' => $va_last_settings['matchType'])
            )
        );

        $this->view->setVar(
            $vs_import_target . '_type_list',
            $t_instance->getTypeListAsHTMLFormElement(
                $vs_import_target . '_type_id',
                null,
                array('value' => $va_last_settings[$vs_import_target . '_type_id'])
            )
        );
        $this->view->setVar(
            $vs_import_target . '_limit_to_types_list',
            $t_instance->getTypeListAsHTMLFormElement(
        ...
        $this->view->setVar(
            'ca_object_representations_type_list',
            $t_rep->getTypeListAsHTMLFormElement(
                'ca_object_representations_type_id',
                null,
        ...
        if ($vs_import_target != 'ca_objects') { // non-object representations have relationship types
            ...
            $this->getView()->setVar(
                $vs_import_target . '_representation_relationship_type',
                $t_rel->getRelationshipTypesAsHTMLSelect(
                    'ltor',
                    null,
                    null,
                    array('name' => $vs_import_target . '_representation_relationship_type'),
                    array('value' => $va_last_settings[$vs_import_target . '_representation_relationship_type'])
                )
            );
        }
        if ((bool)$this->request->config->get('allow_user_selection_of_embedded_metadata_extraction_mapping')) {
            $add_null_opt = (bool)$this->request->config->get(
                'allow_user_embedded_metadata_extraction_mapping_null_option'
            );
            ...
            $va_object_representation_importer_options = ca_data_importers::getImportersAsHTMLOptions(
                [
                    'formats' => ['exif', 'mediainfo'],
            ...
            $this->view->setVar(
                $vs_import_target . '_mapping_list',
                caHTMLSelect(
                    $vs_import_target . '_mapping_id',
                    $va_object_importer_options,
                    array(),
            ...
            $this->view->setVar(
                'ca_object_representations_mapping_list',
                caHTMLSelect(
                    'ca_object_representations_mapping_id',
                    $va_object_representation_importer_options,
                    array(),
                    array('value' => $va_last_settings['ca_object_representations_mapping_id'])
                )
            );
        ...
        //
        $t_set = new ca_sets();
        $va_available_set_list = caExtractValuesByUserLocale(
            $t_set->getSets(
                array(
    ...
    public function Save($pa_options = null)
    {
        ...
        if (preg_match("!/\.\.!", $vs_directory) || preg_match("!\.\./!", $vs_directory)) {
            $this->response->setRedirect(
                $this->request->config->get('error_display_url') . '/n/3250?r=' . urlencode(
        ...
        $va_options = array(
            ...
            $vs_import_target . '_limit_matching_to_type_ids' => $this->request->getParameter(
                $vs_import_target . '_limit_matching_to_type_ids',
                pArray
            ),
            $vs_import_target . '_type_id' => $this->request->getParameter($vs_import_target . '_type_id', pInteger),
            'ca_object_representations_type_id' => $this->request->getParameter(
                'ca_object_representations_type_id',
                pInteger
            ),
            $vs_import_target . '_status' => $this->request->getParameter($vs_import_target . '_status', pInteger),
            'ca_object_representations_status' => $this->request->getParameter(
                'ca_object_representations_status',
                pInteger
            ),
            $vs_import_target . '_access' => $this->request->getParameter($vs_import_target . '_access', pInteger),
            'ca_object_representations_access' => $this->request->getParameter(
                'ca_object_representations_access',
                pInteger
            ),
            $vs_import_target . '_mapping_id' => $this->request->getParameter(
                $vs_import_target . '_mapping_id',
                pInteger
            ),
            'ca_object_representations_mapping_id' => $this->request->getParameter(
                'ca_object_representations_mapping_id',
                pInteger
            ),
        ...
        if ($vn_rel_type = $this->request->getParameter(
            $vs_import_target . '_representation_relationship_type',
            pInteger
        )) {
        ...
        if (is_array($va_create_relationships_for = $this->request->getParameter('create_relationship_for', pArray))) {
            ...
            foreach ($va_create_relationships_for as $vs_rel_table) {
                $va_options['relationship_type_id_for_' . $vs_rel_table] = $this->request->getParameter(
                    'relationship_type_id_for_' . $vs_rel_table,
                    pString
                );
            }
        }
        ...
        $va_last_settings['importFromDirectory'] = preg_replace(
        ...
        if ((bool)$this->request->config->get('queue_enabled') && (bool)$this->request->getParameter(
            ...
            $vs_row_key = $vs_entity_key = join(
                ...
                array(
                    ...
                    $va_options['importFromDirectory'],
                    time(),
                    rand(1, 999999)
                )
            );
    ...
    public function GetDirectoryLevel()
    {
        ...
        if ($this->request->getParameter('init', pInteger)) {
            ...
            foreach ($va_tmp as $vs_tmp) {
                ...
                $va_level_data["{$vs_k}|{$vn_i}"] = $va_file_list = $this->_getDirectoryListing(
                    $vs_root_directory . '/' . $vs_directory,
                    false,
                    20,
                    (int)$vn_start,
                    (int)$pn_max
            ...
            if (!$ps_directory) {
                ...
                $va_level_data["{$vs_k}|{$vn_level}"] = $va_file_list = $this->_getDirectoryListing(
                    $vs_root_directory . '/' . $ps_directory,
                    false,
                    20,
                    (int)$pn_start,
                    (int)$pn_max
    ...
    public function UploadFiles()
    {
        ...
        $va_response['uploadMessage'] = (($vn_upload_count = sizeof($va_response['copied'])) == 1) ? _t(
            'Uploaded %1 file',
            $vn_upload_count
        ) : _t('Uploaded %1 files', $vn_upload_count);
        if (is_array($va_response['skipped']) && ($vn_skip_count = sizeof(
                $va_response['skipped']
            )) && !$va_response['error']) {
            $va_response['skippedMessage'] = ($vn_skip_count == 1) ? _t('Skipped %1 file', $vn_skip_count) : _t(
                'Skipped %1 files',
                $vn_skip_count
            );
        }
