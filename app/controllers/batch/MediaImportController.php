 		...
 		public function Save($pa_options=null) {
			...
			if(!$this->getRequest()->getAppDatamodel()->tableExists($vs_import_target)) {
 			...
 			$va_options = array(
				...
				$vs_import_target.'_limit_matching_to_type_ids' => $this->request->getParameter('ca_objects_limit_matching_to_type_ids', pArray),
 				$vs_import_target.'_type_id' => $this->request->getParameter('ca_objects_type_id', pInteger),
 				'ca_object_representations_type_id' => $this->request->getParameter('ca_object_representations_type_id', pInteger),
 				$vs_import_target.'_status' => $this->request->getParameter('ca_objects_status', pInteger),
 				'ca_object_representations_status' => $this->request->getParameter('ca_object_representations_status', pInteger),
 				$vs_import_target.'_access' => $this->request->getParameter('ca_objects_access', pInteger),
 				'ca_object_representations_access' => $this->request->getParameter('ca_object_representations_access', pInteger),
 				$vs_import_target.'_mapping_id' => $this->request->getParameter('ca_objects_mapping_id', pInteger),
