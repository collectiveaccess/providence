...
class ConfigurationCheckController extends ActionController
{
    ...
    public function DoCheck()
    {
        ...
        $va_gd = array(
            'name' => 'GD',
            'description' => _t('GD is a graphics processing library required for all barcode generation.')
        );
        ...
        $va_md_extraction_components = [
            'EXIFTool' => [
                'available' => false,
                'description' => _t(
                    'A tool for extraction of embedded metadata in images, documents and other media. See https://exiftool.org for additional information.'
                ),
                'warnings' => [],
                'errors' => []
            ],
            'MediaInfo' => [
                'available' => false,
                'description' => _t(
                    'A tool for extraction of embedded metadata from audio and video files. See https://mediaarea.net/en/MediaInfo for additional information.'
                ),
                'warnings' => [],
                'errors' => []
            ]
