...
class InterfacesController extends BaseEditorController {
	...
	public function ListUIs() {
		...
		$this->view->setVar( 'table_list',
			caFilterTableList( $t_ui->getFieldInfo( 'editor_type', 'BOUNDS_CHOICE_LIST' ) ) );
	 ...
	 *
	 * @return bool Returns true on success (either UI already exists or was created successfully), false on error (UI
