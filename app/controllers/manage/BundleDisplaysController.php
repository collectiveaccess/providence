...
class BundleDisplaysController extends ActionController {
	...
	public function ListDisplays() {
		...
		$this->view->setVar( 'display_list', $va_displays
			= caExtractValuesByUserLocale( $t_display->getBundleDisplays( array(
			'user_id' => $this->request->getUserID(),
			'access'  => __CA_BUNDLE_DISPLAY_EDIT_ACCESS__
		) ), null, null, array() ) );
		...
		$this->view->setVar( 'table_list',
			caFilterTableList( $t_display->getFieldInfo( 'table_num', 'BOUNDS_CHOICE_LIST' ) ) );
	...
	public function Info() {
		...
		$this->view->setVar( 'bundle_displays', caExtractValuesByUserLocale( $t_display->getBundleDisplays( array(
			'user_id' => $this->request->getUserID(),
			'access'  => __CA_BUNDLE_DISPLAY_EDIT_ACCESS__
		) ), null, array() ) );
