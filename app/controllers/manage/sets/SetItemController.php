<?php
/** ---------------------------------------------------------------------
 * app/controllers/manage/sets/SetItemController.php : 
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
class SetItemController extends ActionController {
	# -------------------------------------------------------
...
// 		}
		...
		$va_component_types = null; //$this->request->config->getList('ca_objects_component_types');
	...
	public function Save($pa_options=null) {
		...
		if(!sizeof($_POST)) {
			...
			$this->render('set_item_result_json.php');
			return;
		}
