...
<?php
	$va_reps = $t_item->getRepresentations(array("thumbnail", "medium"), null, ['usePath' => false]);
...
<?php
	foreach($va_placements as $vn_placement_id => $va_bundle_info){
		...
		if (!strlen($vs_display_value = $t_display->getDisplayValue($t_item, $vn_placement_id, array('usePath' => false, 'purify' => true)))) {
