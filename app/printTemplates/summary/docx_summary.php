...
if ( $va_info['info']['medium']['MIMETYPE']
     == 'image/jpeg'
...
$contentCell->addText(
	caEscapeForXML( html_entity_decode( strip_tags( br2nl( $t_item->get( 'preferred_labels' ) ) ),
...
foreach ( $list as $vn_placement_id => $va_info ) {
	...
	} elseif ( $vs_display_text = $t_display->getDisplayValue( $t_item, $vn_placement_id,
