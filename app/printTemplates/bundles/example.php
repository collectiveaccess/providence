<?php
/* ----------------------------------------------------------------------
 * app/printTemplates/bundles/bundle.php
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
$values_as_attribute_instances = $this->getVar('valuesAsAttributeInstances');
...
$values_as_element_indexed_arrays = $this->getVar('valuesAsElementCodeArrays');
...
<table>
<?php
	foreach($values_as_element_indexed_arrays as $value) {
		print "<tr><td>".$value['number_ne']."</td><td>".$value['ne_purchaser']."</td></tr>\n";
	}
?>
</table>
