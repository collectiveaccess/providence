...
$vs_color          = ( $this->request->config->get( 'report_text_color' ) )
	? $this->request->config->get( 'report_text_color' ) : "FFFFFF";;
...
<div id='body'>
	...
	while ( $vo_result->nextHit() ) {
		...
		<div class="thumbnail" style="left: <?php print $vn_left; ?>mm; top: <?php print $vn_top + 3; ?>mm;">
			<?php print "<div class='imgThumb'><img src='"
			            . $vo_result->getMediaPath( 'ca_object_representations.media', 'preview' ) . "'/></div>"; ?>
			<br/>
			<?php print "<div class='caption'>"
