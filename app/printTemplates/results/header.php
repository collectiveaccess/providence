        ...
        case 'domPDF':
            ...
            <div id='header'>
                ...
                if (file_exists($this->getVar('base_path') . "/local/pdf.css")) {
                    ?>
                    <link type="text/css" href="<?php print $this->getVar('base_path'); ?>/local/pdf.css"
                          rel="stylesheet"/>
                    <?php
                } else {
                    ?>
                ...
                if (file_exists(
                    $this->request->getThemeDirectoryPath() . "/graphics/logos/" . $this->request->config->get(
                        'report_img'
                    )
                )) {
                    print '<img src="' . $this->request->getThemeDirectoryPath(
                        ) . '/graphics/logos/' . $this->request->config->get('report_img') . '" class="headerImg"/>';
                }
                ...
                PhantomJSPrinting['header'] = {
                    ...
                    contents: function (pageNum, numPages) {
                        return '<div style="position: absolute; width: 100%; height: 80px;"><img style="width:126px;height:30px;" src="data:image/png;base64,"/>'
                            + '<div style="position: absolute; top: 0px; right: 10px; font: "helvetica, sans-serif"; font-size: 10px; text-align: right;  margin: 0px 0px 10px 25px;"><?php print _t(
                                'Page'
                            ); ?> ' + pageNum + '</div></div>';
