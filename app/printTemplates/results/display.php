            ...
            <table>
                <tr>
                    <td style="width:250px;">
                        <?php
                        if ($va_rep = $vo_result->get(
                            'ca_object_representations.media.small',
                            [
                                'usePath' => true,
                                'scaleCSSWidthTo' => '250px',
                                'scaleCSSHeightTo' => '200px'
                            ]
                        )) {
                        ...
                        <div class="metaBlock">
                            ...
                            if (is_array($va_display_list)) {
                                foreach ($va_display_list as $vn_placement_id => $va_display_item) {
                                    ...
                                    print "<div class='metadata'><span class='displayHeader'>" . $va_display_item['display'] . "</span>: <span class='displayValue' >" . (strlen(
                                            $vs_display_value
                                        ) > 1200 ? strip_tags(
                                                substr($vs_display_value, 0, 1197)
