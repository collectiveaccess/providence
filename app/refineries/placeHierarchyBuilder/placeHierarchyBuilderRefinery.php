...
class placeHierarchyBuilderRefinery extends BaseRefinery {
	...
	public function refine( &$pa_destination_data, $pa_group, $pa_item, $pa_source_data, $pa_options = null ) {
		...
		// Set place hierarchy
		if (
			( $vs_hierarchy = $pa_item['settings']['placeHierarchyBuilder_hierarchy'] )
			// for compatibility with older mappings
		...
		if ( $va_parents = $pa_item['settings']['placeHierarchyBuilder_parents'] ) {
			...
			$vn_parent_id           = caProcessRefineryParents( 'placeHierarchyBuilder', 'ca_places', $va_parents,
