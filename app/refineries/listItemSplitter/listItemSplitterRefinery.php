...
class listItemSplitterRefinery extends BaseRefinery
{
    ...
    public function __construct()
    {
        ...
        $this->ops_description = _t(
            'Provides several list item-related import functions: splitting of many items in a string into separate names, and merging entity data with item names.'
        );
...
BaseRefinery::$s_refinery_settings['listItemSplitter'] = array(
    ...
    'listItemSplitter_hierarchicalListItemTypes' => array(
        ...
        'description' => _t(
            'A semicolon-delimited list of list item types to apply to hierarchical list items extracted using the hierarchical delimiter.'
        )
    ),
    ...
    'listItemSplitter_listItemType' => array(
        ...
        'description' => _t(
            'Accepts a constant list item idno from the list list_item_types or a reference to the location in the data source where the type can be found.'
        )
    ),
    'listItemSplitter_attributes' => array(
        ...
        'label' => _t('Attributes'),
        'description' => _t(
            'Sets or maps metadata for the list item record by referencing the metadataElement code and the location in the data source where the data values can be found.'
        )
    ),
    ...
    'listItemSplitter_interstitial' => array(
        ...
        'description' => _t(
            'Sets or maps metadata for the interstitial vocabulary <em>relationship</em> record by referencing the metadataElement code and the location in the data source where the data values can be found.'
        )
    ),
