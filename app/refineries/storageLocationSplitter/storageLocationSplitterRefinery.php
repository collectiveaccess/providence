...
class storageLocationSplitterRefinery extends BaseRefinery
{
    ...
    public function __construct()
    {
        ...
        $this->ops_description = _t(
            'Provides several storage location-related import functions: splitting of multiple locations in a string into individual values, mapping of type and relationship type for related locations, building location hierarchies and merging location data with names.'
        );
...
BaseRefinery::$s_refinery_settings['storageLocationSplitter'] = array(
    ...
    'storageLocationSplitter_hierarchicalStorageLocationTypes' => array(
        ...
        'description' => _t(
            'A semicolon-delimited list of storage location types to apply to hierarchical storage locations extracted using the hierarchical delimiter.'
        )
    ),
    ...
    'storageLocationSplitter_storageLocationTypeDefault' => array(
        ...
        'description' => _t(
            'Sets the default storage location type that will be used if none are defined or if the data source values do not match any values in the CollectiveAccess list storage_location_types'
        )
    ),
    'storageLocationSplitter_interstitial' => array(
        ...
        'description' => _t(
            'Sets or maps metadata for the interstitial storage location <em>relationship</em> record by referencing the metadataElement code and the location in the data source where the data values can be found.'
        )
    ),
