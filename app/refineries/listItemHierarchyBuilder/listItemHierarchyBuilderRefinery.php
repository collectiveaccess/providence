	...
	class listItemHierarchyBuilderRefinery extends BaseRefinery {
		...
		public function refine(&$pa_destination_data, $pa_group, $pa_item, $pa_source_data, $pa_options=null) {
			...
			if ($va_parents = $pa_item['settings']['listItemHierarchyBuilder_parents']) {
				$vn_parent_id = caProcessRefineryParents('listItemHierarchyBuilder', 'ca_list_items', $va_parents, $pa_source_data, $pa_item, null, null, array('reader' => caGetOption('reader', $pa_options, null), 'log' => $o_log, 'list_id' => $pa_item['settings']['listItemHierarchyBuilder_list']));
			}
