...
class dateAccuracyJoinerRefinery extends BaseRefinery
{
    ...
    public function refine(&$pa_destination_data, $pa_group, $pa_item, $pa_source_data, $pa_options = null)
    {
        ...
        $vo_normalised_date = DateTime::createFromFormat(
            $pa_item['settings']['dateAccuracyJoiner_dateFormat'],
            $vs_source_value
        );
...
BaseRefinery::$s_refinery_settings['dateAccuracyJoiner'] = array(
    ...
    'dateAccuracyJoiner_accuracyValueDay' => array(
        ...
        'description' => _t(
            'The case-insensitive value in the accuracy field that indicates that the date is accurate to the day'
        )
    ),
    'dateAccuracyJoiner_accuracyValueMonth' => array(
        ...
        'description' => _t(
            'The case-insensitive value in the accuracy field that indicates that the date is accurate to the month'
        )
    ),
    'dateAccuracyJoiner_accuracyValueYear' => array(
        ...
        'description' => _t(
            'The case-insensitive value in the accuracy field that indicates that the date is accurate to the year'
        )
    ),
