...
BaseRefinery::$s_refinery_settings['objectRepresentationSplitter'] = array(
    ...
    'objectRepresentationSplitter_objectRepresentationType' => array(
        ...
        'description' => _t(
            'Accepts a constant list item idno from the list object_representation_types or a reference to the location in the data source where the type can be found.'
        )
    ),
    ...
    'objectRepresentationSplitter_objectRepresentationTypeDefault' => array(
        ...
        'description' => _t(
            'Sets the default object representation type that will be used if none are defined or if the data source values do not match any values in the CollectiveAccess list object_types.'
        )
    ),
    'objectRepresentationSplitter_interstitial' => array(
        ...
        'description' => _t(
            'Sets or maps metadata for the interstitial object representation <em>relationship</em> record by referencing the metadataElement code and the location in the data source where the data values can be found.'
        )
    ),
