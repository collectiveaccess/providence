 ...
 */
	...
	class entitySplitterRefinery extends BaseRefinery {
		 ...
		 *
		 */
		public function refine($pm_value, $pa_data, $pa_group, $pa_settings, $pa_options=null) {
			$va_group_dest = explode(".", $pa_group['destination']);
			$vs_terminal = array_pop($va_group_dest);
			
			$va_split_name = DataMigrationUtils::splitEntityName($pm_value);
			...
			return array('preferred_labels' => DataMigrationUtils::splitEntityName($pm_value));
		}
		# -------------------------------------------------------
	}
