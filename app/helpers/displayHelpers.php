...
\n";
	...
	function caEditorBundleShowHideControl($po_request, $ps_id_prefix) {
		...
		$vs_buf  = "<span style='position: absolute; left: 500px; top: 4px; font-style: italic; font-weight: normal; display: none;' id='{$ps_preview_id_prefix}_BundleContentPreview'></span>";
