...
function caDetailUrl(
    ...
    $vn_id_for_idno = null;
    if (((int)$pn_id > 0) && ($vs_use_alt_identifier_in_urls = caUseAltIdentifierInUrls($ps_table)) && is_array(
            $attr_list = $t_table->getAttributeForIDs($vs_use_alt_identifier_in_urls, [$pn_id])
        )) {
