...
# ---------------------------------------
/**
 * Age calculation (in years) with arbitrary number of params. @return int
 * @see caGetDateTimeDiff
 */
function caCalculateAgeInYears()
{
    $va_args = func_get_args();
    $o_diff = caGetDateTimeDiff($va_args);
    if (!($o_diff instanceof DateInterval)) {
        return false;
    }
...
# ---------------------------------------
/**
 * Age calculation (in days) with arbitrary number of params. @return int
 * @see caGetDateTimeDiff
 */
