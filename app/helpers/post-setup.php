...
if (!defined("__CA_BASE_DIR__")) {
	define("__CA_BASE_DIR__", $_SERVER['SCRIPT_FILENAME'] ? preg_replace("!/install$!", "", pathinfo($_SERVER['SCRIPT_FILENAME'], PATHINFO_DIRNAME)) :  join(DIRECTORY_SEPARATOR, array_slice(explode(DIRECTORY_SEPARATOR, __FILE__), 0, -3)));
}
