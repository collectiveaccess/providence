		...
		foreach($pa_parents as $vn_i => $va_parent) {
			...
			switch($ps_table) {
				...
				case 'ca_entities':
					...
					$va_entity_label = DataMigrationUtils::splitEntityName($vs_name, array_merge($pa_options, ['type' => $vs_type, 'doNotParse' => $pa_item['settings']["{$ps_refinery_name}_doNotParse"]]));
