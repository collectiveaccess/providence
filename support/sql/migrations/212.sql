...
ALTER TABLE ca_sql_search_word_index MODIFY COLUMN word_index mediumint unsigned not null default 0;
ALTER TABLE ca_sql_search_word_index MODIFY COLUMN word_count mediumint unsigned not null default 0;
ALTER TABLE ca_sql_search_word_index MODIFY COLUMN field_index mediumint unsigned not null default 0;
