...
switch ($vs_entity_class) {
    case 'ORG':
        ...
        <table>
							<tr>
								<td>
									<?php print $t_label->htmlFormElement(
                                        'surname',
                                        null,
                                        array(
                                            'label' => _t('Name'),
                                            'description' => _t(
                                                'The full name of the organization, excluding for suffixes.'
                                            ),
                                            'width' => '500px',
							...
							<tr>
								<td colspan="2">
									<?php print '<div class="formLabel">' . $t_label->htmlFormElement(
                                            'locale_id',
                                            "^LABEL ^ELEMENT",
                                            array(
                                    ...
                                    <?php print $t_label->htmlFormElement(
                                            ...
                                            array(
                                                ...
                                                "value" => "{type_id}",
                                                'no_tooltips' => true,
                                                'list_code' => $this->request->config->get(
                                                    'ca_entities_preferred_label_type_list'
                                                ),
                                                'dont_show_null_value' => true,
    ...
    case 'IND_SM':
        ...
        <table>
							...
							<tr>
								...
								<td colspan="3"><?php print $t_label->htmlFormElement(
                                    'displayname',
                                    null,
                                    array(
                                        'name' => "{fieldNamePrefix}displayname_{n}",
...
?>
    ...
    <div class="bundleContainer">
        ...
        <div class='button labelInfo caAddLabelButton'><a href='#'><?php print caNavIcon(
                    __CA_NAV_ICON_ADD__,
                    '15px'
                ); ?><?php print $vs_add_label ? $vs_add_label : _t("Add label"); ?></a></div>
    </div>
</div>
<script type="text/javascript">
    caUI.initLabelBundle('#<?php print $vs_id_prefix; ?>Labels', {
        ...
        checkForDupes: <?php print ($t_label->getAppConfig()->get(
            'ca_entities_warn_when_preferred_label_exists'
        ) ? 'true' : 'false') ?>,
        checkForDupesUrl: '<?php print caNavUrl(
            $this->request,
            'editor/entities',
            'EntityEditor',
            'checkForDupeLabels'
