...
<?php
	if (!$vb_read_only) {
?>	
		<div class='button labelInfo caAddItemButton'><a href='#'><?php print caNavIcon(__CA_NAV_ICON_ADD__, 1); ?> <?php print $vs_add_label ? $vs_add_label : _t("Add  group access"); ?></a></div>
<?php
	}
?>
	</div>
