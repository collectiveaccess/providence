...
print caEditorBundleShowHideControl(
    ...
    _t("Number of media: %1", sizeof($va_initial_values))
);
...
?>
								...
								<script type="text/javascript">
                                    ...
                                    caUI.initIDNoChecker({
                                        ...
                                        singularAlreadyInUseMessage: '<?php print addslashes(
                                            _t('Identifier is already in use')
                                        ); ?>',
                                        pluralAlreadyInUseMessage: '<?php print addslashes(
                                            _t('Identifier is already in use %1 times')
                                        ); ?>'
                                    });
								</script>
							</div>
    ...
    <div class='caObjectRepresentationListActionButton'>
								<span id="{fieldNamePrefix}change_{n}"
                                      class="caObjectRepresentationListInfoSubDisplayUpdate"><a href='#'
                                                                                                class='updateIcon'
                                                                                                onclick="caOpenMediaDetailEditor('{n}'); return false;"><?php print caNavIcon(
...
<div class="bundleContainer">
    ...
    if (!$vb_read_only) {
        ...
        <div class='button labelInfo caAddItemButton'><a href='#'><?php print caNavIcon(
                    __CA_NAV_ICON_ADD__,
                    '15px'
                ); ?><?php print $vs_add_label ? $vs_add_label : _t("Add media") . " &rsaquo;"; ?></a></div>
        <?php
    }
    ?>
</div>
