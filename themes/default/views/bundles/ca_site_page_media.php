...
$va_initial_values   = caSanitizeArray( $t_subject->getBundleFormValues( 'ca_site_page_media',
	$this->getVar( 'placement_code' ), $va_settings, [ 'request' => $this->request ] ),
...
print caEditorBundleShowHideControl( $this->request, $vs_id_prefix . $t_item->tableNum() . '_rel', $va_settings,
	( sizeof( $va_initial_values ) > 0 ), _t( "Number of media: %1", sizeof( $va_initial_values ) ) );
				...
				<div style="float: left;">
					<div class="caObjectRepresentationListItemImageThumb"><a href="#"
					                                                         onclick="caMediaPanel.showPanel('<?php print urldecode( caNavUrl( $this->request,
						                                                         'manage/site_pages', 'SitePageEditor',
						                                                         'GetMediaOverlay', array(
							                                                         'page_id'  => $t_subject->getPrimaryKey(),
							                                                         'media_id' => '{n}'
...
if ( ! $vb_read_only ) {
	...
	<div id='{fieldNamePrefix}detail_editor_{n}' class="caObjectRepresentationDetailEditorContainer">
                                <div
	                                class="caObjectRepresentationDetailEditorElement"><?php print $t_item->htmlFormElement( 'title',
		                                null, array(
			                                'classname'         => 'caObjectRepresentationDetailEditorElement',
			                                'id'                => "{fieldNamePrefix}title_{n}",
			                                'name'              => "{fieldNamePrefix}title_{n}",
			                                'value'             => "{title}",
			                                'no_tooltips'       => false,
			                                'tooltip_namespace' => 'bundle_ca_site_page_media'
		                                ) ); ?></div>
                                <div
	                                class="caObjectRepresentationDetailEditorElement"><?php print $t_item->htmlFormElement( 'caption',
		                                null, array(
			                                'classname'         => 'caObjectRepresentationDetailEditorElement',
			                                'id'                => "{fieldNamePrefix}caption_{n}",
			                                'name'              => "{fieldNamePrefix}caption_{n}",
			                                'value'             => "{caption}",
			                                'no_tooltips'       => false,
			                                'tooltip_namespace' => 'bundle_ca_site_page_media'
		                                ) ); ?></div>
                                <div
	                                class="caObjectRepresentationDetailEditorElement"><?php print $t_item->htmlFormElement( 'idno',
		                                null, array(
			                                'classname'         => 'caObjectRepresentationDetailEditorElementReadOnly',
			                                ...
			                                'tooltip_namespace' => 'bundle_ca_site_page_media'
                                                     ...
                                                     id='{fieldNamePrefix}idno_status_{n}'></div></div>
								<div
									class="caObjectRepresentationDetailEditorElement"><?php print $t_item->htmlFormElement( 'access',
										null, array(
											'classname'         => 'caObjectRepresentationDetailEditorElement',
...
print caJSButton( $this->request, __CA_NAV_ICON_SAVE__, _t( 'Done' ), '{fieldNamePrefix}detail_editor_save_button{n}',
	array( 'onclick' => 'caCloseMediaDetailEditor("{n}"); return false;' ) );
?>
								</div>	
								...
								<script type="text/javascript">
									...
									caUI.initIDNoChecker({
										...
										lookupUrl: '<?php print caNavUrl( $this->request, 'lookup', 'SitePageMedia',
											'IDNo' ); ?>',
										searchUrl: '',
...
if ( ! $vb_read_only ) {
	?>
	<div class='caObjectRepresentationListActionButton'>
								<span id="{fieldNamePrefix}change_{n}"
								      class="caObjectRepresentationListInfoSubDisplayUpdate"><a href='#'
								                                                                class='updateIcon'
								                                                                onclick="caOpenMediaDetailEditor('{n}'); return false;"><?php print caNavIcon( __CA_NAV_ICON_UPDATE__,
											1 ) . ' ' . _t( 'Settings' ) . '</a>'; ?></span>
                            </div>
	<?php
}
?>
				...
				<div id="{fieldNamePrefix}media_replication_container_{n}" style="display: none;">
					<div class="caRepresentationMediaReplicationButton">
						<a href="#" id="{fieldNamePrefix}caRepresentationMediaReplicationButton_{n}"
						   ...
						   class="caRepresentationMediaReplicationButton"><?php print caNavIcon( __CA_NAV_ICON_MEDIA_METADATA__,
									'15px' ) . " " . _t( 'Replication' ); ?></a>
					</div>
					<div>
	...
	<textarea class='caNewItemTemplate' style='display: none;'>	
		<div id="<?php print $vs_id_prefix; ?>Item_{n}" class="labelInfo">
			...
			<div id='{fieldNamePrefix}detail_editor_{n}'>
				<div class="caObjectRepresentationDetailEditorElement"><?php print $t_item->htmlFormElement( 'title',
						null, array(
							'classname'         => 'caObjectRepresentationDetailEditorElement',
							'id'                => "{fieldNamePrefix}title_{n}",
							'name'              => "{fieldNamePrefix}title_{n}",
				...
				<div class="caObjectRepresentationDetailEditorElement"><?php print $t_item->htmlFormElement( 'caption',
						null, array(
							'classname'         => 'caObjectRepresentationDetailEditorElement',
							'id'                => "{fieldNamePrefix}caption_{n}",
							'name'              => "{fieldNamePrefix}caption_{n}",
				...
				<div class="caObjectRepresentationDetailEditorElement"><?php print $t_item->htmlFormElement( 'idno',
						null, array(
							'classname'         => 'caObjectRepresentationDetailEditorElementReadOnly',
							'id'                => "{fieldNamePrefix}idno_{n}",
							'name'              => "{fieldNamePrefix}idno_{n}",
							...
							'no_tooltips'       => false,
							'tooltip_namespace' => 'bundle_ca_site_page_media'
						) ); ?> <div style='margin-bottom: 10px;' id='{fieldNamePrefix}idno_status_{n}'></div></div>
				<div class="caObjectRepresentationDetailEditorElement"><?php print $t_item->htmlFormElement( 'access',
						null, array(
							'classname'         => 'caObjectRepresentationDetailEditorElement',
							'id'                => "{fieldNamePrefix}access_{n}",
							'name'              => "{fieldNamePrefix}access_{n}",
...
<div class="bundleContainer">
	<div class="downloadAll">
		...
		if ( $vn_page_media_count > 1 ) {
			print caNavLink( $this->request, caNavIcon( __CA_NAV_ICON_DOWNLOAD__, 1 ) . " " . _t( 'Download all' ),
				'button', '*', '*', 'DownloadMedia', [ $t_subject->primaryKey() => $t_subject->getPrimaryKey() ] );
		}
		?>
	</div>
	<br class="clear"/>
	...
	if ( ! $vb_read_only ) {
		...
		<div class='button labelInfo caAddItemButton'><a href='#'><?php print caNavIcon( __CA_NAV_ICON_ADD__,
					'15px' ); ?><?php print $vs_add_label ? $vs_add_label : _t( "Add media" ) . " &rsaquo;"; ?></a>
		</div>
		<?php
	}
	?>
...
<input type="hidden" id="<?php print $vs_id_prefix; ?>_MediaBundleList"
       name="<?php print $vs_id_prefix; ?>_MediaBundleList" value=""/>
<?php
// order element
