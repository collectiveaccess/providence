...
$vs_display_select_html = $t_display->getBundleDisplaysAsHTMLSelect( 'display_id', [], [
	'table'           => $t_item->tableNum(),
	'value'           => $t_display->getPrimaryKey(),
	'access'          => __CA_BUNDLE_DISPLAY_READ_ACCESS__,
	'user_id'         => $this->request->getUserID(),
	'restrictToTypes' => [ $t_item->getTypeID() ],
...
<?php print caFormTag( $this->request, 'PrintSummary', 'caSummaryDownloadOptionsForm', null, 'post',
	'multipart/form-data', '_top', [ 'disableUnsavedChangesWarning' => true, 'noCSRFToken' => true ] ); ?>
<div id="caSummaryDownloadOptionsPanel" class="caSummaryDownloadOptionsPanel">
	...
	<div id="caSummaryDownloadOptionsPanelContentArea">
		<div class="caSummaryDownloadOptionsPanelAlertControls">
			<table class="caSummaryDownloadOptionsPanelAlertControls">
				<tr style="vertical-align: top;">
					...
					<td class="caSummaryDownloadOptionsPanelAlertControl">
						<?php
						print _t( 'Format using<br/> %1',
							caHTMLSelect( 'template', array_flip( $this->getVar( 'formats' ) ), [],
								[ 'value' => caGetOption( 'template', $va_last_settings, null ) ] ) );
						?>
					</td>
				</tr>
			</table>
		...
		<div id="caSummaryDownloadOptionsPanelControlButtons">
			<table>
				<tr>
					<td align="right"><?php print caJSButton( $this->request, __CA_NAV_ICON_SAVE__, _t( 'Download' ),
							'caSummaryDownloadOptionsFormExecuteButton',
							array( 'onclick' => 'caExecuteSummaryDownload(); return false;' ), array() ); ?></td>
					<td align="left"><?php print caJSButton( $this->request, __CA_NAV_ICON_CANCEL__, _t( 'Cancel' ),
							'caSummaryDownloadOptionsFormCancelButton',
							array( 'onclick' => 'caSummaryDownloadOptionsPanel.hidePanel(); return false;' ),
							array() ); ?></td>
				</tr>
			</table>
		</div>
