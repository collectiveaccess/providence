...
$vs_display_select_html = $t_display->getBundleDisplaysAsHTMLSelect(
    'display_id',
    [],
    [
...
<?php print caFormTag(
    $this->request,
    'PrintSummary',
    'caSummaryDownloadOptionsForm',
    null,
    'post',
    'multipart/form-data',
    '_top',
    ['disableUnsavedChangesWarning' => true, 'noCSRFToken' => true]
); ?>
                ...
                <tr style="vertical-align: top;">
                    ...
                    <td class="caSummaryDownloadOptionsPanelAlertControl">
                        ...
                        print _t(
                            ...
                            caHTMLSelect(
                                'template',
                                array_flip($this->getVar('formats')),
                                [],
            ...
            <table>
                <tr>
                    <td align="right"><?php print caJSButton(
                            ...
                            array('onclick' => 'caExecuteSummaryDownload(); return false;'),
                            array()
                        ); ?></td>
