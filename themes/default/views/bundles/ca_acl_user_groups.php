...
<?php
	if (!$read_only) {
?>	
		<div class='button labelInfo caAddItemButton'><a href='#'><?= caNavIcon(__CA_NAV_ICON_ADD__, '15px'); ?> <?= $add_label ? $add_label : _t("Add  group access"); ?></a></div>
<?php
	}
?>
	</div>
...
<script type="text/javascript">
	jQuery(document).ready(function() {
		caUI.initRelationBundle('#<?= $id_prefix.$t_item->tableNum().'_rel'; ?>', {
			...
			autocompleteUrl: '<?= caNavUrl($this->request, 'lookup', 'UserGroup', 'Get', []); ?>'
		});
	});
</script>
