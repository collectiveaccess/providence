...
$vs_display_template = caGetOption(
    'displayTemplate',
    $va_settings,
...
$vn_num_components = ($qr_components = $t_subject->getComponents(
    ...
    <div class="bundleContainer">
        <div class="caItemList">
            <div class="labelInfo">
                ...
                ?>
                <div
                    class='button labelInfo caAddItemButton'><?php print '<a href="#" onclick=\'caObjectComponentPanel.showPanel("' . caNavUrl(
                            $this->request,
                            '*',
                            'ObjectComponent',
                            'Form',
                            array('parent_id' => $t_subject->getPrimaryKey())
