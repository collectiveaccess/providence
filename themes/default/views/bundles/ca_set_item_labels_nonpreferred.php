...
$vb_read_only = ( ( isset( $va_settings['readonly'] ) && $va_settings['readonly'] )
                  || ( $this->request->user->getBundleAccessLevel( 'ca_set_items', 'nonpreferred_labels' )
	...
	<textarea class='caLabelTemplate' style='display: none;'>
		<div id="{fieldNamePrefix}Label_{n}" class="labelInfo">
			...
			<?php print $t_label->htmlFormElement( 'name', "^ELEMENT", array_merge( $va_settings, array(
				'caption'         => "{fieldNamePrefix}caption_{n}",
				'id'              => "{fieldNamePrefix}caption_{n}",
				"value"           => "{{caption}}",
				'no_tooltips'     => true,
...
<script type="text/javascript">
	caUI.initLabelBundle('#<?php print $vs_id_prefix; ?>NPLabels', {
		...
		bundlePreview: <?php $va_cur
			= current( $va_initial_values ); print caEscapeForBundlePreview( $va_cur['caption'] ); ?>,
