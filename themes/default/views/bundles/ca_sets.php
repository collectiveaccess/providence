...
$vb_read_only     = ( ( isset( $va_settings['readonly'] ) && $va_settings['readonly'] )
                      || ( $this->request->user->getBundleAccessLevel( $t_instance->tableName(), 'ca_sets' )
...
<?php
print caGetRelationDisplayString( $this->request, 'ca_sets',
	array( 'class' => 'caEditItemButton', 'id' => "{$vs_id_prefix}_edit_related_{n}" ),
	array( 'display' => '_display', 'makeLink' => true, 'relationshipTypeDisplayPosition' => 'none' ) );
?>
			</span>
			...
			<table class="caListItem">
				<tr>
					...
					<td>
						...
						<a href="<?php print urldecode( caEditorUrl( $this->request, 'ca_sets', '{set_id}' ) ); ?>"
...
<script type="text/javascript">
	...
	jQuery(document).ready(function () {
		...
		caRelationBundle<?php print $vs_id_prefix; ?> = caUI.initRelationBundle('#<?php print $vs_id_prefix; ?>', {
			...
			quickaddUrl: '<?php print caNavUrl( $this->request, 'manage/sets', 'SetQuickAdd', 'Form', array(
				'set_id'                                    => 0,
