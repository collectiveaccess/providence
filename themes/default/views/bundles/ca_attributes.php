...
<?php
		...
		print "<a href='#' onclick='{$vs_id_prefix}Print(); return false;'>".caNavIcon(__CA_NAV_BUTTON_PDF__, 1)."</a>";
?>
	</div>
<?php
	}
...
<?php
		...
		print "<a href='#' onclick='{$vs_id_prefix}Print({n}); return false;'>".caNavIcon(__CA_NAV_BUTTON_PDF__, 1)."</a>";
?>
	</div>
<?php
	}
...
?>
		<div class='button labelInfo caAddItemButton'><a href='#'><?php print caNavIcon(__CA_NAV_BUTTON_ADD__, 1); ?> <?php print $vs_add_label; ?></a></div>
<?php
	}
?>
	</div>
