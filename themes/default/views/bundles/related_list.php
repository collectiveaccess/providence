...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        jQuery.get('<?php print caNavUrl(
            ...
            'RelatedList',
            'Index',
            $va_additional_search_controller_params
...
?>
					...
					<td>
						...
						<a href="<?php print urldecode(
                            caEditorUrl($this->request, $t_item->tableName(), '{' . $t_item->primaryKey() . '}')
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        initiRelationBundleOptions<?php print $vs_id_prefix; ?> = {
            ...
            autocompleteUrl: '<?php print $vs_navurl = caNavUrl(
                $this->request,
                'lookup',
                ucfirst($t_item->getProperty('NAME_SINGULAR')),
                'Get',
                $va_lookup_params
            ); ?>',
            ...
            quickaddUrl: '<?php print caEditorUrl(
                $this->request,
                $t_item->tableName(),
                null,
                false,
