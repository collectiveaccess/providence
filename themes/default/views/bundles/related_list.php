...
$vb_read_only     = ( ( isset( $va_settings['readonly'] ) && $va_settings['readonly'] )
                      || ( $this->request->user->getBundleAccessLevel( $t_instance->tableName(), $vs_bundle_name )
...
<script type="text/javascript">
	function caAsyncSearchResultForm<?php print $vs_id_prefix; ?>(data) {
		...
		caRelationBundle<?php print $vs_id_prefix; ?> = caUI.initRelationBundle('#<?php print $vs_id_prefix
		                                                                                      . $t_item->tableNum()
		                                                                                      . '_rel'; ?>', initiRelationBundleOptions<?php print $vs_id_prefix; ?>);
	...
	jQuery(document).ready(function () {
		jQuery.post('<?php print caNavUrl( $this->request, 'find', 'RelatedList', 'Index',
			[] ); ?>', <?php print json_encode( $va_additional_search_controller_params ); ?>, caAsyncSearchResultForm<?php print $vs_id_prefix; ?>);
	});
	<?php
	}
	?>
</script>
<div id="<?php print $vs_id_prefix . $t_item->tableNum() . '_rel'; ?>" <?php print $vb_batch
	? "class='editorBatchBundleContent'" : ''; ?>>
...
?>
					...
					<td>
						...
						<a href="<?php print urldecode( caEditorUrl( $this->request, $t_item->tableName(),
							'{' . $t_item->primaryKey() . '}' ) ); ?>" class="caEditItemButton"
...
<div id="caRelationEditorPanel<?php print $vs_id_prefix; ?>" class="caRelationQuickAddPanel">
	...
	<textarea class='caBundleDisplayTemplate' style='display: none;'>
		<?php print caGetRelationDisplayString( $this->request, $t_item->tableName(), array(),
...
<script type="text/javascript">
	...
	jQuery(document).ready(function () {
		...
		initiRelationBundleOptions<?php print $vs_id_prefix; ?> = {
			...
			autocompleteUrl: '<?php print $vs_navurl = caNavUrl( $this->request, 'lookup',
				ucfirst( str_replace( " ", "", ucwords( $t_item->getProperty( 'NAME_SINGULAR' ), ' ' ) ) ), 'Get',
				$va_lookup_params ); ?>',
			...
			quickaddUrl: '<?php print caEditorUrl( $this->request, $t_item->tableName(), null, false, null,
				array( 'quick_add' => true ) ); ?>',
