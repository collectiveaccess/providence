				...
				<tr>
					<td width="200">
						<div class="formLabel" id="{fieldNamePrefix}edit_name_{n}" style="display: none;">
							<?php print _t("Name") . "<br/>" . caHTMLTextInput(
					...
					<td class="listtableEditDelete"><div style="float:right;">
							...
							<a href="#" class="caDeleteScreenButton"><?php print caNavIcon(
...
?>
    ...
    <div class="bundleContainer">
        ...
        <div class='button labelInfo caAddItemButton'><a href='#'><?php print caNavIcon(
                    __CA_NAV_ICON_ADD__,
                    '15px'
                ); ?> <?php print _t("Add screen"); ?> &rsaquo;</a></div>
    </div>
</div>
...
<script type="text/javascript">
    caUI.initBundle('#<?php print $vs_id_prefix; ?>', {
        ...
        initialValueOrder: <?php print json_encode(
            is_array($va_initial_values) ? array_keys($va_initial_values) : null
        ); ?>,
