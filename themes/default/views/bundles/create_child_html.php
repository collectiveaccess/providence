						...
						<div id="caTypeChangePanelControlButtons">
							<table>
								<tr>
									...
									<td align="left"><?php print caJSButton($this->request, __CA_NAV_ICON_CANCEL__, _t('Cancel'), 'caChangeTypeFormCancelButton', array('onclick' => 'caCreateChildPanel.hidePanel(); return false;'), array()); ?></td>
								</tr>
							</table>
						</div>
				</form>
