...
<div class="bundleContainer" id="<?php print $vs_id_prefix; ?>">
	<div class="caItemList">
		<div class="labelInfo">
			...
			print $t_subject->htmlFormElement( 'circulation_status_id', null,
				[ 'name' => $vs_placement_code . $vs_id_prefix . 'ca_object_circulation_status' ] );
			print "</div>";
				...
				switch ( $vn_status = $va_checkout_status['status'] ) {
					...
					case __CA_OBJECTS_CHECKOUT_STATUS_RESERVED__:
						...
						if ( in_array( $vn_status, array(
							...
							print _t( '<strong>Borrowed by:</strong> %1 on %2', $va_checkout_status['user_name'],
									$va_checkout_status['checkout_date'] ) . "<br/>\n";
							...
							if ( $va_checkout_status['checkout_notes'] ) {
								print _t( '<strong>Notes:</strong> %1', $va_checkout_status['checkout_notes'] )
								      . "<br/>\n";
							}
						}
						if ( in_array( $vn_status, array(
