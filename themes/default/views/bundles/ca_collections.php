...
$vb_read_only     = ( ( isset( $va_settings['readonly'] ) && $va_settings['readonly'] )
                      || ( $this->request->user->getBundleAccessLevel( $t_instance->tableName(), 'ca_collections' )
...
<div id="<?php print $vs_id_prefix; ?>" <?php print $vb_batch ? "class='editorBatchBundleContent'" : ''; ?>>
	...
	if ( sizeof( $this->getVar( 'initialValues' ) ) && ! $vb_read_only && ! $vs_sort
		...
		print caEditorBundleSortControls( $this->request, $vs_id_prefix, $t_item->tableName(),
			array_merge( [ 'includeInterstitialSortsFor' => $t_subject->tableName() ], $va_settings ) );
	}
...
<?php
print caGetRelationDisplayString( $this->request, 'ca_collections',
			...
			<table class="caListItem">
				<tr>
					...
					<td>
						...
						<a href="<?php print urldecode( caEditorUrl( $this->request, 'ca_collections',
							'{collection_id}' ) ); ?>" class="caEditItemButton"
...
<div id="caRelationEditorPanel<?php print $vs_id_prefix; ?>" class="caRelationQuickAddPanel">
	...
	<textarea class='caBundleDisplayTemplate' style='display: none;'>
		<?php print caGetRelationDisplayString( $this->request, 'ca_collections', array(),
