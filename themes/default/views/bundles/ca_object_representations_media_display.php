...
?>						
						<div style="float:right;">
							<?php print urldecode(caNavButton($this->request, __CA_NAV_BUTTON_DOWNLOAD__, 'Download', 'editor/objects', 'ObjectEditor', 'DownloadRepresentation', array('version' => 'original', 'representation_id' => $t_subject->getPrimaryKey(), 'download' => 1), array('id' => "{$vs_id_prefix}_download"), array('no_background' => true, 'dont_show_content' => true))); ?>
						</div>
<?php
	}
?>
