...
<div id="<?php print $vs_id_prefix . $t_item->tableNum(
    ...
    if (is_array($this->getVar('initialValues')) && sizeof(
            $this->getVar('initialValues')
		...
		<div id="<?php print $vs_id_prefix; ?>Item_{n}" class="labelInfo caRelatedItem">
			<table class="caListItem">
				<tr>
					...
					<td>
<?php
if (is_array($this->getVar('relationship_types_by_sub_type')) && sizeof(
        $this->getVar('relationship_types_by_sub_type')
    )) {
    ?>
...
?>
					...
					<td>
						...
						<a href="<?php print urldecode(caEditorUrl($this->request, 'ca_objects', '{object_id}')); ?>"
...
<div id="caRelationEditorPanel<?php print $vs_id_prefix; ?>" class="caRelationQuickAddPanel">
    ...
    <textarea class='caBundleDisplayTemplate' style='display: none;'>
		<?php print caGetRelationDisplayString(
            $this->request,
            'ca_objects',
            array(),
