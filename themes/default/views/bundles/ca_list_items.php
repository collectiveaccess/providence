...
<?php
if ($vs_checklist = ca_lists::getListAsHTMLFormElement(
    null,
    $vs_id_prefix . "_id{n}",
    null,
    array(
        'render' => 'checklist',
        'limitToItemsRelatedToCollections' => $t_instance->get(
...
if (isset($va_settings['restrictToTermsOnCollectionUseRelationshipType']) && is_array(
        $va_settings['restrictToTermsOnCollectionUseRelationshipType']
    )) {
    ?>
                        ...
                        jQuery('#<?php print $vs_id_prefix; ?>_hierarchyBrowserSearch{n}').autocomplete(
                            {
                                source: '<?php print caNavUrl(
                                    ...
                                    array(
                                        ...
                                        'lists' => is_array(
                                            $va_settings['restrict_to_lists']
                                        ) ? join(';', $va_settings['restrict_to_lists']) : ""
                                    )
                                ); ?>',
