...
<?php
	...
	if ($show_move) {
		...
		$msg = $is_new ? _t('Search for or click on a record to serve as enclosure.') : ($batch ? _t('Search for or click on a record to move items in the current record set under.') : _t('Click on an arrow to choose the location to move this record under.', $t_subject->getProperty('NAME_SINGULAR')));
?>
