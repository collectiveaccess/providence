...
$vb_read_only = ( ( isset( $va_settings['readonly'] ) && $va_settings['readonly'] )
                  || ( $this->request->user->getBundleAccessLevel( 'ca_objects', 'preferred_labels' )
...
<div id="<?php print $vs_id_prefix; ?>Labels" <?php print $vb_batch ? "class='editorBatchBundleContent'" : ''; ?>>
	...
	<textarea class='caLabelTemplate' style='display: none;'>
		<div id="{fieldNamePrefix}Label_{n}" class="labelInfo">
			<div style="float: right;">
				<a href="#" class="caDeleteLabelButton"><?php print caNavIcon( __CA_NAV_ICON_DEL_BUNDLE__, 1, null,
						null, array( 'graphicsPath' => $this->getVar( 'graphicsPath' ) ) ); ?></a>
			</div>
			
			<?php print $t_label->htmlFormElement( 'name', "^ELEMENT", array_merge( $va_settings, array(
				'request'         => $this->request,
				'name'            => "{fieldNamePrefix}name_{n}",
			...
			<br/>
			<?php print '<div class="formLabel">' . $t_label->htmlFormElement( 'locale_id', "^LABEL ^ELEMENT", array(
			...
			<?php print $t_label->htmlFormElement( 'type_id', "^LABEL ^ELEMENT", array(
					...
					"value"                     => "{type_id}",
					'no_tooltips'               => true,
					'list_code'                 => $this->request->config->get( 'ca_objects_preferred_label_type_list' ),
					'dont_show_null_value'      => true,
	...
	<div class="bundleContainer">
		...
		<div class="button labelInfo caAddLabelButton"><a href='#'><?php print caNavIcon( __CA_NAV_ICON_ADD__, '15px',
					null, null,
					array( 'graphicsPath' => $this->getVar( 'graphicsPath' ) ) ); ?><?php print $vs_add_label
					? $vs_add_label : _t( "Add label" ); ?></a></div>
	</div>
