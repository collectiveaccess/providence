...
?>
	<textarea class='caLabelTemplate' style='display: none;'>
		<div id="{fieldNamePrefix}Label_{n}" class="labelInfo">
			<div style="float: right;">
				<a href="#" class="caDeleteLabelButton"><?php print caNavIcon(__CA_NAV_BUTTON_DEL_BUNDLE__, 1, null, null, array('graphicsPath' => $this->getVar('graphicsPath'))); ?></a>
			</div>
	...
	<div class="bundleContainer">
		...
		<div class="button labelInfo caAddLabelButton"><a href='#'><?php print caNavIcon(__CA_NAV_BUTTON_ADD__, 1, null, null, array('graphicsPath' => $this->getVar('graphicsPath'))); ?> <?php print $vs_add_label ? $vs_add_label : _t("Add label"); ?></a></div>
	</div>
