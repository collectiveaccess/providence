...
<?php if($vb_quick_add_enabled) { ?>
			...
			quickaddUrl: '<?= caNavUrl($this->request, 'editor/occurrences', 'OccurrenceQuickAdd', 'Form', array('occurrence_id' => 0, 'dont_include_subtypes_in_type_restriction' => (int)($va_settings['dont_include_subtypes_in_type_restriction'] ?? 0), 'prepopulate_fields' => join(";", $va_settings['prepopulateQuickaddFields'] ?? []))); ?>',
<?php } ?>
