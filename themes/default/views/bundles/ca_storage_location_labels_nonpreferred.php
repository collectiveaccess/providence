...
$vb_read_only = ( ( isset( $va_settings['readonly'] ) && $va_settings['readonly'] )
                  || ( $this->request->user->getBundleAccessLevel( 'ca_storage_locations', 'nonpreferred_labels' )
	...
	<textarea class='caLabelTemplate' style='display: none;'>
		<div id="{fieldNamePrefix}Label_{n}" class="labelInfo">
			...
			<?php print ( $vs_label_list
				= $this->request->config->get( 'ca_storage_locations_nonpreferred_label_type_list' ) )
