...
?>
			<div class="caListItem">
				...
				<?php print urlDecode(caNavLink($this->request, caNavIcon(__CA_NAV_BUTTON_DOWNLOAD__, 1,  null, array('align' => 'top')), '', '*', '*', 'downloadCaptionFile', array('representation_id' => $t_instance->getPrimaryKey(), 'caption_id' => "{caption_id}", 'download' => 1), array('id' => "{$vs_id_prefix}download{caption_id}", 'class' => 'attributeDownloadButton'))); ?>
...
<?php
	if (!$vb_read_only) {
?>	
		<div class='button labelInfo caAddItemButton'><a href='#'><?php print caNavIcon(__CA_NAV_BUTTON_ADD__, 1); ?> <?php print $vs_add_label ? $vs_add_label : _t("Add caption file"); ?></a></div>
<?php
	}
?>
	</div>
