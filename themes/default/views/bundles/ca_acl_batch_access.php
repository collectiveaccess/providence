<?php
/* ----------------------------------------------------------------------
 * bundles/ca_acl_batch_access.php : 
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
?>
		<p>
			<?= ($stats['inheritingAccessRelatedObjectCount'] === 1) ? 
				_t('%1 %2 (out of %4 total) are inheriting public access settings from %3', $stats['inheritingAccessRelatedObjectCount'], Datamodel::getTableProperty('ca_objects', 'NAME_SINGULAR'), $t_instance->getProperty('NAME_PLURAL'), $stats['potentialInheritingAccessRelatedObjectCount']) 
				: 
				_t('%1 %2 (out of %4 total) are inheriting public access settings from %3', $stats['inheritingAccessRelatedObjectCount'], Datamodel::getTableProperty('ca_objects', 'NAME_PLURAL'), $t_instance->getProperty('NAME_PLURAL'), $stats['potentialInheritingAccessRelatedObjectCount'])  
			?>
<?php
			if(
