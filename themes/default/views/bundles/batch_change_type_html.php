...
<div id="caTypeChangePanel" class="caTypeChangePanel">
	...
	<div id="caTypeChangePanelContentArea">
		<?php print caFormTag( $this->request, 'ChangeType', 'caChangeTypeForm', null, $ps_method = 'post',
			'multipart/form-data', '_top', array() ); ?>
		...
		<p><?php print _t( 'Change type from <em>%1</em> to %2', $t_item->getTypeName(),
				$t_item->getTypeListAsHTMLFormElement( 'new_type_id', array( 'id' => 'caChangeTypeFormTypeID' ), array(
