...
$read_only		=	((isset($settings['readonly']) && $settings['readonly'])  || ($this->request->user->getBundleAccessLevel('ca_search_forms', 'preferred_labels') == __CA_BUNDLE_ACCESS_READONLY__));
...
<script type="text/javascript">
	caUI.initLabelBundle('#<?= $id_prefix; ?>Labels', {
		...
		bundlePreview: <?php $cur = current($initial_values); print caEscapeForBundlePreview(is_array($cur) ? $cur['name'] : ''); ?>,
