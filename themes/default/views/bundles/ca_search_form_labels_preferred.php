 ...
 */
	...
	$vb_read_only		=	((isset($settings['readonly']) && $settings['readonly'])  || ($this->request->user->getBundleAccessLevel('ca_search_forms', 'preferred_labels') == __CA_BUNDLE_ACCESS_READONLY__));
...
<script type="text/javascript">
	caUI.initLabelBundle('#<?= $vs_id_prefix; ?>Labels', {
		...
		bundlePreview: <?php $va_cur = current($va_initial_values); print caEscapeForBundlePreview(is_array($va_cur) ? $va_cur['name'] : ''); ?>,
