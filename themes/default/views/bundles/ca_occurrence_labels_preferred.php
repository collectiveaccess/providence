...
$vb_read_only = ( ( isset( $va_settings['readonly'] ) && $va_settings['readonly'] )
                  || ( $this->request->user->getBundleAccessLevel( 'ca_occurrences', 'preferred_labels' )
...
<div id="<?php print $vs_id_prefix; ?>Labels" <?php print $vb_batch ? "class='editorBatchBundleContent'" : ''; ?>>
	...
	<textarea class='caLabelTemplate' style='display: none;'>
		<div id="{fieldNamePrefix}Label_{n}" class="labelInfo">
			...
			<?php print $t_label->htmlFormElement( 'type_id', "^LABEL ^ELEMENT", array(
					...
					"value"                     => "{type_id}",
					'no_tooltips'               => true,
					'list_code'                 => $this->request->config->get( 'ca_occurrences_preferred_label_type_list' ),
					'dont_show_null_value'      => true,
	...
	<div class="bundleContainer">
		...
		<div class='button labelInfo caAddLabelButton' style="margin-left: 10px;"><a
				href='#'><?php print caNavIcon( __CA_NAV_ICON_ADD__, '15px' ); ?><?php print $vs_add_label
