    ...
    <div class="bundleContainer">
        <div class="caItemList">
            <div class="labelInfo">
                ...
                ?>
                <?php print $t_trigger->htmlFormElement(
                    'trigger_type',
                    null,
                    [
                        'name' => $vs_id_prefix . '_trigger_type',
                        'id' => $vs_id_prefix . 'triggerTypeSelect'
                    ]
                ); ?>
...
<script type="text/javascript">
    function caSetTriggerSettingsForm(opts) {
        ...
        jQuery("#<?php print $vs_id_prefix; ?>triggerTypeSettingsForm").load('<?php print caNavUrl(
            $this->request,
            'manage/metadata_alert_rules',
            'MetadataAlertRuleEditor',
            'getTriggerTypeSettingsForm'
        ); ?>', opts);
    }
