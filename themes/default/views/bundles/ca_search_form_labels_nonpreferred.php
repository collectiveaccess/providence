 ...
 */
	...
	$vb_read_only		= ((isset($settings['readonly']) && $settings['readonly'])  || ($this->request->user->getBundleAccessLevel('ca_search_forms', 'nonpreferred_labels') == __CA_BUNDLE_ACCESS_READONLY__));
