...
<div class="sectionBox">
    ...
    <div class='globalAccess'>
        ...
        <div id='editGlobalAccessLink' class='editLink'><a href='#'
                                                           onclick='jQuery("#editGlobalAccess").show(250); jQuery("#editGlobalAccessLink").hide()'><?php print caNavIcon(
                    __CA_NAV_ICON_EDIT__,
                    2
                ); ?><?php print _t('Edit Global Access'); ?></a></div>
    ...
    <div class='globalAccess'>
        ...
        if (($t_instance->getACLUserGroups()) || ($t_instance->getACLUsers())) {
            print "<p>" . _t(
                    'The following groups and users have special access or restrictions for this record'
                ) . ".</p>";
        } else {
        ...
        foreach ($va_group_access as $va_group_access_item) {
            print "<div><span class='accessName'>" . ucwords(
                    $va_group_access_item['name']
        ...
        if (($t_instance->getACLUserGroups()) || ($t_instance->getACLUsers())) {
            ...
            <div id='editUserAccessLink' class='editLink'><a href='#'
                                                             onclick='jQuery("#editUserAccess").show(250); jQuery("#editUserAccessLink").hide()'><?php print caNavIcon(
                        __CA_NAV_ICON_EDIT__,
                        2
                    ); ?><?php print _t('Edit Exceptions'); ?></a></div>
            <?php
        } else {
            ?>
            <div id='editUserAccessLink' class='editLink'><a href='#'
                        ...
                        __CA_NAV_ICON_EDIT__,
                        2
                    ); ?><?php print _t('Create an Exception'); ?></a></div>
            <?php
        }
        ?>
        <div style='width:100%; clear:both; height: 1px;'></div>
    ...
    if ($t_instance->hasField('acl_inherit_from_ca_collections')) {
        print $t_instance->getBundleFormHTML(
            'acl_inherit_from_ca_collections',
            '',
            array('forACLAccessScreen' => true),
