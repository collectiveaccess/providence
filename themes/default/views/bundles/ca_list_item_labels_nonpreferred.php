						...
						<table>
							...
							<tr>
								<td>
                                    ...
                                    <?php print ($vs_label_list = $this->request->config->get(
                                        'ca_list_items_nonpreferred_label_type_list'
                                    )) ? $t_label->htmlFormElement(
                                            'type_id',
                                            "^LABEL ^ELEMENT",
                                            array(
                                                'classname' => 'labelType',
...
<script type="text/javascript">
    caUI.initLabelBundle('#<?php print $vs_id_prefix; ?>NPLabels', {
        ...
        bundlePreview: <?php $va_cur = current($va_initial_values); print caEscapeForBundlePreview(
            $va_cur['name_plural']
        ); ?>,
