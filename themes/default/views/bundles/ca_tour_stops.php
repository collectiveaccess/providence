...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		caRelationBundle<?= $vs_id_prefix; ?> = caUI.initRelationBundle('#<?= $vs_id_prefix; ?>', {
			...
			quickaddUrl: '<?= caNavUrl($this->request, 'editor/tour_stops', 'TourStopQuickAdd', 'Form', array('stop_id' => 0, 'dont_include_subtypes_in_type_restriction' => (int)($va_settings['dont_include_subtypes_in_type_restriction'] ?? 0))); ?>',
