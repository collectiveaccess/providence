...
$vb_read_only     = ( ( isset( $va_settings['readonly'] ) && $va_settings['readonly'] )
                      || ( $this->request->user->getBundleAccessLevel( $t_instance->tableName(), 'ca_tour_stops' )
...
<?php
print caGetRelationDisplayString( $this->request, 'ca_tour_stops',
			...
			<table class="caListItem">
				<tr>
					...
					<td>
						...
						<a href="<?php print urldecode( caEditorUrl( $this->request, 'ca_tour_stops',
							'{stop_id}' ) ); ?>" class="caEditItemButton"
...
<div id="caRelationEditorPanel<?php print $vs_id_prefix; ?>" class="caRelationQuickAddPanel">
	...
	<textarea class='caBundleDisplayTemplate' style='display: none;'>
		<?php print caGetRelationDisplayString( $this->request, 'ca_tour_stops', array(),
...
<script type="text/javascript">
	...
	jQuery(document).ready(function () {
		...
		caRelationBundle<?php print $vs_id_prefix; ?> = caUI.initRelationBundle('#<?php print $vs_id_prefix; ?>', {
			...
			autocompleteUrl: '<?php print caNavUrl( $this->request, 'lookup', 'TourStop', 'Get',
				$va_lookup_params ); ?>',
			...
			quickaddUrl: '<?php print caNavUrl( $this->request, 'editor/tour_stops', 'TourStopQuickAdd', 'Form', array(
				'stop_id'                                   => 0,
