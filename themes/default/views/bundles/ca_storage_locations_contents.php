...
print caEditorBundleShowHideControl(
    $this->request,
    $vs_id_prefix . $t_subject->tableNum() . '_rel',
    $va_settings,
    ...
    <div class="bundleContainer">
        <div class="caItemList">
            ...
            while ($qr_result->nextHit()) {
                ?>
                <div
                    class="labelInfo listRel caRelatedItem" <?php print $vs_color ? "style=\"background-color: #{$vs_color};\"" : ""; ?>>
                    <?php
        ...
        default:
            while ($qr_result->nextHit()) {
                ?>
                <div
                    class="labelInfo roundedRel caRelatedItem" <?php print $vs_color ? "style=\"background-color: #{$vs_color};\"" : ""; ?>>
                    <?php
                    print $qr_result->getWithTemplate($va_settings['displayTemplate']);
                    ?>
                </div>
            ...
            <div class="labelInfo">
                <table>
                    <tr>
                        <td><?php print _t('Location is empty'); ?></td>
                    </tr>
                </table>
            </div>
            <?php
