...
$vb_read_only		= ((isset($settings['readonly']) && $settings['readonly'])  || ($this->request->user->getBundleAccessLevel('ca_editor_uis', 'preferred_labels') == __CA_BUNDLE_ACCESS_READONLY__));
