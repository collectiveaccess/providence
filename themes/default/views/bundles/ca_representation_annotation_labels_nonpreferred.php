...
$vb_read_only = ( ( isset( $va_settings['readonly'] ) && $va_settings['readonly'] )
                  || ( $this->request->user->getBundleAccessLevel( 'ca_representation_annotations',
			'nonpreferred_labels' ) == __CA_BUNDLE_ACCESS_READONLY__ ) );
	...
	<textarea class='caLabelTemplate' style='display: none;'>
		<div id="{fieldNamePrefix}Label_{n}" class="labelInfo">
			...
			<?php print ( $vs_label_list
				= $this->request->config->get( 'ca_representation_annotations_nonpreferred_label_type_list' ) )
