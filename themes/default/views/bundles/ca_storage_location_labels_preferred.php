...
$vb_read_only = ( ( isset( $va_settings['readonly'] ) && $va_settings['readonly'] )
                  || ( $this->request->user->getBundleAccessLevel( 'ca_storage_locations', 'preferred_labels' )
	...
	<textarea class='caLabelTemplate' style='display: none;'>
		<div id="{fieldNamePrefix}Label_{n}" class="labelInfo">
			...
			<?php print $t_label->htmlFormElement( 'type_id', "^LABEL ^ELEMENT", array(
					...
					"value"                     => "{type_id}",
					'no_tooltips'               => true,
					'list_code'                 => $this->request->config->get( 'ca_storage_locations_preferred_label_type_list' ),
					'dont_show_null_value'      => true,
