		...
		<form id="<?php print "caWidgetSettings_{$vs_widget_id}"; ?>" action="#" method="get">
			...
			if ( $vs_form = $this->getVar( 'form' ) ) {
				...
				print caJSButton(
					      ...
					      array(
						      'onclick' => 'jQuery("#caWidgetSettingForm_' . $vs_widget_id . '").load("'
						                   . caNavUrl( $this->request, '', 'Dashboard', 'saveSettings', array() )
			...
			print caJSButton(
				...
				array(
					'onclick' => 'jQuery("#caWidgetSettingForm_' . $vs_widget_id . '").load("'
					             . caNavUrl( $this->request, '', 'Dashboard', 'getWidget', array() )
					             . '", jQuery("#caWidgetSettings_' . $vs_widget_id . '").serializeArray());',
					array()
				)
			);
