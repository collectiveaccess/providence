...
foreach ($va_widget_list as $vs_widget_name) {
    ...
    print "<a href='#' onclick='jQuery(\"#caWidgetManagerFormWidgetValue\").val(\"{$vs_widget_name}\"); jQuery(\"#caWidgetManagerForm\").submit();'>" . caNavIcon(
            __CA_NAV_ICON_ADD_WIDGET__,
            1
        ) . "  " . $o_widget_manager->getWidgetTitle($vs_widget_name) . "</a><br/>\n";
