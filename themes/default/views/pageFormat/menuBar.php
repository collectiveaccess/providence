...
<?php
						...
						print caFormSubmitLink($this->request, caNavIcon(__CA_NAV_BUTTON_SEARCH__, 1, array('style' => 'float: right; margin: 5px 3px 0 0; color: #777')), 'caQuickSearchFormSubmit', 'caQuickSearchForm'); 
?>
