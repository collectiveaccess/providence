...
?>
						<input type="text" name="search" length="15" id="caQuickSearchFormText" value="<?= htmlspecialchars(Session::getVar('quick_search_last_search'), ENT_QUOTES | ENT_HTML5, 'UTF-8'); ?>" onfocus="this.value='';" aria-label="<?= htmlspecialchars(_t('Quick search text')); ?>"/>
<?php						
						} else {
?>
						<input type="text" name="search" length="15" id="caQuickSearchFormText" value="<?= htmlspecialchars(Session::getVar('quick_search_last_search'), ENT_QUOTES | ENT_HTML5, 'UTF-8'); ?>" aria-label="<?= htmlspecialchars(_t('Quick search text')); ?>"/>	
<?php
						}
