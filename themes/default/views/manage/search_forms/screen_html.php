...
<?php
		print $vs_control_box = caFormControlBox(
			...
			caNavButton($this->request, __CA_NAV_ICON_CANCEL__, _t("Cancel"), '', 'manage/search_forms', 'SearchFormEditor', 'Edit/'.$this->request->getActionExtra(), array('form_id' => $vn_form_id)), 
			'', 
			(intval($vn_form_id) > 0) ? caNavButton($this->request, __CA_NAV_ICON_DELETE__, _t("Delete"), '', 'manage/search_forms', 'SearchFormEditor', 'Delete/'.$this->request->getActionExtra(), array('form_id' => $vn_form_id)) : ''
		);
