...
<div class="sectionBox">
    ...
    if ($vb_can_edit) {
        print $vs_control_box = caFormControlBox(
            ...
            '',
            ((intval($vn_page_id) > 0) && ($vb_can_delete)) ? caFormNavButton(
                $this->request,
    ...
    print caFormTag(
        $this->request,
        'Save/' . $this->request->getActionExtra() . '/page_id/' . $vn_page_id,
        'SitePageEditorForm',
        null,
        'POST',
        'multipart/form-data'
    ...
    $va_form_elements = $t_page->getBundleFormHTMLForScreen(
