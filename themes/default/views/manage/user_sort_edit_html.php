...
<table>
    <tr>
        ...
        <td><?php print caHTMLSelect(
                'sort_item_1',
                $va_sort_element_list,
                ['style' => 'width: 370px'],
                array('value' => $vs_select_1_val, 'contentArrayUsesKeysForValues' => true)
            ); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php print caHTMLSelect(
                ...
                $va_sort_element_list,
                ['style' => 'width: 370px'],
                array('value' => $vs_select_2_val, 'contentArrayUsesKeysForValues' => true)
            ); ?></td>
    </tr>
    <tr>
        ...
        <td><?php print caHTMLSelect(
                ...
                $va_sort_element_list,
                ['style' => 'width: 370px'],
                array('value' => $vs_select_3_val, 'contentArrayUsesKeysForValues' => true)
            ); ?></td>
    </tr>
</table>
