...
<div id="caTypeChangePanelControlButtons">
	<table>
		<tr>
			<td align="right"><?php print caFormSubmitButton( $this->request, __CA_NAV_ICON_SAVE__, _t( 'Save' ),
					'caUserSortForm' ); ?></td>
			<td align="left"><?php print caJSButton( $this->request, __CA_NAV_ICON_CANCEL__, _t( 'Cancel' ),
					'caChangeTypeFormCancelButton',
					array( 'onclick' => 'caTypeChangePanel.hidePanel(); return false;' ), array() ); ?></td>
		</tr>
	</table>
</div>
...
<table>
	<tr>
		...
		<td><?php print caHTMLSelect( 'sort_item_1', $va_sort_element_list, [ 'style' => 'width: 370px' ],
				array( 'value' => $vs_select_1_val, 'contentArrayUsesKeysForValues' => true ) ); ?></td>
	</tr>

	<tr>
		<td><?php print _t( "Sort field %1", 2 ); ?></td>
		<td><?php print caHTMLSelect( 'sort_item_2', $va_sort_element_list, [ 'style' => 'width: 370px' ],
				array( 'value' => $vs_select_2_val, 'contentArrayUsesKeysForValues' => true ) ); ?></td>
	</tr>
	<tr>
		<td><?php print _t( "Sort field %1", 3 ); ?></td>
		<td><?php print caHTMLSelect( 'sort_item_3', $va_sort_element_list, [ 'style' => 'width: 370px' ],
				array( 'value' => $vs_select_3_val, 'contentArrayUsesKeysForValues' => true ) ); ?></td>
	</tr>
</table>
...
<script type="text/javascript">
	jQuery(document).ready(function () {
		jQuery('select#table_num').change(function () {
			...
			jQuery.getJSON(
				'<?php print caNavUrl( $this->request, 'manage', 'UserSort',
					'GetBundlesForTable' );?>/table_num/' + table_num,
				function (data) {
