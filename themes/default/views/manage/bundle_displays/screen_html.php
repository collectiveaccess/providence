...
<?php
		print $vs_control_box = caFormControlBox(
			...
			caNavButton($this->request, __CA_NAV_ICON_CANCEL__, _t("Cancel"), '', 'manage/bundle_displays', 'BundleDisplayEditor', 'Edit/'.$this->request->getActionExtra(), array('display_id' => $vn_display_id)), 
			'', 
			(intval($vn_display_id) > 0) ? caNavButton($this->request, __CA_NAV_ICON_DELETE__, _t("Delete"), '', 'manage/bundle_displays', 'BundleDisplayEditor', 'Delete/'.$this->request->getActionExtra(), array('display_id' => $vn_display_id)) : ''
		);
