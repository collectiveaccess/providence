...
?>
	<table>
		...
		<tr>
			...
			<td>
				<div><?php print caHTMLCheckboxInput('exportDestinationFile', array('value' => 1)); ?> File download</div>
				<div><?php print caHTMLCheckboxInput('exportDestinationGitHub', array('value' => 0)); ?> GitHub</div>
			</td>
		</tr>
		<tr>
