...
$va_form_elements = $t_set->getBundleFormHTMLForScreen(
...
<div class="sectionBox">
	<?php print caFormTag($this->request, 'Save/'.$this->request->getActionExtra().'/set_id/'.$vn_set_id, 'SetEditorForm', null, 'POST', 'multipart/form-data'); ?>
		<div class="grid">
			<?php print join("\n", $va_form_elements); ?>
