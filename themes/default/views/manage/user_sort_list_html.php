...
<div class="control-box rounded">
    <div style='float:left;margin-top:2px;'>
        <a href='#' onclick="caTypeChangePanel.showPanel('<?php print caNavUrl(
            $this->request,
            'manage',
            'UserSort',
            'Edit'
        ); ?>'); return false;" class='form-button'><span class='form-button'><?php print caNavIcon(
                    __CA_NAV_ICON_ADD__,
                    2,
    ...
    <div style='float:right;'>
        <a href='#' onclick='jQuery("#UserSortsListForm").attr("action", "<?php print caNavUrl(
            $this->request,
            'manage',
            'UserSort',
            'Delete'
        ); ?>").submit();' class='form-button'><span class='form-button delete'
                                                     style='padding-top:5px;'><?php print caNavIcon(
                    ...
                    <tr>
                        ...
                        <td class="listtableEdit">
                            <a href="#" onclick="caTypeChangePanel.showPanel('<?php print caNavUrl(
                                ...
                                'UserSort',
                                'Edit',
                                array('sort_id' => $va_sort['sort_id'])
                            ); ?>'); return false;"><?php print caNavIcon(
