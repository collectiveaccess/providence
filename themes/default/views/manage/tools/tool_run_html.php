...
<script type="text/javascript">
	jQuery(document).ready(function () {
		...
		jQuery.post('<?php print caNavUrl( $this->request, 'manage', 'Tools', 'RunJob', array(
				'tool' => $vs_tool_identifier,
				'command' => $vs_command
			) ); ?>', <?php print json_encode( array( 'job_id' => $vs_job_id, 'settings' => $va_setting_values ) ); ?>,
		...
		updateProgressBarInterval = setInterval(function () {
			jQuery.getJSON('<?php print caNavUrl( $this->request, 'manage', 'Tools', 'GetJobStatus',
				array( 'job_id' => $vs_job_id ) ); ?>', {}, function (data) {
