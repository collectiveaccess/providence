...
<div class="sectionBox">
	...
	print caFormControlBox(
		...
		'',
		caNavHeaderButton( $this->request, __CA_NAV_ICON_ADD__, _t( "New team" ), 'manage', 'groups', 'Edit',
			array( 'group_id' => 0 ) )
	);
	?>
			...
			foreach ( $va_group_list as $va_group ) {
				...
				<tr>
					...
					<td class="listtableEdit">
						<?php print caNavButton( $this->request, __CA_NAV_ICON_EDIT__, _t( "Edit" ), '', 'manage',
							'groups', 'Edit', array( 'group_id' => $va_group['group_id'] ), array(), array(
						...
						<?php print caNavButton( $this->request, __CA_NAV_ICON_DELETE__, _t( "Delete" ), '', 'manage',
							'groups', 'Delete', array( 'group_id' => $va_group['group_id'] ), array(), array(
								'icon_position'     => __CA_NAV_ICON_ICON_POS_LEFT__,
								'use_class'         => 'list-button',
								'no_background'     => true,
								'dont_show_content' => true
