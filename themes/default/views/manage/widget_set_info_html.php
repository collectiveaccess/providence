...
if ( $this->request->user->canDoAction( 'is_administrator' )
     || $this->request->user->canDoAction( 'can_administrate_sets' )
) {
	?>
	...
	<h3 class='setStats'><?php print _t( 'Show %1', $vs_type_name_plural ); ?>:
		<div><?php
			print caFormTag( $this->request, 'ListSets', 'caSetDisplayMode',
			...
			print caHTMLSelect( 'mode', $va_options, array( 'class' => 'searchToolsSelect' ),
					array( 'value' => $this->getVar( 'mode' ), 'width' => '130px' ) ) . "\n";
