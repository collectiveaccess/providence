        ...
        <div style="text-align:right;">
            ...
            <a href='#' onclick='jQuery("#tagListForm").attr("action", "<?php print caNavUrl(
                ...
                'DeleteTags'
                        ...
                        1
                    ); ?><span class='formtext'><?php print _t("Delete"); ?></span></span></a>
        </div>
            ...
            while (($vn_item_count < $vn_items_per_page) && $vo_result->nextHit()) {
                ...
                <tr>
                    <td>
                        <?php print caNavLink(
                            $this->request,
                            $tag = $vo_result->get('ca_item_tags.tag'),
                            '',
                            'find',
                            'QuickSearch',
                            'Index',
                            ['search' => "ca_item_tags.tag:\"{$tag}\""]
                        ); ?>
                    </td>
                    <td>
                        <?php
                        print ca_items_x_tags::find(
                            ['tag_id' => $vo_result->get('ca_item_tags.tag_id')],
                            ['returnAs' => 'count']
                        );
                        ?>
                    </td>
