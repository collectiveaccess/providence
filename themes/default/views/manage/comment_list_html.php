        ...
        <form id="commentListForm"><input type="hidden" name="mode" value="list">
            ...
            <div style="text-align:right;">
                <?php print _t('Batch actions'); ?>: <a href='#'
                                                        onclick='jQuery("#commentListForm").attr("action", "<?php print caNavUrl(
                                                            $this->request,
                                                            'manage',
                                                            'Comments',
                                                            'Approve'
                                                        ); ?>").submit();' class='form-button'><span
                ...
                <a href='#' onclick='jQuery("#commentListForm").attr("action", "<?php print caNavUrl(
                    ...
                    'Comments',
                    'Delete'
                ); ?>").submit();' class='form-button'><span class='form-button approveDelete'><?php print caNavIcon(
                            __CA_NAV_ICON_DELETE__,
                            1
                        ); ?><span class='formtext'>Delete</span></span></a>
            </div>
            <table id="caItemList" class="listtable">
                ...
                foreach ($va_comments_list as $va_comment) {
                    ...
                    <tr>
                        <td>
                            <?php print caEditorLink(
                                $this->request,
                                $va_comment['commented_on'],
                                '',
                                $va_comment['table_num'],
                                $va_comment['row_id']
                            ); ?>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            if (is_array($va_comment['media1']) && (sizeof($va_comment['media1']) > 0)) {
                                ...
                                print caNavButton(
                                    ...
                                    array(),
                                    array('no_background' => true, 'dont_show_content' => true)
                                );
                                print "</span>";
                            }
                            ?>
                        ...
                        <td>
                            <input type="checkbox" name="comment_id[]"
                                   value="<?php print $va_comment['comment_id']; ?>">
                        </td>
                    </tr>
                    <?php
                }
