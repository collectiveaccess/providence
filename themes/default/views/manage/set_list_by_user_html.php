        ...
        <table id="caItemList" class="listtable">
            ...
            if (sizeof($va_set_list)) {
                foreach ($va_set_list as $vn_user_id => $va_user) {
                    ...
                    <tr>
                        <td colspan="8">
                            <strong><?php print $va_user['user']['fname'] . " " . $va_user['user']['lname'] . " (" . $va_user['user']['email'] . ")</strong> [" . (($vn_num_sets_for_user == 1) ? _t(
                                    "%1 set",
                                    $vn_num_sets_for_user
                                ) : _t("%1 sets", $vn_num_sets_for_user)) . "]"; ?></td>
                    </tr>
                    <?php
