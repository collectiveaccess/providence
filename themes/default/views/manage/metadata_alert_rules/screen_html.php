...
<div class="sectionBox">
    ...
    print $vs_control_box = caFormControlBox(
        ...
        '',
        (intval($vn_rule_id) > 0) ? caFormNavButton(
            $this->request,
    ...
    print caFormTag(
        $this->request,
        'Save/' . $this->request->getActionExtra() . '/rule_id/' . $vn_rule_id,
        'MetadataAlertRuleEditorForm',
        null,
        'POST',
        'multipart/form-data'
    );

    $va_form_elements = $t_alert->getBundleFormHTMLForScreen(
