...
$rule_id 		= $this->getVar('subject_id');
$table_num 		= $t_alert->get("table_num"); 

$control_box 	= caEditorFormControls($this, 'MetadataAlertRuleEditorForm');
...
<?php
	print caFormTag($this->request, 'Save/'.$this->request->getActionExtra().'/rule_id/'.$rule_id, 'MetadataAlertRuleEditorForm', null, 'POST', 'multipart/form-data');
