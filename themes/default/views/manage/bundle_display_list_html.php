...
$vs_type_menu = '<div class="sf-small-menu form-header-button rounded">' .
                ...
                '</div>' .
                '<form action="#">' . _t( 'New display for ' ) . ' ' . caHTMLSelect( 'table_num',
...
<script language="JavaScript" type="text/javascript">
	...
	function _navigateToNewForm(table_num) {
		document.location = '<?php print caNavUrl( $this->request, 'manage/bundle_displays', 'BundleDisplayEditor',
			'Edit', array( 'display_id' => 0 ) ); ?>' + '/table_num/' + table_num;
	}
					...
					<td class="listtableEditDelete">
						...
						if ( $this->request->user->canDoAction( 'can_edit_ca_bundle_displays' ) ) {
							...
							<?php print caNavButton( $this->request, __CA_NAV_ICON_EDIT__, _t( "Edit" ), '',
								'manage/bundle_displays', 'BundleDisplayEditor', 'Edit',
								array( 'display_id' => $va_display['display_id'] ), array(), array(
						...
						if ( $this->request->user->canDoAction( 'can_delete_ca_bundle_displays' ) ) {
							...
							<?php print caNavButton( $this->request, __CA_NAV_ICON_DELETE__, _t( "Delete" ), '',
								'manage/bundle_displays', 'BundleDisplayEditor', 'Delete',
								array( 'display_id' => $va_display['display_id'] ), array(), array(
									'icon_position'     => __CA_NAV_ICON_ICON_POS_LEFT__,
									'use_class'         => 'list-button',
									'no_background'     => true,
