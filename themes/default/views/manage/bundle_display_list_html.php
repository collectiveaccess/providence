 ...
 */
	...
	$vs_type_menu = '<div class="sf-small-menu form-header-button rounded">'.
						...
						'<a href="#" class="form-button" onclick="_navigateToNewForm(jQuery(\'#tableList\').val());"><span class="form-button">'.caNavIcon($this->request, __CA_NAV_BUTTON_ADD_LARGE__).'Add</span></a>'.
						'</div>';
?>
