...
<?php if ( is_array( $totals['most_recent'] ) ) { ?>
	<div><?php print _t( "Most recent login at %1 by %2", $totals['most_recent']['last_login'],
			trim( $totals['most_recent']['last_login_user_fname'] . ' '
			      . $totals['most_recent']['last_login_user_lname'] ) . " ("
			. $totals['most_recent']['last_login_user_email'] . ")" ); ?></div>
	<br/>
<?php } ?>
<?php
