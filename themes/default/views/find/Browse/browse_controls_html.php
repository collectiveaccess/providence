...
<?php
						...
						foreach($va_available_facets as $vs_facet_code => $va_facet_info) {
							...
							print "<a href='#' class='facetLink facet{$vs_facet_code}' onclick='caUIBrowsePanel.showBrowsePanel(\"{$vs_facet_code}\"); $(\".facetLink\").removeClass(\"active\"); $(\".facet{$vs_facet_code}\").addClass(\"active\");' ".$vs_style.">".$va_facet_info['label_plural'].caNavIcon(__CA_NAV_BUTTON_ADD__, 1)."</a>";
...
<?php
				...
				if (sizeof($va_facets)) { 
					...
					foreach($va_available_facets as $vs_facet_code => $va_facet_info) {
						...
						print "<div class='facetHeadingLink facet{$vs_facet_code}' ".$vs_style."><a href='#' onclick='caUIBrowsePanel.showBrowsePanel(\"{$vs_facet_code}\"); $(\".facetHeadingLink\").removeClass(\"active\"); $(\".facet{$vs_facet_code}\").addClass(\"active\");'>".$va_facet_info['label_plural'].caNavIcon(__CA_NAV_BUTTON_ADD__, 1)."</a></div>\n";
