...
?>
						<div class="quickSearchResultHeader rounded">
							<div class="quickSearchFullResultsLink"><?php print caNavLink($this->request, caNavIcon(__CA_NAV_BUTTON_FILTER__, 1)." "._t("Full Results &rsaquo;"), null, $va_info['searchModule'], $va_info['searchController'], $va_info['searchAction'], array("search" => urlencode($ps_search), "type_id" => $vn_type_id)); ?></div>
							<a href='#' style="text-decoration:none; color:#333;" id='show<?php print $vs_table.$vn_type_id; ?>' onclick='return caQuickSearchShowHideResults("show", "<?php print $vs_table.$vn_type_id; ?>");'><?php print unicode_ucfirst($va_type_info['name_plural'])." (".sizeof($va_occurrences_by_type[$vn_type_id]).")"; ?> <?php print caNavIcon(__CA_NAV_BUTTON_EXPAND__, 1); ?></a>
							<a href='#' id='hide<?php print $vs_table.$vn_type_id; ?>' style='display:none; text-decoration:none; color:#333;' onclick='return caQuickSearchShowHideResults("hide", "<?php print $vs_table.$vn_type_id; ?>").hide();'><?php print unicode_ucfirst($va_type_info['name_plural'])." (".sizeof($va_occurrences_by_type[$vn_type_id]).")"; ?> <?php print caNavIcon(__CA_NAV_BUTTON_COLLAPSE__, 1); ?></a>
						</div>
...
?>
							...
							<div class="quickSearchResultHide"><a href='#' id='hide<?php print $vs_table.$vn_type_id; ?>' onclick='jQuery("#<?php print $vs_table.$vn_type_id; ?>_results").slideUp(250); jQuery("#show<?php print $vs_table.$vn_type_id; ?>").slideDown(1); jQuery("#hide<?php print $vs_table.$vn_type_id; ?>").hide(); return false;'> <?php print caNavIcon(__CA_NAV_BUTTON_COLLAPSE__, 1); ?></a></div>
						</div>
...
?>
				<div class="quickSearchResultHeader rounded" >
					<div class="quickSearchFullResultsLink"><?php print caNavLink($this->request, caNavIcon(__CA_NAV_BUTTON_FILTER__, 1)." "._t("Full Results &rsaquo;"), null, $va_info['searchModule'], $va_info['searchController'], $va_info['searchAction'], array("search" => urlencode($ps_search))); ?></div>
					<a href='#' style="text-decoration:none; color:#333;" id='show<?php print $vs_table; ?>' onclick='return caQuickSearchShowHideResults("show", "<?php print $vs_table; ?>");'><?php print $va_info['displayname']." (".$o_res->numHits().")"; ?> <?php print caNavIcon(__CA_NAV_BUTTON_EXPAND__, 1); ?></a>
					<a href='#' id='hide<?php print $vs_table; ?>' style='display:none; text-decoration:none; color:#333;' onclick='return caQuickSearchShowHideResults("hide", "<?php print $vs_table; ?>");'><?php print $va_info['displayname']." (".$o_res->numHits().")"; ?> <?php print caNavIcon(__CA_NAV_BUTTON_COLLAPSE__, 1); ?></a>
				</div>
...
<?php
	...
	?>
					...
					<div class="quickSearchResultHide"><a href='#' id='hide<?php print $vs_table; ?>' onclick='jQuery("#<?php print $vs_table; ?>_results").slideUp(250); jQuery("#show<?php print $vs_table; ?>").slideDown(1); jQuery("#hide<?php print $vs_table; ?>").hide(); return false;'> <?php print caNavIcon(__CA_NAV_BUTTON_COLLAPSE__, 1); ?></a></div>
				</div>
<?php	
			} else {
