...
<?php
		...
		while(($item_count < $items_per_page) && ($result->nextHit())) {
			...
			$va_media_info = $result->getMediaInfo('ca_collections.media', 'preview170');
			$va_tmp = $result->getMediaTags('ca_collections.media', 'preview170');
...
<script type="text/javascript">
	jQuery(document).ready(function() { 
		...
		jQuery(".collectionThumbnailsImageContainer").on("mouseleave", function(e) {
			jQuery(".qlButtonContainerThumbnail").css("display", "none");
		});
