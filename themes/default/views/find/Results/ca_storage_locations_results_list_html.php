...
<?php
					print "<td style='width:17%;'>".caEditorLink($this->request, caNavIcon(__CA_NAV_BUTTON_EDIT__, 1), '', 'ca_storage_locations', $vn_location_id, array())."</td>";
					if ($vs_mode == 'search') { 
						print " <a href='#' onclick='caOpenBrowserWith(".$vn_location_id.");'>".caNavIcon(__CA_NAV_BUTTON_HIER__, 1)."</a>";
					}
					print "</td>";		
