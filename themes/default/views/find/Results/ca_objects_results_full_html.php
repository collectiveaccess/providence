...
<?php
		...
		print caNavLink($this->request, array_shift($va_tmp), '', 'editor/objects', 'ObjectEditor', $vs_action, array('object_id' => $vn_object_id), array('onmouseover' => 'jQuery(".qlButtonContainerFull").css("display", "none"); jQuery("#ql_'.$vn_object_id.'").css("display", "block");', 'onmouseout' => 'jQuery(".qlButtonContainerFull").css("display", "none");'));
