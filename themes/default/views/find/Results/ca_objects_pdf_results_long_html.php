...
table, td { border: 1px solid #000000; color: #000000; text-wrap: normal; width: 100px; height: 30px; padding: 5px; font-size: 11px;}
td.odd   { color: #00AA00; }
...
<?php
		...
		foreach($va_display_list as $va_display_item) {
			...
			print "<th class='displayHeader'>".((unicode_strlen($va_display_item['display']) > 20) ? strip_tags(mb_substr($va_display_item['display'], 0, 17))."..." : $va_display_item['display'])."</th>";
			$vn_count++;
