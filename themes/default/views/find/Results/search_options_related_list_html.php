...
<a href='#' class='showOptions' id='showOptions_<?php print $this->getVar( 'interstitialPrefix' ); ?>'
   onclick='return caHandleResultsUIBoxes_<?php print $this->getVar( 'interstitialPrefix' ); ?>("display", "show");'><?php print caNavIcon( __CA_NAV_ICON_SETTINGS__,
		'24px' ); ?></a>
...
if ( $vo_result->numHits() > 0 ) {
	if ( $this->getVar( 'mode' ) === 'search' && ( $this->request->user->canDoAction( 'can_browse_' . $vs_table ) )
		...
		<a href='#' id='showRefine_<?php print $this->getVar( 'interstitialPrefix' ); ?>'
		   onclick='return caHandleResultsUIBoxes_<?php print $this->getVar( 'interstitialPrefix' ); ?>("refine", "show");'><?php print caNavIcon( __CA_NAV_ICON_FILTER__,
				'24px' ); ?></a>
		<?php
	}
	?>
	<a href='#' class='showTools' id='showTools_<?php print $this->getVar( 'interstitialPrefix' ); ?>'
	   onclick='return caHandleResultsUIBoxes_<?php print $this->getVar( 'interstitialPrefix' ); ?>("tools", "show");'><?php print caNavIcon( __CA_NAV_ICON_EXPORT__,
			'24px' ); ?></a>
	<?php
}
?>
...
<div id="searchOptionsBox_<?php print $this->getVar( 'interstitialPrefix' ); ?>" class="relatedListSearchOptionsBox">
	<div class="bg">
		<?php
		print caFormTag( $this->request, 'Index', 'caSearchOptionsForm_' . $this->getVar( 'interstitialPrefix' ), null,
		...
		<a href='#' id='hideOptions_<?php print $this->getVar( 'interstitialPrefix' ); ?>'
		   onclick='return caHandleResultsUIBoxes_<?php print $this->getVar( 'interstitialPrefix' ); ?>("display", "hide"); return false;'><?php print caNavIcon( __CA_NAV_ICON_COLLAPSE__,
				"18px" ); ?></a>
		<a href='#' id='saveOptions_<?php print $this->getVar( 'interstitialPrefix' ); ?>'
		   onclick='jQuery("#caSearchOptionsForm_<?php print $this->getVar( 'interstitialPrefix' ); ?>").submit(); return false;'><?php print caNavIcon( __CA_NAV_ICON_GO__,
				"18px" ); ?></a>
		</form>
