...
<?php
		...
		foreach($va_display_list as $placement_id => $info) {
			if (in_array($info['bundle_name'], array('ca_object_lots.preferred_labels', 'ca_object_lot_labels.name'))) { continue; } 		// skip preferred labels because we always output them above
