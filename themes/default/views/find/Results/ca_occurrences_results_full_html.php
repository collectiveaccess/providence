...
<form id="caFindResultsForm">
    ...
    while (($vn_item_count < $vn_items_per_page) && ($vo_result->nextHit())) {
        ...
        print caEditorLink(
            ...
            array(),
            array(
                'onmouseover' => 'jQuery(".qlButtonContainerFull").css("display", "none"); jQuery("#ql_' . $vn_occurrence_id . '").css("display", "block");',
                'onmouseout' => 'jQuery(".qlButtonContainerFull").css("display", "none");'
            )
        );
        print "<div class='qlButtonContainerFull' id='ql_" . $vn_occurrence_id . "' onmouseover='jQuery(\"#ql_" . $vn_occurrence_id . "\").css(\"display\", \"block\");'><a class='qlButton' onclick='caMediaPanel.showPanel(\"" . caNavUrl(
                $this->request,
                'find',
                'SearchOccurrences',
                'QuickLook',
