...
<div class="caMediaOverlayControls">
	<?php
	print ( $vn_num_items_rendered == 1 ) ? _t( "Displaying %1 of %2 %3", $vn_num_items_rendered, $vn_num_items_total,
		$t_item->getProperty( 'NAME_SINGULAR' ) )
		: _t( "Displaying %1 of %2 %3", $vn_num_items_rendered, $vn_num_items_total,
		$t_item->getProperty( 'NAME_PLURAL' ) );
	?>
