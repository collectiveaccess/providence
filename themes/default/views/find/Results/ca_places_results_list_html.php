...
<?php
					print "<td style='width:5%;'>".caEditorLink($this->request, caNavIcon(__CA_NAV_ICON_EDIT__, 2), '', 'ca_places', $vn_place_id, array())."</td>";
					if ($vs_mode == 'search') { 
						print " <a href='#' onclick='caOpenBrowserWith(".$vn_place_id.");'>".caNavIcon(__CA_NAV_ICON_HIER__, 1)."</a>";
					}
					print "</td>";	
