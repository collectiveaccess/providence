...
if (!$vn_form_id) {
    ...
    <div class="notification-warning-box">
        <ul class='notification-warning-box'>
            <li class='notification-warning-box'><?php print _t(
                        "You must define a search form before you can use the advanced search."
                    ) . ' ' . caNavLink(
                        $this->request,
                        _t('Click here to create a new form.'),
                        '',
                        'manage',
                        'SearchForm',
                        'ListForms'
        ...
        <div class="control-box rounded">
            ...
            <div style="float:right; ">
                <?php print caJSButton(
                    ...
                    _t("Reset"),
                    'AdvancedSearchForm',
                    array('onclick' => 'caAdvancedSearchFormReset()'),
                    array()
                ); ?>
                <?php print caFormSearchButton(
                    $this->request,
            ...
            <div class="saveAs" style="float: right; margin-right:20px;">
                ...
                <a href="#"
                   onclick="caSaveSearch('AdvancedSearchForm', jQuery('#caAdvancedSearchSaveLabelInput').val(), [<?php print join(
                       ',',
                       $va_flds
                   ); ?>]); return false;" class="button"><?php print caNavIcon(__CA_NAV_ICON_GO__, "18px"); ?></a>
            </div>
        </div>
        </form>
        <?php
