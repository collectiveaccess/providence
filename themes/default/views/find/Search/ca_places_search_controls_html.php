        ...
        jQuery(document).ready(function () {
            ...
            jQuery("#browseToggle").click(function () {
                jQuery("#browse").slideToggle(350, function () {
                    ...
                    jQuery("#browseToggle").html((this.style.display == 'block') ? '<?php print '<span class="form-button">' . _t(
                            'Close hierarchy viewer'
            ...
            ) ? 'true' : "!stateCookieJar.get('placeBrowserIsClosed')"); ?>) {
                jQuery("#browseToggle").html('<?php print '<span class="form-button">' . _t(
                        'Close hierarchy viewer'
                    ) . '</span>';?>');
            } else {
                jQuery("#browse").hide();
