...
if ( ! $this->request->isAjax() ) {
	...
	<div class='searchFormSelector' style='float:right;'>
		<form action='#' id='advancedSearchFormContainerFormSelector'><?php print ( $vs_form_list_select )
				? _t( 'Form' ) . ': ' . $vs_form_list_select : ''; ?></form>
	</div>
	...
	<script type='text/javascript'>
		function caLoadAdvancedSearchForm(form_id) {
			jQuery('#advancedSearchFormContainer').load('<?php print caNavUrl( $this->request,
				$this->request->getModulePath(), $this->request->getController(),
				'getAdvancedSearchForm' ); ?>', {form_id: form_id});
		}
