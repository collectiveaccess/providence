...
$vb_show_add_checked_to_set      = (bool) ( is_array( $va_sets = $this->getVar( 'available_editable_sets' ) )
                                            && sizeof( $va_sets )
                                            && $this->request->user->canDoAction( 'can_edit_sets' ) );
...
if ( $vb_show_add_checked_to_set || $vb_show_create_set_from_checked ) {
	...
	<div class='setTools'>
		<a href="#" id='searchSetToolsShow'
		   onclick="$('.setTools').hide(); return caShowSearchSetTools();"><?php print caNavIcon( __CA_NAV_ICON_SETS__,
					2 ) . ' ' . _t( "Set Tools" ); ?></a>
	</div><!-- end setTools -->
		...
		if ( $vb_show_add_checked_to_set ) {
			...
			<div class="col">
				...
				<form id="caAddToSet">
					...
					?>
					<a href='#' onclick="return caAddItemsToSet();" class="button"><?php print _t( 'Add' ); ?>
						&rsaquo;</a>
			...
			<div class="col">
				...
				<form id="caCreateSetFromResults">
					...
					print caBusyIndicatorIcon( $this->request, array( 'id' => 'caCreateSetFromResultsIndicator' ) )
					      . "\n";
					?>
					<a href='#' onclick="caCreateSetFromResults(); return false;"
