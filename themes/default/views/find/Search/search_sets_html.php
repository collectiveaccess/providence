...
$vb_show_add_checked_to_set = (bool)(is_array($va_sets = $this->getVar('available_editable_sets')) && sizeof(
        $va_sets
...
if ($vb_show_add_checked_to_set || $vb_show_create_set_from_checked) {
    ...
    <div id="searchSetTools">
        ...
        if ($vb_show_create_set_from_checked) {
            ...
            <div class="col">
                ...
                <form id="caCreateSetFromResults">
                    ...
                    ?>
                    <a href='#' onclick="caCreateSetFromResults(); return false;" class="button"><?php print _t(
                            'Create'
                        ); ?> &rsaquo;</a>
                    <?php
        ...
        <a href='#' id='hideSets'
           onclick='caHideSearchSetTools(); $(".setTools").slideDown(250);'><?php print caNavIcon(
