 ...
 */
	...
	print $vs_control_box = caFormControlBox(
		...
		(caNavButton($this->request, __CA_NAV_BUTTON_CANCEL__, _t("Cancel"), 'client', 'OrderEditor', 'AdditionalFees', array('order_id' => $vn_order_id))),
		'',
...
?>
	<h1><?php print _t('Additional order fees'); ?></h1>
