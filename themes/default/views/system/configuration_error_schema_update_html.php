...
<div id='box'>
    ...
    <div id="content">
        ...
        <div class='contentSuccess' style='align: center;'>
            ...
            if ($vb_has_error) {
                print _t(
                    "Errors occurred while performing the update. <a href='%1/index.php'>Return to the login screen</a>.",
                    __CA_URL_ROOT__
                );
            } else {
                print _t(
                    "Update complete. You can now <a href='%1/index.php'>log into your system</a>",
                    __CA_URL_ROOT__
                );
            }
            ?>
