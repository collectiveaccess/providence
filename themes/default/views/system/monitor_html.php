...
<div id="caApplicationMonitor">
	...
	if ( is_array( $va_log['queries'] ) && ( $vn_num_queries = sizeof( $va_log['queries'] ) ) ) {
		...
		<table>
			<tr>
				<th width="310"><?php print _t( 'Query' ); ?></th>
				<th width="120"><?php print _t( 'Parameters' ); ?></th>
				<th width="310"><?php print _t( 'Location' ); ?></th>
				<th width="30"><?php print _t( 'Execution time' ); ?></th>
				<th width="30"><?php print _t( 'Hits' ); ?></th>
			</tr>
			<?php
