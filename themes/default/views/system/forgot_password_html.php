...
<div align="center">
    <div id="loginBox">
        <div align="center">
            <img src="<?php print $this->request->getThemeUrlPath() . "/graphics/logos/" . $this->request->config->get(
                    'login_logo'
                ); ?>" border="0">
        </div>
        <div id="systemTitle">
            ...
            <p class="smallContent">
                <?php print _t(
                    "Enter your CollectiveAccess user name below to request a new password. We will send you an email with further instructions."
                ); ?>
            </p>
        </div><!-- end  systemTitle -->
        <div id="loginForm">
            ...
            <div class="loginSubmitButton"><?php print caFormSubmitButton(
                    $this->request,
                    __CA_NAV_ICON_LOGIN__,
                    _t("Submit"),
                    'forgot',
                    array('icon_position' => __CA_NAV_ICON_ICON_POS_RIGHT__)
                ); ?></div>
            </form>
        </div><!-- end loginForm -->
    </div><!-- end loginBox -->
