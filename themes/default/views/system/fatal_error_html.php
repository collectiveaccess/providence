...
<div id='errorDetails'>
    ...
    <div id="content">
        ...
        <?php if ((defined('__CA_ENABLE_DEBUG_OUTPUT__') && __CA_ENABLE_DEBUG_OUTPUT__) || (defined(
        ...
        <div id="stacktace">
            <ol class="tracelist">
                ...
                foreach ($pa_errcontext as $vn_i => $va_trace) {
                    print "<li>" . (($vn_i == 0) ? "In " : "At ") . $va_trace['class'] . $va_trace['type'] . $va_trace['function'] . "(" . join(
                            ', ',
                            $pa_errcontext_args[$vn_i]
                        ) . ") in <a class='tracelistEntry' title='" . $va_trace['file'] . "' ondblclick='var f=this.innerHTML;this.innerHTML=this.title;this.title=f;'>" . pathinfo(
                            $va_trace['file'],
                            PATHINFO_FILENAME
                        ) . "</a> line " . $va_trace['line'] . "</li>\n";
                }
                ?>
            </ol>
            <?php
