...
<div class="caLibraryFindAutocompleteContainer">
	<form>
		...
		<?php print caHTMLTextInput( 'user', array( 'id' => 'objectAutocomplete' ),
			array( 'width' => '500px', 'autocomplete' => 'off' ) ); ?>
	</form>
</div>
...
<form>
	...
	<div class="caLibrarySubmitListContainer" id="transactionSubmitContainer">
		<?php print caJSButton( $this->request, __CA_NAV_ICON_SAVE__, _t( 'Check in' ), 'transactionSubmit', array(),
			array() ); ?>
	</div>
...
<script type="text/javascript">
	jQuery(document).ready(function () {
		var checkinManager = caUI.initObjectCheckinManager({
			...
			searchURL: '<?php print caNavUrl( $this->request, 'lookup', 'ObjectCheckout', 'Get',
				array( 'max' => 100, 'inlineCreate' => 0, 'quickadd' => 0 ) ); ?>',
