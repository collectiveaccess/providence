...
<form>
	...
	<div class="caLibrarySubmitListContainer" id="transactionSubmitContainer">
		<?php print caJSButton( $this->request, __CA_NAV_ICON_SAVE__, _t( 'Check out items' ), 'transactionSubmit',
			array(), array() ); ?>
	</div>
...
<script type="text/javascript">
	jQuery(document).ready(function () {
		var checkoutManager = caUI.initObjectCheckoutManager({
			...
			searchURL: '<?php print caNavUrl( $this->request, 'lookup', 'ObjectLibraryServices', 'Get',
				array( 'max' => 100, 'noInline' => 1, 'quickadd' => 0, 'types' => join( ";", $pa_types ) ) ); ?>',
