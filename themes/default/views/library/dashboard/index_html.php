...
print caFormTag( $this->request, 'Index', 'libraryDashboardOptions', null, 'post', 'multipart/form-data', '_top',
	array( 'noCSRFToken' => true, 'disableUnsavedChangesWarning' => true ) );
print _t( 'Dates' ) . ': ' . caHTMLTextInput( 'daterange', array( 'value' => $ps_daterange, 'class' => 'dateBg' ),
		array( 'width' => '200px' ) );
?>
</form>
...
<script type="text/javascript">
	jQuery(document).ready(function () {
		...
		jQuery(".caLibraryUserLink").bind("click", function (e) {
			...
			jQuery("#caLibraryDashboardDetailContainer").load('<?php print caNavUrl( $this->request, '*', '*',
					'getUserDetail' ); ?>', {
					daterange: '<?php print addslashes( $vs_daterange_proc ); ?>',
