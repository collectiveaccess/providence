...
?>
	Some of your order requires digitization. You will be informed by email when your items are ready for download. Note that digitization may take several days.
<?php
	}
