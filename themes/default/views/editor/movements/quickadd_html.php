...
<script type="text/javascript">
	var caQuickAddFormHandler = caUI.initQuickAddFormHandler({
		...
		formUrl: '<?php print caNavUrl( $this->request, 'editor/movements', 'MovementQuickAdd', 'Form' ); ?>',
		fileUploadUrl: '<?php print caNavUrl( $this->request, "editor/movements", "MovementEditor",
			"UploadFiles" ); ?>',
		saveUrl: '<?php print caNavUrl( $this->request, "editor/movements", "MovementQuickAdd", "Save" ); ?>',
