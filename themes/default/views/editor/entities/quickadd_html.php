...
<script type="text/javascript">
	var caQuickAddFormHandler = caUI.initQuickAddFormHandler({
		...
		formUrl: '<?php print caNavUrl($this->request, 'editor/entities', 'EntityQuickAdd', 'Form'); ?>',
		fileUploadUrl: '<?php print caNavUrl($this->request, "editor/entities", "EntityEditor", "UploadFiles"); ?>',
		saveUrl: '<?php print caNavUrl($this->request, "editor/entities", "EntityQuickAdd", "Save"); ?>',
