...
$stop_id 		= $this->getVar('subject_id');
...
$control_box 	= caEditorFormControls($this, 'TourStopEditorForm');
...
<?php
		print caFormTag($this->request, 'Save/'.$this->request->getActionExtra().'/stop_id/'.$stop_id, 'TourStopEditorForm', null, 'POST', 'multipart/form-data');
		
		$form_elements = $t_stop->getBundleFormHTMLForScreen($this->request->getActionExtra(), array(
...
<?= caSetupEditorScreenOverlays($this->request, $t_stop, $bundle_list); ?>
