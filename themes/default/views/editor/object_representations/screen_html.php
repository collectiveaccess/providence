...
if ($vb_can_edit) {
    $va_cancel_parameters = ($vn_representation_id ? array('representation_id' => $vn_representation_id) : array(
        'type_id' => $t_object_representation->getTypeID()
    ));
    print $vs_control_box = caFormControlBox(
        ...
        ($this->getVar('show_save_and_return') ? caFormSubmitButton(
            ...
            _t("Save and return"),
            'ObjectRepresentationEditorForm',
        ...
        '',
        ((intval($vn_representation_id) > 0) && $vb_can_delete) ? caFormNavButton(
            $this->request,
