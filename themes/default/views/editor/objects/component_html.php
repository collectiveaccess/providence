...
<form action="#" name="<?php print $vs_form_name; ?>" method="POST" enctype="multipart/form-data"
    ...
    <div class='dialogHeader quickaddDialogHeader'><?php
        print "<div class='componentAddTypeList'>" . _t(
                'Add component %1',
        ...
        if ($vb_can_edit) {
            print "<div style='float: right;'>" . caJSButton(
                    $this->request,
                    __CA_NAV_ICON_ADD__,
    ...
    <div class="componentAddSectionBox"
        ...
        <script type="text/javascript">
            function caSave<?php print $vs_form_name . $vs_field_name_prefix . $vs_n; ?>(e) {
                ...
                jQuery.post('<?php print caNavUrl(
                    $this->request,
                    "editor/objects",
                    "ObjectComponent",
                    "Save"
                ); ?>', jQuery("#<?php print $vs_form_name . $vs_field_name_prefix . $vs_n; ?>").serialize(), function (resp, textStatus) {
                    if (resp.status == 0) {
                        ...
                        jQuery.jGrowl('<?php print addslashes(
                            _t('Created %1 ', $t_subject->getTypeName())
                        ); ?> <em>' + resp.display + '</em>', {
                            header: '<?php print addslashes(
                                _t('Component add %1', $t_subject->getTypeName())
                            ); ?>'
                        });
            ...
            function caSwitchTypeComponentForm<?php print $vs_field_name_prefix . $vs_n; ?>() {
                ...
                jQuery("#<?php print $vs_form_name . $vs_field_name_prefix . $vs_n; ?>").parent().load("<?php print caNavUrl(
                    $this->request,
                    'editor/objects',
                    'ObjectComponent',
                    'Form'
