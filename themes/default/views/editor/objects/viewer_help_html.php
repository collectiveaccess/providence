...
<div class='content'>
    ...
    <p class='tileviewerHelpText'>
        <?php print _t(
            'You may add text annotations to the image. Each annotation is associated with a point, rectangular or polygon area on the image. To create an annotation
	select the point (line icon), rectangle or polygon tool from the tool bar, then click on the location you wish to annotate. '
        ); ?>
    </p>
    <p class='tileviewerHelpText'>
        <?php print _t(
            'For point annotations a line will appear connecting the location with a text box. The location will also be highlighted with a red translucent circle. You may drag both the point of the line and the text box to adjust position.'
        ); ?>
    </p>
    <p class='tileviewerHelpText'>
        <?php print _t(
            'For rectangular annotations a rectangle will appear with a text box below and adjacent. Drag on the edges at the highlighted locations to resize the rectangle. Drag the rectangle on its interior to reposition it.'
        ); ?>
    </p>
    <p class='tileviewerHelpText'>
        <?php print _t(
            'For polygon annotations click 
    ...
    <p class='tileviewerHelpText'>
        <?php print _t(
            'You may also drag the text box into position. Click on the text box to add text. All changes to annotations are saved automatically as you work.'
        ); ?>
    </p>
    ...
    <ul class='tileviewerHelpList'>
        ...
        <li><?php print _t(
                '%1 to return the image to the centered, zoomed out "home" position',
                '<code>h</code>'
            ); ?></li>
        ...
        <li><?php print _t(
                '%1, %2, %3 or %4 to pan the image in small increments',
                '<code>←</code>',
                '<code>↑</code>',
                '<code>→</code>',
                '<code>↓</code>'
