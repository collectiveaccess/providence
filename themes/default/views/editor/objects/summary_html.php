                    ...
                    if (is_array($va_reps)) {
                        foreach ($va_reps as $va_rep) {
                            if (sizeof($va_reps) > 1) {
                                ...
                                print "<a href='#' onclick='caMediaPanel.showPanel(\"" . caNavUrl(
                                        $this->request,
                                        'editor/objects',
                                        'ObjectEditor',
                                        'GetMediaOverlay',
                                ...
                                if ($this->request->user->canDoAction('can_download_ca_object_representations')) {
                                    print "<div class='download" . $va_rep['representation_id'] . " downloadMediaContainer'>" . caNavLink(
                                            $this->request,
                                            caNavIcon(__CA_NAV_ICON_DOWNLOAD__, 1),
                                            'downloadMedia',
                                            'editor/objects',
                                            'ObjectEditor',
                                            'DownloadMedia',
            ...
            <tr>
                <td valign="top" align="left" style="padding-right:10px;">
                    ...
                    foreach ($va_placements as $vn_placement_id => $va_info) {
                        ...
                        print "<div class=\"unit" . $vs_class . "\"><span class=\"heading" . $vs_class . "\">" . caTruncateStringWithEllipsis(
                                $va_info['display'],
                                26
