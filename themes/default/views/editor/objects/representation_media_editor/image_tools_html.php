...
?>
			...
			<div class="caRepTools">
				<a href="#" id="caRepToolsButton"><img src="<?php print $this->request->getThemeUrlPath()."/graphics/buttons/rotate16.png"; ?>" alt="<?php print htmlspecialchars(_t('Rotation'), ENT_QUOTES, "utf8"); ?>" border="0"/></a>
