...
if ($vb_can_edit) {
    $va_cancel_parameters = ($vn_place_id ? array('place_id' => $vn_place_id) : array(
        'type_id' => $t_place->getTypeID()
    ));
    print $vs_control_box = caFormControlBox(
        ...
        '',
        ((intval($vn_place_id) > 0) && $vb_can_delete) ? caFormNavButton(
            $this->request,
...
<div class="sectionBox">
    ...
    print caFormTag(
        $this->request,
        'Save/' . $this->request->getActionExtra() . '/place_id/' . $vn_place_id,
        'PlaceEditorForm',
        null,
        'POST',
        'multipart/form-data'
