...
if ($vb_can_edit) {
    $va_cancel_parameters = ($vn_annotation_id ? array('annotation_id' => $vn_annotation_id) : array(
        'type_id' => $t_representation_annotation->getTypeID()
    ));
    print $vs_control_box = caFormControlBox(
        caFormSubmitButton(
            ...
            _t("Save"),
            'RepresentationAnnotationEditorForm'
        ) . ' ' .
        ...
        '',
        ((intval($vn_annotation_id) > 0) && $vb_can_delete) ? caFormNavButton(
            $this->request,
