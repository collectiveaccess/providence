...
if ($vb_can_edit) {
	$vs_control_box = caFormControlBox(
		...
		caNavButton($this->request, __CA_NAV_BUTTON_CANCEL__, _t("Cancel"), '', 'editor/object_lots', 'ObjectLotEditor', 'Edit/'.$this->request->getActionExtra(), ($vn_lot_id ? array('lot_id' => $vn_lot_id) : array('type_id' => $t_lot->getTypeID()))),
		'',
