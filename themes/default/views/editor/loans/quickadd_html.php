...
<script type="text/javascript">
	var caQuickAddFormHandler = caUI.initQuickAddFormHandler({
		...
		formUrl: '<?php print caNavUrl( $this->request, 'editor/loans', 'LoanQuickAdd', 'Form' ); ?>',
		fileUploadUrl: '<?php print caNavUrl( $this->request, "editor/loans", "LoanEditor", "UploadFiles" ); ?>',
		saveUrl: '<?php print caNavUrl( $this->request, "editor/loans", "LoanQuickAdd", "Save" ); ?>',
