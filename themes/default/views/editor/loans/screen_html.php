...
$loan_id 		= $this->getVar('subject_id');
...
$control_box 	= caEditorFormControls($this, 'LoanEditorForm');

print $control_box;
?>
<div class="sectionBox">
<?php
		print caFormTag($this->request, 'Save/'.$this->request->getActionExtra().'/loan_id/'.$loan_id, 'LoanEditorForm', null, 'POST', 'multipart/form-data');
		
		$form_elements = $t_loan->getBundleFormHTMLForScreen($this->request->getActionExtra(), array(
...
<?= caSetupEditorScreenOverlays($this->request, $t_loan, $bundle_list); ?>
