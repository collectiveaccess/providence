...
<script type="text/javascript">
	var caQuickAddFormHandler = caUI.initQuickAddFormHandler({
		...
		formUrl: '<?php print caNavUrl($this->request, 'editor/occurrences', 'OccurrenceQuickAdd', 'Form'); ?>',
		fileUploadUrl: '<?php print caNavUrl($this->request, "editor/occurrences", "OccurrenceEditor", "UploadFiles"); ?>',
		saveUrl: '<?php print caNavUrl($this->request, "editor/occurrences", "OccurrenceQuickAdd", "Save"); ?>',
