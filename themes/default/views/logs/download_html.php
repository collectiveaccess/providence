...
<div class="sectionBox">
    ...
    print caFormControlBox(
        ...
        '',
        _t('Group by') . ': ' . caHTMLSelect(
            'group_by',
            array(_t('Downloads') => "download", _t('Record') => "record"),
            null,
            array('value' => $vs_group_by)
        ) . '&nbsp;&nbsp;' . _t('Show from') . ': ' . caHTMLTextInput(
            'search',
            array(
                'size' => 25,
                'value' => $this->getVar(
                    'download_list_search'
                )
            )
                ...
                if (sizeof($va_download_list)) {
                    foreach ($va_download_list as $va_download) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?php print (sizeof($va_download['num_logged_in_users'])) ? sizeof(
                                        $va_download['num_logged_in_users']
                                    ) . " (logged in)" : ""; ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php print caEditorLink(
                                    ...
                                    '',
                                    $va_tables[$va_download['table_num']]['name'],
                                    $va_download['row_id'],
                                    array()
                                ); ?>
                            </td>
