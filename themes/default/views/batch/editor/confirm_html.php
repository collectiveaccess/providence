...
<div id="caConfirmBatchExecutionPanel" class="caConfirmBatchExecutionPanel">
	<div class='dialogHeader'><?php print _t( 'Batch edit (%1 %2)', $vn_num_items_in_set,
			$t_subject->getProperty( ( $vn_num_items_in_set == 1 ) ? 'NAME_SINGULAR' : 'NAME_PLURAL' ) ); ?></div>
	<div id="caConfirmBatchExecutionPanelContentArea">

		<div class="caConfirmBatchExecutionPanelAlertText">
			<?php
			print _t( "You are about to apply changes to %1 %2. These changes cannot be undone.", $vn_num_items_in_set,
				$t_subject->getProperty( ( $vn_num_items_in_set == 1 ) ? 'NAME_SINGULAR' : 'NAME_PLURAL' ) );
			?>
		</div>
				...
				<tr style="vertical-align: top;">
					...
					if ( ( $vs_sms = trim( $this->request->user->get( 'sms_number' ) ) )
						...
						<td class="caConfirmBatchExecutionPanelAlertControl">
							...
							print caHTMLCheckboxInput( 'send_sms_when_done',
								array( 'id' => 'caSendSMSWhenDone', $va_opts ) );
							?>
						</td>
						<td class="caConfirmBatchExecutionPanelAlertControl">
							<?php
			...
			<table>
				<tr>
					<td align="right"><?php print caJSButton( $this->request, __CA_NAV_ICON_SAVE__,
							_t( 'Execute batch edit' ), 'caConfirmBatchExecutionFormExecuteButton',
