...
print $vs_control_box = caFormControlBox(
    caFormJSButton(
        ...
        _t("Execute data import"),
        'caBatchMetadataImportFormButton',
...
<div class="sectionBox">
    ...
    print caFormTag(
        $this->request,
        'ImportData/' . $this->request->getActionExtra(),
        'caBatchMetadataImportForm',
        null,
        'POST',
        'multipart/form-data',
        '_top',
    ...
    <div class='bundleLabel'>
        ...
        <div class="bundleContainer">
            <div class="caLabelList">
                <p>
                    <?php
                    print ca_data_importers::getImporterListAsHTMLFormElement(
                        'importer_id',
                        null,
                        array(
                            'id' => 'caImporterList',
                        ...
                        array(
                            'value' => $t_importer->getPrimaryKey()
                        )
                    );
                    ?>
                </p>
    ...
    <div class='bundleLabel'>
        ...
        <div class="bundleContainer">
            <div class="caLabelList">
                <p>
                    <?php
                    print ca_data_importers::getInputFormatListAsHTMLFormElement(
                        'inputFormat',
                        array(
                    ...
                    print "<span id='caImportAllDatasetsContainer' class='formLabelPlain'>" . caHTMLCheckboxInput(
                            'importAllDatasets',
                            array('id' => 'caImportAllDatasets', 'value' => 1),
                            array()
                    ...
                    <table class="caFileSourceControls">
                        <tr class="caFileSourceControls">
                            <td class="caSourceFileControlRadio">
                                ...
                                print caHTMLRadioButtonInput(
                                        "fileInput",
                                        $va_attr
                                    ) . "</td><td class='formLabel caFileSourceControls'>" . _t(
                                        'From a file'
                        ...
                        <tr class="caFileSourceControls">
                            <td class="caSourceFileControlRadio">
                                ...
                                print caHTMLRadioButtonInput(
                                    ...
                                    ) . " <div id='caFileBrowserContainer'>" . $this->getVar('file_browser') . "</div>";
                                ?>
                            </td>
                        </tr>
                    </table>
            ...
            <div class="caLabelList">
                <p>
                    ...
                    print caHTMLTextInput(
                        'sourceUrl',
                        array('id' => 'caSourceUrl', 'class' => 'urlBg'),
                        array('width' => '300px')
                    );
                    ?>
                </p>
...
<script type="text/javascript">
    ...
    var caImporterInfo = <?php print json_encode(
        ca_data_importers::getImporters(null, ['dontIncludeWorksheet' => true])
    ); ?>;
