...
print $vs_control_box = caFormControlBox(
    caFormJSButton(
        ...
        _t("Execute media import"),
        'caBatchMediaImportFormButton',
    ...
    caFormNavButton(
        ...
        'batch',
        'MediaImport',
        'Index/' . $this->request->getActionExtra(),
        array()
    ),
    '',
    ''
...
<div class="sectionBox">
    ...
    print caFormTag(
        $this->request,
        'Save/' . $this->request->getActionExtra(),
        'caBatchMediaImportForm',
        null,
        'POST',
        'multipart/form-data',
        '_top',
                ...
                <script type="text/javascript">
                    ...
                    jQuery(document).ready(function () {
                        oDirBrowser = caUI.initDirectoryBrowser('directoryBrowser', {
                            ...
                            disabledDirectoryIcon: "<?php print caNavIcon(
                                __CA_NAV_ICON_DOT__,
                                1,
                            ...
                            allowDragAndDropUpload: <?php print is_writable(
                                $this->request->config->get('batch_media_import_root_directory')
                            ) ? "true" : "false"; ?>,
                            dragAndDropUploadUrl: "<?php print caNavUrl(
                                $this->request,
                                'batch',
                                'MediaImport',
                                'UploadFiles'
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td class='formLabel'>
                                <?php
                                print _t(
                                        'Type used for newly created object representations'
                                    ) . "<br/>\n" . $this->getVar('ca_object_representations_type_list') . "</div>\n";
                                ?>
                            </td>
                            <?php if ($vs_reltypes = $this->getVar(
                                $t_instance->tableName() . '_representation_relationship_type'
                            )) { ?>
                                <td class='formLabel'>
                                    <?php
                    ...
                    <table>
                        ...
                        if (is_array($this->getVar('available_sets')) && sizeof($this->getVar('available_sets'))) {
                            ...
                            <tr>
                                <td><?php
                                    ...
                                    ?></td>
                                <td class='formLabel'><?php print _t(
                                        'Add imported media to set %1',
                                        caHTMLSelect(
                                            'set_id',
                                            $this->getVar('available_sets'),
                                            array(
                                                'id' => 'caAddToSetID',
                        ...
                        <tr>
                            <td><?php
                                ...
                                ?></td>
                            <td class='formLabel'><?php print _t(
                                    'Create set %1 with imported media',
                                    caHTMLTextInput(
                                        'set_create_name',
                                        array(
                                            'value' => '',
                        ...
                        <tr>
                            <td><?php
                                ...
                                if (!((isset($va_last_settings['setMode']) && (in_array(
                                        $va_last_settings['setMode'],
                                        array('add', 'create')
                                    ))))) {
                                    $va_attrs['checked'] = 1;
                                }
    ...
    <div class='bundleLabel'>
        <span class="formLabelText"><?php print _t(
                '%1 identifier',
                ucfirst(caGetTableDisplayName($t_instance->tableName(), false))
            ); ?></span>
        <div class="bundleContainer">
                    ...
                    <table>
                        <tr>
                            <td><?php
                                ...
                                ?></td>
                            <td class='formLabel' id='caIdnoFormModeForm'><?php print _t(
                                    'Set %1 identifier to %2',
                                    caGetTableDisplayName(
                                        $t_instance->tableName(),
                                        false
                                    ),
                                    $t_instance->htmlFormElement(
                                        'idno',
                                        '^ELEMENT',
                        ...
                        <tr>
                            <td><?php
                                ...
                                ?></td>
                            <td class='formLabel'><?php print _t(
                                    'Set %1 identifier to file name without extension',
                                    caGetTableDisplayName($t_instance->tableName(), false)
                                ); ?></td>
                        </tr>
                        <tr>
                            <td><?php
                                ...
                                ?></td>
                            <td class='formLabel'><?php print _t(
                                    'Set %1 identifier to directory and file name',
                                    caGetTableDisplayName($t_instance->tableName(), false)
                                ); ?></td>
                        </tr>
                    </table>
    ...
    <div class='bundleLabel'>
        <span class="formLabelText"><?php print (($this->getVar(
                        'ca_object_representations_mapping_list_count'
                    ) > 1) || ($this->getVar($t_instance->tableName() . '_mapping_list_count') > 1)) ? _t(
                'Status, access &amp; metadata extraction'
                    ...
                    <table style="width: 100%;">
                        <tr style="vertical-align: top;">
                            <td class='formLabel'>
                                <?php
                                print _t(
                                    'Set %1 status to<br/>%2',
                                    caGetTableDisplayName($t_instance->tableName(), false),
                                    $t_instance->htmlFormElement(
                                        'status',
                                        '',
                                        array(
                                            'name' => $t_instance->tableName() . '_status'
                                        )
                                    )
                                );
                                print "<br/>";
                                print _t(
                                    'Set %1 access to<br/>%2',
                                    caGetTableDisplayName($t_instance->tableName(), false),
                                    $t_instance->htmlFormElement(
                                        'access',
                                        '',
                                        array(
                                            'name' => $t_instance->tableName() . '_access'
                                        )
                                    )
                                );
                                ...
                                if ($this->getVar($t_instance->tableName() . '_mapping_list_count') > 1) {
                                    print "<br/>";
                                    print _t(
                                        'Extract embedded metadata into %1 using mapping<br/>%2',
                                        caGetTableDisplayName($t_instance->tableName(), false),
                            ...
                            <td class='formLabel'>
                                <?php
                                print _t(
                                    'Set representation status to<br/>%1',
                                    $t_rep->htmlFormElement(
                                        'status',
                                        '',
                                ...
                                print "<br/>";
                                print _t(
                                    'Set representation access to<br/>%1',
                                    $t_rep->htmlFormElement(
                                        'access',
                                        '',
                                ...
                                if ($this->getVar('ca_object_representations_mapping_list_count') > 1) {
                                    print "<br/>";
                                    print _t(
                                        'Extract embedded metadata into representation using mapping<br/>%1',
    ...
    <div class='bundleLabel'>
        <span id="caBatchMediaAdvancedHeader" class="formLabelText"><a href="#"
                                                                       id="caBatchMediaAdvancedHeaderText"><?php print _t(
            ...
            jQuery("#caBatchMediaAdvancedHeader").click(function (e) {
                ...
                $content.slideToggle(500, function () {
                    jQuery("#caBatchMediaAdvancedHeaderText").text(function () {
                        return $content.is(":visible") ? "< <?php print _t(
                            "Hide advanced options"
                        ); ?>" : "<?php print _t("Show advanced options"); ?> >";
                    });
                });
                        ...
                        <tr>
                            ...
                            <td class='formLabel'>
                                ...
                                print _t("Limit to types") . "<br/>\n" . $this->getVar(
                                        $t_instance->tableName() . '_limit_to_types_list'
                                    );
                                ?>
                            </td>
                        </tr>
                        ...
                        <table>
                            <tr>
                                <td><?php
                                    ...
                                    ?></td>
                                <td class='formLabel' id='caRepresentationIdnoFormModeForm'><?php print _t(
                                        'Set %1 identifier to %2',
                                        caGetTableDisplayName('ca_object_representations', false),
                                        $t_rep->htmlFormElement('idno', '^ELEMENT', array('request' => $this->request))
                                    ); ?></td>
                            </tr>
                            <tr>
                                <td><?php
            ...
            <div class="bundleContainer">
                <div class="caLabelList">
                    <p class="bundleDisplayPlacementEditorHelpText">
                        <?php
                        print _t(
                            'Relationships will be created by matching the identifier extracted from the media file name with identifiers in related records.'
                        );
                        ?>
                    </p>
                    <div style='padding:10px 0px 10px 10px;'>
                        <table>
                            ...
                            foreach (
                                ...
                                $t_rel = ca_relationship_types::getRelationshipTypeInstance(
                                    $t_instance->tableName(),
                                    $vs_rel_table
                                );
                                if (!$t_rel) {
                                ...
                                <tr>
                                    <td class='formLabel'>
                                        ...
                                        print caHTMLCheckboxInput(
                                            ...
                                            array('dontConvertAttributeQuotesToEntities' => true)
                                        );
                                        print ' ' . _t(
                                                "to %1 with relationship type",
                                    ...
                                    <td class='formLabel'>
                                        <?php
                                        print $t_rel->getRelationshipTypesAsHTMLSelect(
                                            'ltor',
                                            null,
                                            null,
                                            array(
            ...
            <div class="bundleContainer">
                <div class="caLabelList">
                    <p class="bundleDisplayPlacementEditorHelpText">
                        <?php
                        print _t(
                            'List names of files you wish to skip during import below, one per line. You may use asterisks ("*") as wildcards to make partial matches. Values enclosed in "/" characters will be treated as <a href="http://www.pcre.org/pcre.txt" target="_new">Perl-compatible regular expressions</a>.'
                        );
                        ?>
                    </p>
                    <p>
                        ...
                        print caHTMLTextInput(
                            'skip_file_list',
                            array(
                                'value' => $va_last_settings['skipFileList'],
                                'id' => "caSkipFilesList"
                            ),
