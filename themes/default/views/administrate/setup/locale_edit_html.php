...
<div class="sectionBox">
	...
	print $vs_control_box = caFormControlBox(
		...
		caFormNavButton( $this->request, __CA_NAV_ICON_CANCEL__, _t( "Cancel" ), '', 'administrate/setup', 'Locales',
			'ListLocales', array( 'locale_id' => 0 ) ),
		'',
		caFormNavButton( $this->request, __CA_NAV_ICON_DELETE__, _t( "Delete" ), '', 'administrate/setup', 'Locales',
			'Delete', array( 'locale_id' => $vn_locale_id ) )
	);
	?>
	<?php
	...
	foreach ( $t_locale->getFormFields() as $vs_f => $va_locale_info ) {
		print $t_locale->htmlFormElement( $vs_f, null,
