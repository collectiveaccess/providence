...
print $vs_control_box = caFormControlBox(
	...
	'',
	( intval( $vn_subject_id ) > 0 ) ? caNavButton( $this->request, __CA_NAV_ICON_DELETE__, _t( "Delete" ), '',
		'administrate/setup/interface_screen_editor', 'InterfaceScreenEditor',
...
<div class="sectionBox">
	<?php
	print caFormTag( $this->request, 'Save/' . $this->request->getActionExtra() . '/screen_id/' . $vn_subject_id,
		'InterfaceScreenEditorForm', null, 'POST', 'multipart/form-data' );
