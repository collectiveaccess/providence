...
<div class="sectionBox">
	...
	print caFormControlBox(
		...
		'',
		caNavHeaderButton( $this->request, __CA_NAV_ICON_ADD__, _t( "New" ), 'administrate/setup', 'Locales', 'Edit',
			array( 'locale_id' => 0 ) )
	);
	?>
		...
		foreach ( $va_locale_list as $va_locale ) {
			...
			<tr>
				...
				<td class="listtableEditDelete">
					<?php print caNavButton( $this->request, __CA_NAV_ICON_EDIT__, _t( "Edit" ), 'editIcon',
						'administrate/setup', 'Locales', 'Edit', array( 'locale_id' => $va_locale['locale_id'] ),
						array(), array(
					...
					<?php print caNavButton( $this->request, __CA_NAV_ICON_DELETE__, _t( "Delete" ), 'deleteIcon',
						'administrate/setup', 'Locales', 'Delete', array( 'locale_id' => $va_locale['locale_id'] ),
						array(), array(
							'icon_position'     => __CA_NAV_ICON_ICON_POS_LEFT__,
							'use_class'         => 'list-button',
							'no_background'     => true,
