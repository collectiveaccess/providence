...
<div class="sectionBox">
    ...
    <div class="control-box rounded">
        <div class="control-box-middle-content"><?php print _t('Search Engine'); ?>: <?php print $this->getVar(
                'search_config_engine_name'
            ); ?></div>
    </div>
    <div class="clear"></div>
    <table id="caSearchConfigSettingList" class="listtable">
            ...
            <tr>
                ...
                <td>
                    <?php if ($va_search_config_settings->getCurrentStatus() == __CA_SEARCH_CONFIG_OK__) {
                        ...
                        if ($va_search_config_settings->getCurrentStatus() == __CA_SEARCH_CONFIG_WARNING__) {
                ...
                <td>
                    ...
                    if ((boolean)$va_plugin_info['available']) {
                        ...
                        if ((boolean)$va_plugin_info['unused']) {
                            ...
                            print "<span style=\"color:red;text-decoration:underline;\">" . _t(
                                    "Not available"
                                ) . "</span>";
                        }
                    }
            ...
            <tr>
                ...
                <td><?php
                    ...
                    if (is_array($va_component_info['warnings']) && sizeof($va_component_info['warnings'])) {
                        print '<div style="color:GoldenRod;">' . join(
                                '<br/>',
                                $va_component_info['warnings']
                            ) . '</div>';
                    }
                    ?></td>
                <td>
