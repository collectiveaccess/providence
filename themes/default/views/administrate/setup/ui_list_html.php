...
$vs_type_menu = '<div class="sf-small-menu form-header-button rounded">' .
                ...
                '</div>' .
                '<form action="#">' . _t( 'New interface for ' ) . ' ' . caHTMLSelect( 'editor_type',
...
<script language="JavaScript" type="text/javascript">
	...
	function _navigateToNewForm(editor_type) {
		document.location = '<?php print caNavUrl( $this->request, 'administrate/setup/interface_editor',
			'InterfaceEditor', 'Edit', array( 'ui_id' => 0 ) ); ?>' + '/editor_type/' + editor_type;
	}
</script>
			...
			<tr>
				...
				<td class="listtableEdit">
					<?php print caNavButton( $this->request, __CA_NAV_ICON_EDIT__, _t( "Edit" ), '',
						'administrate/setup/interface_editor', 'InterfaceEditor', 'Edit',
						array( 'ui_id' => $va_ui['ui_id'] ), array(), array(
