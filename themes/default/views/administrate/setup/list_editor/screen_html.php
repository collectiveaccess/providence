 ...
 */
	...
	if ($vb_can_edit) {
		print $vs_control_box = caFormControlBox(
			...
			caNavButton($this->request, __CA_NAV_ICON_CANCEL__, _t("Cancel"), '', 'administrate/setup/list_editor', 'ListEditor', 'Edit/'.$this->request->getActionExtra(), array('list_id' => $vn_list_id)), 
			'', 
