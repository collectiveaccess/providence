...
?>
	<div id="summary" style="clear: both;">
		...
		if ( $vs_display_select_html = $t_display->getBundleDisplaysAsHTMLSelect( 'display_id',
			...
			?>
			<div id="printButton">
				<a href="<?php print caNavUrl( $this->request, $this->request->getModulePath(),
					$this->request->getController(), "PrintSummary",
					array( $t_item->primaryKey() => $t_item->getPrimaryKey() ) ) ?>">
					<?php print caNavIcon( __CA_NAV_ICON_PDF__, 2 ); ?>
				</a>
			</div>
			<?php
			print caFormTag( $this->request, 'Summary', 'caSummaryDisplaySelectorForm', null, 'post',
				...
				<td valign="top" align="left" style="padding-right:10px;">
					...
					foreach ( $va_placements as $vn_placement_id => $va_info ) {
						...
						print "<div class=\"unit" . $vs_class . "\"><span class=\"heading" . $vs_class . "\">"
						      . $va_info['display'] . ":</span> " . $vs_display_value . "</div>\n";
					}
					?>
				</td>
				</td>
