            ...
            <table class="listtable">
                        ...
                        if ($va_display_item['is_sortable']) {
                            if ($vs_current_sort == $va_display_item['bundle_name']) {
                                ...
                                print "<th class='list-header-unsorted'><span id='listHeader1" . $vn_id_count . "'><nobr>" . caNavLink(
                                        ...
                                        'Index',
                                        array('sort' => $va_display_item['bundle_name'])
                                    ) . "</nobr></span></th>";
                                TooltipManager::add(
                ...
                while (($vn_item_count < $vn_items_per_page) && $vo_result->nextHit()) {
                    ...
                    <tr <?php print ($i == 1) ? "class='odd'" : ""; ?>>
                        ...
                        print "<td class='listtableEditDelete'>" . caEditorLink(
                                $this->request,
                        ...
                        print " <a href='#' onclick='caOpenBrowserWith({$vn_type_id}); return false;' class='hierarchyIcon'>" . caNavIcon(
