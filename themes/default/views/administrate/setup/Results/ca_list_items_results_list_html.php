...
<?php
				...
				print "<td style='width: 60px; white-space:nowrap;'><span class='editIcon'>".caEditorLink($this->request, caNavIcon($this->request, __CA_NAV_BUTTON_EDIT__), 'list-button', 'ca_list_items', $vn_item_id, array())."</span>";
