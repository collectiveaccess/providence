            ...
            foreach ($va_row_ids as $vn_row_id => $vs_label) {
                if ($vs_facet_name != '_search') {
                    ...
                    print caNavLink(
                            ...
                            'removeCriteria',
                            array('facet' => $vs_facet_name, 'id' => $vn_row_id)
                        ) . "</div>";
                }
            }
        }
...
<div id="searchRefineBox">
    <div class="bg">
        ...
        <a href='#' id="hideRefine"
           onclick='return caHandleResultsUIBoxes("refine", "hide");'><?php print caNavIcon(
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        // load facets
        jQuery("#searchRefineContent").load("<?php print caNavUrl(
            $this->request,
            $this->request->getModulePath(),
            $this->request->getController(),
            'Facets'
