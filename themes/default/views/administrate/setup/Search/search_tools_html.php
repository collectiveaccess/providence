	...
	<div class="bg">
		...
		if ( is_array( $va_forms = $this->getVar( 'print_forms' ) ) && sizeof( $va_forms ) ) {
			...
			<div class="col">
				...
				print caHTMLSelect( 'label_form', $va_options, array( 'class' => 'searchToolsSelect' ),
						array( 'value' => $this->getVar( 'current_label_form' ) ) ) . "\n";
				print caFormSubmitLink( $this->request, caNavIcon( __CA_NAV_ICON_GO__, "18px" ), 'button',
					'caPrintLabelsForm' );
				?>
		...
		<div class="col">
			...
			print caHTMLSelect( 'export_format', $va_options, array( 'class' => 'searchToolsSelect' ),
					array( 'value' => $this->getVar( 'current_export_format' ) ) ) . "\n";
			...
			<div class="col">
				...
				<form id="caAddToSet">
					...
					print caHTMLSelect( 'set_id', $va_options,
							array( 'id' => 'caAddToSetID', 'class' => 'searchToolsSelect' ), array( 'value' => null ) )
					      . "\n";
					?>
					<a href='#' onclick="caAddItemsToSet();" class="button"><?php print caNavIcon( __CA_NAV_ICON_GO__,
							"18px" ); ?></a>
				</form>
			</div>
			<?php
		...
		?>
		<a href='#' id='hideTools'
		   onclick='jQuery("#searchToolsBox").slideUp(250); jQuery("#showTools").slideDown(1); jQuery("input.addItemToSetControl").hide(); return false;'><?php print caNavIcon( __CA_NAV_ICON_COLLAPSE__,
				"18px" ); ?></a>
