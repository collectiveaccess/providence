...
<div id="searchToolsBox">
    <div class="bg">
            ...
            <div class="col">
                ...
                <form id="caAddToSet">
                    ...
                    print caHTMLSelect(
                            'set_id',
                            $va_options,
                            array('id' => 'caAddToSetID', 'class' => 'searchToolsSelect'),
                            array('value' => null)
                        ) . "\n";
                    ?>
                    <a href='#' onclick="caAddItemsToSet();" class="button"><?php print caNavIcon(
                            __CA_NAV_ICON_GO__,
                            "18px"
                        ); ?></a>
                </form>
        ...
        ?>
        <a href='#' id='hideTools'
           onclick='jQuery("#searchToolsBox").slideUp(250); jQuery("#showTools").slideDown(1); jQuery("input.addItemToSetControl").hide(); return false;'><?php print caNavIcon(
