...
print caFormTag( $this->request, 'reindex', 'caHierarchicalReindexForm', null, 'post', 'multipart/form-data', '_top',
...
print "<div style='text-align: center'>" . caFormSubmitButton( $this->request, __CA_NAV_ICON_GO__,
		_t( "Rebuild hierarchical indices" ), 'caHierarchicalReindexForm', array() ) . "</div>";
print "</form>";
print "</div>\n";
?>
