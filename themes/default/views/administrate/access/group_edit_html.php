...
<div class="sectionBox">
	...
	print $vs_control_box = caFormControlBox(
		...
		caFormNavButton( $this->request, __CA_NAV_ICON_CANCEL__, _t( "Cancel" ), '', 'administrate/access', 'groups',
			'ListGroups', array( 'group_id' => 0 ) ),
		'',
		( $vn_group_id > 0 ) ? caFormNavButton( $this->request, __CA_NAV_ICON_DELETE__, _t( "Delete" ), '',
			'administrate/access', 'groups', 'Delete', array( 'group_id' => $vn_group_id ) ) : ''
	);
	?>
	<?php
	...
	foreach ( $t_group->getFormFields() as $vs_f => $va_group_info ) {
		print $t_group->htmlFormElement( $vs_f, null,
