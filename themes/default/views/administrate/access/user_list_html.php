...
<div class="sectionBox">
    ...
    print caFormControlBox(
        ...
        '' . _t(
            ...
            caHTMLSelect(
                'userclass',
                $this->request->user->getFieldInfo('userclass', 'BOUNDS_CHOICE_LIST'),
    ...
    ?>
    <h1 style='float:left; margin:10px 0px 10px 0px;'><?php print _t(
            '%1 users',
            ucfirst($this->getVar('userclass_displayname'))
        ); ?></h1>
    <?php
    if (sizeof($va_user_list)) {
        ?>
        <a href='#' id='showTools' style="float:left;margin-top:10px;"
           onclick='jQuery("#searchToolsBox").slideDown(250); jQuery("#showTools").hide(); return false;'><?php print caNavIcon(
