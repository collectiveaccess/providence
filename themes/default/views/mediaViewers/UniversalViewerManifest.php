...
$va_services[] = [
	...
	"@id"      => caNavUrl( $vo_request, '*', '*', 'SearchMediaData', [
		'identifier'             => $vs_identifier,
		$t_subject->primaryKey() => $t_subject->getPrimaryKey(),
		'context'                => caGetOption( 'context', $va_data, null ),
		'display'                => caGetOption( 'display_type', $va_data, null )
	] ),
	"profile"  => "http://iiif.io/api/search/0/search",
	"label"    => _t( "Search within this manifest" ),
	"service"  => [
		"@id"     => caNavUrl( $vo_request, '*', '*', 'MediaDataAutocomplete',
			[ 'identifier' => $vs_identifier, $t_subject->primaryKey() => $t_subject->getPrimaryKey() ] ),
