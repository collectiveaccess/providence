 ...
 * UNE SEULE ligne diffère de themes/default/views/pageFormat/pageFooter.php : les deux
 * liens de crédit de l'amont, passés de « http:// » à « https:// ». C'étaient les
 * dernières occurrences de « http:// » dans le HTML servi aux pages de l'éditeur (deux
 * sur une même ligne). Ce sont des liens de NAVIGATION et non des ressources chargées :
 * ils ne provoquaient donc pas de contenu mixte bloqué par le navigateur, mais ils
 * envoyaient l'utilisateur en clair depuis une page servie en HTTPS.
 *
 * ⚠️ LES DEUX ADRESSES NE SE TRAITENT PAS DE LA MÊME FAÇON, ET C'EST MESURÉ. Ne pas
 * « harmoniser » en remettant un « www. » devant whirl-i-gig.com :
 *
 *     https://www.collectiveaccess.org  → 200, certificat valide
 *     https://www.whirl-i-gig.com       → ÉCHEC TLS : « no alternative certificate
 *                                         subject name matches target hostname »
 *                                         (leur certificat ne couvre pas le sous-domaine
 *                                         « www »)
 *     https://whirl-i-gig.com           → 200, certificat valide
 *
 * D'où l'asymétrie : « www » conservé pour CollectiveAccess, retiré pour Whirl-i-Gig.
 * Écrire « https://www.whirl-i-gig.com » enverrait l'utilisateur sur une page
 * d'avertissement de sécurité — c'est-à-dire pire que le « http:// » qu'on corrige.
 * ⚠️ À revérifier aux montées de version : si l'amont finit par couvrir « www » dans son
 * certificat, cette asymétrie devient inutile ; tant qu'il ne le fait pas, elle est la
...
?>
				&nbsp;&nbsp;|&nbsp;&nbsp; &copy; 2026 Whirl-i-Gig, <a href="https://www.collectiveaccess.org" target="_blank" rel="noopener noreferrer">CollectiveAccess</a> <?php _p("is a trademark of"); ?> <a href="https://whirl-i-gig.com" target="_blank" rel="noopener noreferrer">Whirl-i-Gig</a>
