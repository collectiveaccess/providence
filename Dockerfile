...
RUN sed -i "s/memory_limit = 128M/memory_limit = 4G/" /usr/local/lib/php.ini && sed -i "s/post_max_size = 8M/post_max_size = 2048MB/" /usr/local/lib/php.ini && sed -i "s/upload_max_filesize = 2M/upload_max_filesize = 2048M/" /usr/local/lib/php.ini && sed -i "s/display_errors = Off/display_errors = On/" /usr/local/lib/php.ini && sed -i "s/max_execution_time = 30/max_execution_time = 300/g" /usr/local/lib/php.ini
